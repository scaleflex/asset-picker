          ...
          <div class="auth-ring">
            <div class="auth-logo">
              ${e!=null&&e.brandHtml?h`<span
                    ${T({display:"flex","align-items":"center","justify-content":"center",transform:"scale(2.2)"})}
                    >${v(e)}</span
                  >`:m}
            </div>
          </div>
