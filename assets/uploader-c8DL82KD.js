...
}`}]),document.getElementById(`open-btn`).addEventListener(`click`,()=>{n.config=e({uploader:{},onSelect:e=>alert(`Selected ${e.length} asset(s)`),onCancel:()=>console.log(`Cancelled`)}),n.open()})}};export{n as default};