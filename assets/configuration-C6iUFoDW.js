import{n as e,r as t,t as n}from"./doc-utils-C97Qk3q2.js";var r={render(){return`
  ...
  locale: 'fr', // 'fr', 'de', 'en-US', etc. — defaults to 'en'
        ...
        ${n(`javascript`,`localStorage.setItem('apTranslationsMissingKeysEnabled', 'true');`)}
  ...
  forcedFilters: {
    tags: { values: ['approved'] },
        ...
        ${n(`typescript`,`// Lock to specific extensions using subtype values
picker.config = {
  auth: { /* ... */ },
  forcedFilters: {
    type: { values: ['image_svg', 'image_png'] },
        ...
        ${e({href:`#/docs/getting-started`,label:`Getting started`},{href:`#/docs/api`,label:`API`})}
      </div>
