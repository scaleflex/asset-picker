import{i as k,I as w,q as _,g as $,B as z,C as m,M as C,b as s,A as h,o as b,a as I,n as v,r as d}from"./define-BSvUtYAu.js";import"./index-DeQhaZNH.js";const x="sfx-uploader-token:";function p(n){try{return localStorage.getItem(`${x}${n}`)}catch{return null}}function P(n,e){try{localStorage.setItem(`${x}${n}`,e)}catch{}}function f(n){try{localStorage.removeItem(`${x}${n}`)}catch{}}function S(n,e){const i=t=>{if(t.origin!==new URL(n).origin)return;const r=typeof t.data=="string"?M(t.data):t.data;r!=null&&r.token&&e(r.token)};return window.addEventListener("message",i),()=>window.removeEventListener("message",i)}function M(n){try{return JSON.parse(n)}catch{return null}}var B=Object.defineProperty,a=(n,e,i,t)=>{for(var r=void 0,o=n.length-1,c;o>=0;o--)(c=n[o])&&(r=c(e,i,r)||r);return r&&B(e,i,r),r};const y=class extends k{constructor(){super(...arguments),this.provider="google-drive",this.companionUrl="",this._authenticated=!1,this._loading=!1,this._items=[],this._selectedIds=new Set,this._breadcrumbs=[],this._nextPagePath=null,this._error=null,this._loadingMore=!1,this._username=null,this._cleanupAuthListener=null,this._authWindow=null,this._handleConnect=()=>{var e;const i=w(this.companionUrl,this.provider);this._authWindow=window.open(i,"_blank","width=600,height=600"),(e=this._cleanupAuthListener)==null||e.call(this),this._cleanupAuthListener=S(this.companionUrl,t=>{var r,o;(r=this._authWindow)==null||r.close(),this._authWindow=null,(o=this._cleanupAuthListener)==null||o.call(this),this._cleanupAuthListener=null,P(this.provider,t),this._authenticated=!0,this._loadFolder("")})},this._lastClickedIndex=null,this._toggleSelectAll=()=>{const e=this._items.filter(i=>!i.isFolder);e.every(i=>this._selectedIds.has(i.id))?this._selectedIds=new Set:this._selectedIds=new Set(e.map(i=>i.id))},this._onAddSelected=()=>{const e=p(this.provider);if(!e)return;const i=this._items.filter(t=>!t.isFolder&&this._selectedIds.has(t.id)).map(t=>({companionUrl:this.companionUrl,provider:this.provider,token:e,requestPath:t.requestPath,fileId:t.id,name:t.name,mimeType:t.mimeType,size:t.size,thumbnail:t.thumbnail}));this.dispatchEvent(new CustomEvent("connector-files-selected",{detail:{files:i},bubbles:!0,composed:!0}))},this._onClose=()=>{this.dispatchEvent(new CustomEvent("connector-close",{bubbles:!0,composed:!0}))},this._handleLogout=async()=>{const e=p(this.provider);if(e){try{await _(this.companionUrl,this.provider,e)}catch{}f(this.provider)}this._reset()}}connectedCallback(){super.connectedCallback(),this._checkAuth()}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._cleanupAuthListener)==null||e.call(this),this._cleanupAuthListener=null}updated(e){e.has("provider")&&(this._reset(),this._checkAuth())}_reset(){this._authenticated=!1,this._loading=!1,this._items=[],this._selectedIds=new Set,this._breadcrumbs=[],this._nextPagePath=null,this._error=null,this._username=null}_checkAuth(){p(this.provider)&&(this._authenticated=!0,this._loadFolder(""))}get _providerDef(){return $([this.provider])[0]??null}get _providerLabel(){var e;return((e=this._providerDef)==null?void 0:e.label)??this.provider}async _loadFolder(e){const i=p(this.provider);if(!i){this._authenticated=!1;return}this.offsetHeight>0&&(this.style.minHeight=`${this.offsetHeight}px`),this._loading=!0,this._error=null,this._items=[],this._selectedIds=new Set,this._lastClickedIndex=null,this._nextPagePath=null;try{const t=await z(this.companionUrl,this.provider,i,e);this._items=t.items,this._nextPagePath=t.nextPagePath,t.username&&(this._username=t.username)}catch(t){t instanceof m?(f(this.provider),this._authenticated=!1):this._error=t instanceof Error?t.message:"Failed to load files"}finally{this._loading=!1}}_onFolderClick(e){this._breadcrumbs=[...this._breadcrumbs,{name:e.name,path:e.requestPath}],this._loadFolder(e.requestPath)}_onBreadcrumbClick(e){if(e<0)this._breadcrumbs=[],this._loadFolder("");else{const i=this._breadcrumbs[e];this._breadcrumbs=this._breadcrumbs.slice(0,e+1),this._loadFolder(i.path)}}async _onLoadMore(){const e=p(this.provider);if(!(!e||!this._nextPagePath)){this._loadingMore=!0;try{const i=await C(this.companionUrl,e,this._nextPagePath);this._items=[...this._items,...i.items],this._nextPagePath=i.nextPagePath}catch(i){i instanceof m&&(f(this.provider),this._authenticated=!1)}finally{this._loadingMore=!1}}}_toggleSelect(e,i){const t=this._items.filter(o=>!o.isFolder),r=t.findIndex(o=>o.id===e.id);if(i!=null&&i.shiftKey&&this._lastClickedIndex!==null&&r!==-1){const o=Math.min(this._lastClickedIndex,r),c=Math.max(this._lastClickedIndex,r),g=new Set(this._selectedIds);for(let u=o;u<=c;u++)g.add(t[u].id);this._selectedIds=g}else{const o=new Set(this._selectedIds);o.has(e.id)?o.delete(e.id):o.add(e.id),this._selectedIds=o}r!==-1&&(this._lastClickedIndex=r)}render(){return s`
      ${this._renderHeader()}
