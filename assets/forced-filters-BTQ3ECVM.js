import{b as c}from"./index-DbKjKsY1.js";import{r as a}from"./code-block-Bk3NnwHF.js";let t=["image"];function n(){const e=document.getElementById("code-container");if(!e)return;e.innerHTML="";const o=t.map(i=>`'${i}'`).join(", ");a("#code-container",[{label:"JavaScript",lang:"javascript",code:`
picker.config = {
  auth: { /* ... */ },
  forcedFilters: {
    type: { values: [${o}] },
