import{b as d}from"./index-Dn1iy44q.js";import{r as p}from"./code-block-Bk3NnwHF.js";let l=["image"],o="",i="";function u(){const e={type:{values:l}};return o.trim()&&i.trim()&&(e[o.trim()]={values:[i.trim()]}),e}function s(e){const t=[`${e}type: { values: [${l.map(a=>`'${a}'`).join(", ")}] },`];return o.trim()&&i.trim()&&(t.push(`${e}// Custom metadata — use the RAW api key, value as a string`),t.push(`${e}${o.trim()}: { values: ['${i.trim()}'] },`)),t.join(`
