const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/landing-BVgcdmvt.js","assets/code-block-Bk3NnwHF.js","assets/getting-started-Ch2NjLo6.js","assets/doc-utils-XkOyWBCy.js","assets/configuration-DFpgwuv1.js","assets/api-Dl3UszFN.js","assets/theming-hrqYM8pb.js","assets/filters-BlL5oE1x.js","assets/types-DPNAgA2W.js","assets/basic-CX7ZLN1c.js","assets/single-select-DtMoSgxr.js","assets/multi-select-DyDuy631.js","assets/disabled-assets-DHVO5YbJ.js","assets/theming-BuAoWkAJ.js","assets/custom-theming-DjsaBk1g.js","assets/default-filters-C2e9c_bH.js","assets/forced-filters-DWMOycET.js","assets/hidden-tabs-BcFBpeaO.js","assets/root-folder-Det8_UHU.js","assets/events-BipDR5Ts.js","assets/react-wrapper-BXYjOtmk.js","assets/inline-CtsQcdwe.js","assets/sticky-filters-mNkGk2Jg.js","assets/grid-size-B1zwyddK.js","assets/preferences-DFmK9o3B.js","assets/uploader-BEkq5kia.js","assets/folder-selection-BWC1Gt8X.js","assets/ai-search-CkElL0CK.js","assets/transformations-D9DsLoDp.js","assets/language-switcher-C-FAIN0e.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const Jo="modulepreload",Zo=function(t){return"/asset-picker/"+t},vr={},K=function(e,s,i){let r=Promise.resolve();if(s&&s.length>0){let a=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=a(s.map(d=>{if(d=Zo(d),d in vr)return;vr[d]=!0;const p=d.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const h=document.createElement("link");if(h.rel=p?"stylesheet":Jo,p||(h.as="script"),h.crossOrigin="",h.href=d,l&&h.setAttribute("nonce",l),document.head.appendChild(h),p)return new Promise((g,v)=>{h.addEventListener("load",g),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=a,window.dispatchEvent(n),!n.defaultPrevented)throw a}return r.then(a=>{for(const n of a||[])n.status==="rejected"&&o(n.reason);return e().catch(o)})};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Js=globalThis,Vi=Js.ShadowRoot&&(Js.ShadyCSS===void 0||Js.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Hi=Symbol(),br=new WeakMap;let ho=class{constructor(e,s,i){if(this._$cssResult$=!0,i!==Hi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=s}get styleSheet(){let e=this.o;const s=this.t;if(Vi&&e===void 0){const i=s!==void 0&&s.length===1;i&&(e=br.get(s)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&br.set(s,e))}return e}toString(){return this.cssText}};const ea=t=>new ho(typeof t=="string"?t:t+"",void 0,Hi),C=(t,...e)=>{const s=t.length===1?t[0]:e.reduce((i,r,o)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+t[o+1],t[0]);return new ho(s,t,Hi)},ta=(t,e)=>{if(Vi)t.adoptedStyleSheets=e.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of e){const i=document.createElement("style"),r=Js.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=s.cssText,t.appendChild(i)}},xr=Vi?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let s="";for(const i of e.cssRules)s+=i.cssText;return ea(s)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:sa,defineProperty:ia,getOwnPropertyDescriptor:ra,getOwnPropertyNames:oa,getOwnPropertySymbols:aa,getPrototypeOf:na}=Object,ut=globalThis,_r=ut.trustedTypes,la=_r?_r.emptyScript:"",wi=ut.reactiveElementPolyfillSupport,_s=(t,e)=>t,si={toAttribute(t,e){switch(e){case Boolean:t=t?la:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=t!==null;break;case Number:s=t===null?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch{s=null}}return s}},qi=(t,e)=>!sa(t,e),yr={attribute:!0,type:String,converter:si,reflect:!1,useDefault:!1,hasChanged:qi};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ut.litPropertyMetadata??(ut.litPropertyMetadata=new WeakMap);let qt=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,s=yr){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(e,s),!s.noAccessor){const i=Symbol(),r=this.getPropertyDescriptor(e,i,s);r!==void 0&&ia(this.prototype,e,r)}}static getPropertyDescriptor(e,s,i){const{get:r,set:o}=ra(this.prototype,e)??{get(){return this[s]},set(a){this[s]=a}};return{get:r,set(a){const n=r==null?void 0:r.call(this);o==null||o.call(this,a),this.requestUpdate(e,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??yr}static _$Ei(){if(this.hasOwnProperty(_s("elementProperties")))return;const e=na(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(_s("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(_s("properties"))){const s=this.properties,i=[...oa(s),...aa(s)];for(const r of i)this.createProperty(r,s[r])}const e=this[Symbol.metadata];if(e!==null){const s=litPropertyMetadata.get(e);if(s!==void 0)for(const[i,r]of s)this.elementProperties.set(i,r)}this._$Eh=new Map;for(const[s,i]of this.elementProperties){const r=this._$Eu(s,i);r!==void 0&&this._$Eh.set(r,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const s=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const r of i)s.unshift(xr(r))}else e!==void 0&&s.push(xr(e));return s}static _$Eu(e,s){const i=s.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(s=>s(this))}addController(e){var s;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)==null||s.call(e))}removeController(e){var s;(s=this._$EO)==null||s.delete(e)}_$E_(){const e=new Map,s=this.constructor.elementProperties;for(const i of s.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ta(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(s=>{var i;return(i=s.hostConnected)==null?void 0:i.call(s)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(s=>{var i;return(i=s.hostDisconnected)==null?void 0:i.call(s)})}attributeChangedCallback(e,s,i){this._$AK(e,i)}_$ET(e,s){var o;const i=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,i);if(r!==void 0&&i.reflect===!0){const a=(((o=i.converter)==null?void 0:o.toAttribute)!==void 0?i.converter:si).toAttribute(s,i.type);this._$Em=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(e,s){var o,a;const i=this.constructor,r=i._$Eh.get(e);if(r!==void 0&&this._$Em!==r){const n=i.getPropertyOptions(r),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((o=n.converter)==null?void 0:o.fromAttribute)!==void 0?n.converter:si;this._$Em=r;const d=l.fromAttribute(s,n.type);this[r]=d??((a=this._$Ej)==null?void 0:a.get(r))??d,this._$Em=null}}requestUpdate(e,s,i,r=!1,o){var a;if(e!==void 0){const n=this.constructor;if(r===!1&&(o=this[e]),i??(i=n.getPropertyOptions(e)),!((i.hasChanged??qi)(o,s)||i.useDefault&&i.reflect&&o===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(n._$Eu(e,i))))return;this.C(e,s,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,s,{useDefault:i,reflect:r,wrapped:o},a){i&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??s??this[e]),o!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(s=void 0),this._$AL.set(e,s)),r===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var i;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[o,a]of r){const{wrapped:n}=a,l=this[o];n!==!0||this._$AL.has(o)||l===void 0||this.C(o,void 0,a,l)}}let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),(i=this._$EO)==null||i.forEach(r=>{var o;return(o=r.hostUpdate)==null?void 0:o.call(r)}),this.update(s)):this._$EM()}catch(r){throw e=!1,this._$EM(),r}e&&this._$AE(s)}willUpdate(e){}_$AE(e){var s;(s=this._$EO)==null||s.forEach(i=>{var r;return(r=i.hostUpdated)==null?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(s=>this._$ET(s,this[s]))),this._$EM()}updated(e){}firstUpdated(e){}};qt.elementStyles=[],qt.shadowRootOptions={mode:"open"},qt[_s("elementProperties")]=new Map,qt[_s("finalized")]=new Map,wi==null||wi({ReactiveElement:qt}),(ut.reactiveElementVersions??(ut.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ys=globalThis,$r=t=>t,ii=ys.trustedTypes,wr=ii?ii.createPolicy("lit-html",{createHTML:t=>t}):void 0,po="$lit$",ht=`lit$${Math.random().toFixed(9).slice(2)}$`,uo="?"+ht,ca=`<${uo}>`,Ot=document,ws=()=>Ot.createComment(""),ks=t=>t===null||typeof t!="object"&&typeof t!="function",Gi=Array.isArray,da=t=>Gi(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",ki=`[ 	
\f\r]`,us=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,kr=/-->/g,Sr=/>/g,kt=RegExp(`>|${ki}(?:([^\\s"'>=/]+)(${ki}*=${ki}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Cr=/'/g,Ar=/"/g,fo=/^(?:script|style|textarea|title)$/i,go=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),c=go(1),pt=go(2),Ze=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),Er=new WeakMap,At=Ot.createTreeWalker(Ot,129);function mo(t,e){if(!Gi(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return wr!==void 0?wr.createHTML(e):e}const ha=(t,e)=>{const s=t.length-1,i=[];let r,o=e===2?"<svg>":e===3?"<math>":"",a=us;for(let n=0;n<s;n++){const l=t[n];let d,p,u=-1,h=0;for(;h<l.length&&(a.lastIndex=h,p=a.exec(l),p!==null);)h=a.lastIndex,a===us?p[1]==="!--"?a=kr:p[1]!==void 0?a=Sr:p[2]!==void 0?(fo.test(p[2])&&(r=RegExp("</"+p[2],"g")),a=kt):p[3]!==void 0&&(a=kt):a===kt?p[0]===">"?(a=r??us,u=-1):p[1]===void 0?u=-2:(u=a.lastIndex-p[2].length,d=p[1],a=p[3]===void 0?kt:p[3]==='"'?Ar:Cr):a===Ar||a===Cr?a=kt:a===kr||a===Sr?a=us:(a=kt,r=void 0);const g=a===kt&&t[n+1].startsWith("/>")?" ":"";o+=a===us?l+ca:u>=0?(i.push(d),l.slice(0,u)+po+l.slice(u)+ht+g):l+ht+(u===-2?n:g)}return[mo(t,o+(t[s]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class Ss{constructor({strings:e,_$litType$:s},i){let r;this.parts=[];let o=0,a=0;const n=e.length-1,l=this.parts,[d,p]=ha(e,s);if(this.el=Ss.createElement(d,i),At.currentNode=this.el.content,s===2||s===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(r=At.nextNode())!==null&&l.length<n;){if(r.nodeType===1){if(r.hasAttributes())for(const u of r.getAttributeNames())if(u.endsWith(po)){const h=p[a++],g=r.getAttribute(u).split(ht),v=/([.?@])?(.*)/.exec(h);l.push({type:1,index:o,name:v[2],strings:g,ctor:v[1]==="."?ua:v[1]==="?"?fa:v[1]==="@"?ga:mi}),r.removeAttribute(u)}else u.startsWith(ht)&&(l.push({type:6,index:o}),r.removeAttribute(u));if(fo.test(r.tagName)){const u=r.textContent.split(ht),h=u.length-1;if(h>0){r.textContent=ii?ii.emptyScript:"";for(let g=0;g<h;g++)r.append(u[g],ws()),At.nextNode(),l.push({type:2,index:++o});r.append(u[h],ws())}}}else if(r.nodeType===8)if(r.data===uo)l.push({type:2,index:o});else{let u=-1;for(;(u=r.data.indexOf(ht,u+1))!==-1;)l.push({type:7,index:o}),u+=ht.length-1}o++}}static createElement(e,s){const i=Ot.createElement("template");return i.innerHTML=e,i}}function Wt(t,e,s=t,i){var a,n;if(e===Ze)return e;let r=i!==void 0?(a=s._$Co)==null?void 0:a[i]:s._$Cl;const o=ks(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==o&&((n=r==null?void 0:r._$AO)==null||n.call(r,!1),o===void 0?r=void 0:(r=new o(t),r._$AT(t,s,i)),i!==void 0?(s._$Co??(s._$Co=[]))[i]=r:s._$Cl=r),r!==void 0&&(e=Wt(t,r._$AS(t,e.values),r,i)),e}class pa{constructor(e,s){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:s},parts:i}=this._$AD,r=((e==null?void 0:e.creationScope)??Ot).importNode(s,!0);At.currentNode=r;let o=At.nextNode(),a=0,n=0,l=i[0];for(;l!==void 0;){if(a===l.index){let d;l.type===2?d=new es(o,o.nextSibling,this,e):l.type===1?d=new l.ctor(o,l.name,l.strings,this,e):l.type===6&&(d=new ma(o,this,e)),this._$AV.push(d),l=i[++n]}a!==(l==null?void 0:l.index)&&(o=At.nextNode(),a++)}return At.currentNode=Ot,r}p(e){let s=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,s),s+=i.strings.length-2):i._$AI(e[s])),s++}}class es{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,s,i,r){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=s,this._$AM=i,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=s.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,s=this){e=Wt(this,e,s),ks(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==Ze&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):da(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&ks(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ot.createTextNode(e)),this._$AH=e}$(e){var o;const{values:s,_$litType$:i}=e,r=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=Ss.createElement(mo(i.h,i.h[0]),this.options)),i);if(((o=this._$AH)==null?void 0:o._$AD)===r)this._$AH.p(s);else{const a=new pa(r,this),n=a.u(this.options);a.p(s),this.T(n),this._$AH=a}}_$AC(e){let s=Er.get(e.strings);return s===void 0&&Er.set(e.strings,s=new Ss(e)),s}k(e){Gi(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,r=0;for(const o of e)r===s.length?s.push(i=new es(this.O(ws()),this.O(ws()),this,this.options)):i=s[r],i._$AI(o),r++;r<s.length&&(this._$AR(i&&i._$AB.nextSibling,r),s.length=r)}_$AR(e=this._$AA.nextSibling,s){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,s);e!==this._$AB;){const r=$r(e).nextSibling;$r(e).remove(),e=r}}setConnected(e){var s;this._$AM===void 0&&(this._$Cv=e,(s=this._$AP)==null||s.call(this,e))}}class mi{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,s,i,r,o){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=s,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=m}_$AI(e,s=this,i,r){const o=this.strings;let a=!1;if(o===void 0)e=Wt(this,e,s,0),a=!ks(e)||e!==this._$AH&&e!==Ze,a&&(this._$AH=e);else{const n=e;let l,d;for(e=o[0],l=0;l<o.length-1;l++)d=Wt(this,n[i+l],s,l),d===Ze&&(d=this._$AH[l]),a||(a=!ks(d)||d!==this._$AH[l]),d===m?e=m:e!==m&&(e+=(d??"")+o[l+1]),this._$AH[l]=d}a&&!r&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ua extends mi{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class fa extends mi{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class ga extends mi{constructor(e,s,i,r,o){super(e,s,i,r,o),this.type=5}_$AI(e,s=this){if((e=Wt(this,e,s,0)??m)===Ze)return;const i=this._$AH,r=e===m&&i!==m||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==m&&(i===m||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,e):this._$AH.handleEvent(e)}}class ma{constructor(e,s,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Wt(this,e)}}const wh={I:es},Si=ys.litHtmlPolyfillSupport;Si==null||Si(Ss,es),(ys.litHtmlVersions??(ys.litHtmlVersions=[])).push("3.3.3");const va=(t,e,s)=>{const i=(s==null?void 0:s.renderBefore)??e;let r=i._$litPart$;if(r===void 0){const o=(s==null?void 0:s.renderBefore)??null;i._$litPart$=r=new es(e.insertBefore(ws(),o),o,void 0,s??{})}return r._$AI(t),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ft=globalThis;let A=class extends qt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var s;const e=super.createRenderRoot();return(s=this.renderOptions).renderBefore??(s.renderBefore=e.firstChild),e}update(e){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=va(s,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Ze}};var co;A._$litElement$=!0,A.finalized=!0,(co=Ft.litElementHydrateSupport)==null||co.call(Ft,{LitElement:A});const Ci=Ft.litElementPolyfillSupport;Ci==null||Ci({LitElement:A});(Ft.litElementVersions??(Ft.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ba={attribute:!0,type:String,converter:si,reflect:!1,hasChanged:qi},xa=(t=ba,e,s)=>{const{kind:i,metadata:r}=s;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),i==="setter"&&((t=Object.create(t)).wrapped=!0),o.set(s.name,t),i==="accessor"){const{name:a}=s;return{set(n){const l=e.get.call(this);e.set.call(this,n),this.requestUpdate(a,l,t,!0,n)},init(n){return n!==void 0&&this.C(a,void 0,t,n),n}}}if(i==="setter"){const{name:a}=s;return function(n){const l=this[a];e.call(this,n),this.requestUpdate(a,l,t,!0,n)}}throw Error("Unsupported decorator location: "+i)};function f(t){return(e,s)=>typeof s=="object"?xa(t,e,s):((i,r,o)=>{const a=r.hasOwnProperty(o);return r.constructor.createProperty(o,i),a?Object.getOwnPropertyDescriptor(r,o):void 0})(t,e,s)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
curl '${r}/api/import/request-translations' \\
  --data-raw '{"grid_uuid":"${i}","translations_requests":${JSON.stringify(Object.entries(n).map(([u,{value:h,ns:g}])=>({key:g&&u.startsWith(`${g}:`)?u.slice(g.length+1):u,lang:"en",default:h}))).replaceAll("'","'\\''")}}'
    `),console.groupEnd()};return{handleMissingKey(u,h="",g=s){a&&(n[`${g}:${u}`]={value:h,ns:g},l&&clearTimeout(l),l=setTimeout(p,d))}}}const So="a656ff82-0270-46dc-8de8-c734318d841d",nn="https://i18n-fastly.ultrafast.io",ln="https://neo.wordplex.io",Co="asset-picker",cn=on({gridUuid:So,namespace:Co,cdnUrl:nn}),dn=cn.initI18n,hn=an({lsKey:"apTranslationsMissingKeysEnabled",namespace:Co,gridUuid:So,prodUrl:ln,logPrefix:"[asset-picker]"});class pn{constructor(e,s){this.host=e,this.store=s,e.addController(this)}get state(){return this.store.getState()}setState(e){this.store.setState(e)}hostConnected(){this.unsubscribe=this.store.subscribe(()=>{this.host.requestUpdate()})}hostDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this)}}function un(t){return"extension"in t&&!("path"in t)}class fn{constructor(e,s){this.lastClickedIndex=-1,this.host=e,this.store=s,e.addController(this)}hostConnected(){}hostDisconnected(){}get _folderSelectionEnabled(){var e;return((e=this.store.getState().config)==null?void 0:e.folderSelection)===!0}_getCombinedList(){const e=this.store.getState();return this._folderSelectionEnabled?[...e.folders,...e.assets]:e.assets}_applyRangeSelection(e,s,i,r){const o=this.store.getState(),a=this._getCombinedList();for(let n=e;n<=s;n++){const l=a[n];l&&(un(l)?o.disabledAssetIds.has(l.uuid)||i.set(l.uuid,l):o.disabledFolderIds.has(l.uuid)||r.set(l.uuid,l))}}handleSelect(e,s,i){var n,l,d,p;const r=this.store.getState();if(r.disabledAssetIds.has(e.uuid))return;const o=new Map(r.selectedAssets);if(!(((n=r.config)==null?void 0:n.multiSelect)??!0)){o.clear(),o.set(e.uuid,e),this.store.setState({selectedAssets:o,selectedFolders:new Map}),this.lastClickedIndex=s;return}if(i.shiftKey&&this.lastClickedIndex>=0)if(this._folderSelectionEnabled){const u=Math.min(this.lastClickedIndex,s),h=Math.max(this.lastClickedIndex,s),g=new Map(r.selectedFolders);this._applyRangeSelection(u,h,o,g);const v=(l=r.config)==null?void 0:l.maxSelections;if(v&&o.size+g.size>v)return;this.store.setState({selectedAssets:o,selectedFolders:g})}else{const u=Math.min(this.lastClickedIndex,s),h=Math.max(this.lastClickedIndex,s),g=r.assets;for(let y=u;y<=h;y++)g[y]&&!r.disabledAssetIds.has(g[y].uuid)&&o.set(g[y].uuid,g[y]);const v=(d=r.config)==null?void 0:d.maxSelections;if(v&&o.size>v)return;this.store.setState({selectedAssets:o})}else if(i.metaKey||i.ctrlKey){o.has(e.uuid)?o.delete(e.uuid):o.set(e.uuid,e);const u=(p=r.config)==null?void 0:p.maxSelections,h=o.size+(this._folderSelectionEnabled?r.selectedFolders.size:0);if(u&&h>u)return;this.store.setState({selectedAssets:o})}else o.clear(),o.set(e.uuid,e),this.store.setState({selectedAssets:o,selectedFolders:new Map});this.lastClickedIndex=s}handleFolderSelect(e,s,i){var n,l,d;if(!this._folderSelectionEnabled)return;const r=this.store.getState();if(r.disabledFolderIds.has(e.uuid))return;const o=new Map(r.selectedFolders);if(!(((n=r.config)==null?void 0:n.multiSelect)??!0)){o.clear(),o.set(e.uuid,e),this.store.setState({selectedFolders:o,selectedAssets:new Map}),this.lastClickedIndex=s;return}if(i.shiftKey&&this.lastClickedIndex>=0){const p=Math.min(this.lastClickedIndex,s),u=Math.max(this.lastClickedIndex,s),h=new Map(r.selectedAssets);this._applyRangeSelection(p,u,h,o);const g=(l=r.config)==null?void 0:l.maxSelections;if(g&&h.size+o.size>g)return;this.store.setState({selectedAssets:h,selectedFolders:o})}else if(i.metaKey||i.ctrlKey){o.has(e.uuid)?o.delete(e.uuid):o.set(e.uuid,e);const p=(d=r.config)==null?void 0:d.maxSelections,u=o.size+r.selectedAssets.size;if(p&&u>p)return;this.store.setState({selectedFolders:o})}else o.clear(),o.set(e.uuid,e),this.store.setState({selectedFolders:o,selectedAssets:new Map});this.lastClickedIndex=s}isSelected(e){return this.store.getState().selectedAssets.has(e)}isFolderSelected(e){return this.store.getState().selectedFolders.has(e)}resetRange(){this.lastClickedIndex=-1}selectAll(e){var l;const s=this.store.getState(),i=(l=s.config)==null?void 0:l.maxSelections,r=this._folderSelectionEnabled?s.selectedFolders.size:0,o=e.filter(d=>!s.disabledAssetIds.has(d.uuid)),a=new Map,n=i?Math.max(0,Math.min(o.length,i-r)):o.length;for(let d=0;d<n;d++)a.set(o[d].uuid,o[d]);return this.store.setState({selectedAssets:a}),this.lastClickedIndex=-1,a.size}selectAllFolders(e){var n;if(!this._folderSelectionEnabled)return;const s=this.store.getState(),i=(n=s.config)==null?void 0:n.maxSelections,r=e.filter(l=>!s.disabledFolderIds.has(l.uuid)),o=new Map,a=i?Math.max(0,Math.min(r.length,i-s.selectedAssets.size)):r.length;for(let l=0;l<a;l++)o.set(r[l].uuid,r[l]);this.store.setState({selectedFolders:o})}clearSelection(){this.store.setState({selectedAssets:new Map,selectedFolders:new Map}),this.lastClickedIndex=-1}getSelectedAssets(){return Array.from(this.store.getState().selectedAssets.values())}getSelectedFolders(){return Array.from(this.store.getState().selectedFolders.values())}}const Vr=5,Ht=40,Hr=15;class Yi{constructor(e,s){this.host=e,this.options=s,this.isActive=!1,this.rect={x:0,y:0,width:0,height:0},this.startX=0,this.startY=0,this.startClientX=0,this.startClientY=0,this.preMarquee=new Set,this.dragging=!1,this.scrollRAF=null,this.lastMouseEvent=null,this.cardRects=[],this.appliedSelection=null,this.handleMouseDown=i=>this.onMouseDown(i),this.handleMouseMove=i=>this.onMouseMove(i),this.handleMouseUp=()=>this.onMouseUp(),this.preventSelect=i=>i.preventDefault(),e.addController(this)}hostConnected(){}hostDisconnected(){this.detach()}attach(e){this.container!==e&&(this.detach(),this.container=e,e.addEventListener("mousedown",this.handleMouseDown))}detach(){var e,s;(e=this.container)==null||e.removeEventListener("mousedown",this.handleMouseDown),document.removeEventListener("mousemove",this.handleMouseMove),document.removeEventListener("mouseup",this.handleMouseUp),document.removeEventListener("selectstart",this.preventSelect),this.stopAutoScroll(),(s=this.container)==null||s.classList.remove("marqueeing"),this.container=void 0,this.lastMouseEvent=null,this.cardRects=[],this.appliedSelection=null}isInteractiveTarget(e){return this.options.isInteractiveTarget?this.options.isInteractiveTarget(e):e.composedPath().some(s=>s instanceof HTMLElement?s instanceof HTMLButtonElement||s instanceof HTMLInputElement||s instanceof HTMLAnchorElement?!0:s.hasAttribute("data-uuid")||s.tagName==="TR"||s.tagName==="TABLE":!1)}onMouseDown(e){if(e.button!==0||!this.container||this.isInteractiveTarget(e))return;const s=this.container.getBoundingClientRect();this.startX=e.clientX-s.left+this.container.scrollLeft,this.startY=e.clientY-s.top+this.container.scrollTop,this.startClientX=e.clientX,this.startClientY=e.clientY,this.preMarquee=new Set(this.options.getSelection(e)),this.dragging=!1,this.isActive=!1,document.addEventListener("mousemove",this.handleMouseMove),document.addEventListener("mouseup",this.handleMouseUp)}onMouseMove(e){var s;if(this.container){if(!this.dragging){const i=Math.abs(e.clientX-this.startClientX),r=Math.abs(e.clientY-this.startClientY);if(i<Vr&&r<Vr)return;this.dragging=!0,this.isActive=!0,this.container.classList.add("marqueeing"),document.addEventListener("selectstart",this.preventSelect),(s=window.getSelection())==null||s.removeAllRanges(),this.cacheCards()}this.lastMouseEvent=e,this.updateRect(e),this.maybeAutoScroll(e)}}updateRect(e){if(!this.container)return;const s=this.container.getBoundingClientRect(),i=e.clientX-s.left+this.container.scrollLeft,r=e.clientY-s.top+this.container.scrollTop;let o=Math.min(this.startX,i),a=Math.min(this.startY,r),n=Math.abs(i-this.startX),l=Math.abs(r-this.startY);o<0&&(n+=o,o=0),a<0&&(l+=a,a=0),o+n>this.container.scrollWidth&&(n=this.container.scrollWidth-o),a+l>this.container.scrollHeight&&(l=this.container.scrollHeight-a),this.rect={x:o,y:a,width:n,height:l},this.applyBoxStyle(),this.selectIntersecting()}maybeAutoScroll(e){if(!this.container||this.container.scrollHeight<=this.container.clientHeight){this.stopAutoScroll();return}const s=this.container.getBoundingClientRect(),i=e.clientY-s.top<Ht||s.bottom-e.clientY<Ht;i&&this.scrollRAF==null?this.scrollRAF=requestAnimationFrame(()=>this.autoScrollTick()):i||this.stopAutoScroll()}autoScrollTick(){if(this.scrollRAF=null,!this.container||!this.dragging||!this.lastMouseEvent||this.container.scrollHeight<=this.container.clientHeight)return;const e=this.container.getBoundingClientRect(),s=this.lastMouseEvent,i=s.clientY-e.top,r=e.bottom-s.clientY;let o=0;i<Ht?o=-Hr*(1-i/Ht):r<Ht&&(o=Hr*(1-r/Ht)),o!==0&&(this.container.scrollTop+=o,this.updateRect(s),this.scrollRAF=requestAnimationFrame(()=>this.autoScrollTick()))}stopAutoScroll(){this.scrollRAF!=null&&(cancelAnimationFrame(this.scrollRAF),this.scrollRAF=null)}onMouseUp(){var e;document.removeEventListener("mousemove",this.handleMouseMove),document.removeEventListener("mouseup",this.handleMouseUp),document.removeEventListener("selectstart",this.preventSelect),this.stopAutoScroll(),this.lastMouseEvent=null,this.dragging&&(this.dragging=!1,this.isActive=!1,this.rect={x:0,y:0,width:0,height:0},this.cardRects=[],this.appliedSelection=null,(e=this.container)==null||e.classList.remove("marqueeing"),this.host.requestUpdate())}cacheCards(){if(!this.container)return;const e=this.container.getBoundingClientRect(),s=this.container.scrollLeft,i=this.container.scrollTop;this.cardRects=[];for(const{uuid:r,el:o}of this.options.queryCards(this.container)){if(!r)continue;const a=o.getBoundingClientRect();this.cardRects.push({uuid:r,x:a.left-e.left+s,y:a.top-e.top+i,w:a.width,h:a.height})}}applyBoxStyle(){var s;const e=(s=this.container)==null?void 0:s.querySelector(".marquee-box");if(!e){this.host.requestUpdate();return}e.style.left=`${this.rect.x}px`,e.style.top=`${this.rect.y}px`,e.style.width=`${this.rect.width}px`,e.style.height=`${this.rect.height}px`}static sameSet(e,s){if(!s||e.size!==s.size)return!1;for(const i of e)if(!s.has(i))return!1;return!0}selectIntersecting(){const e=new Set(this.preMarquee),{x:s,y:i,width:r,height:o}=this.rect;for(const a of this.cardRects)s<a.x+a.w&&s+r>a.x&&i<a.y+a.h&&i+o>a.y&&e.add(a.uuid);Yi.sameSet(e,this.appliedSelection)||(this.appliedSelection=e,this.options.setSelection(e))}}class gn{constructor(e,s){this.onLoadMore=s,e.addController(this)}hostConnected(){}hostDisconnected(){this.disconnect()}observe(e,s,i="200px"){this.disconnect(),this.sentinel=e,this.observer=new IntersectionObserver(r=>{var o;(o=r[0])!=null&&o.isIntersecting&&this.onLoadMore()},{root:s??null,rootMargin:i}),this.observer.observe(e)}disconnect(){this.observer&&this.sentinel&&(this.observer.unobserve(this.sentinel),this.observer.disconnect()),this.observer=void 0,this.sentinel=void 0}}const mn="https://api.filerobot.com",vn=3e4,bn=2,xn=400;function _n(t){return t===404||t===408||t===429||t>=500}const yn=t=>new Promise(e=>setTimeout(e,t));function Ao(t,e){return`${(e||mn).replace(/\/+$/,"")}/${t}`}async function $n(t,e,s,i={}){const r=`${Ao(t,s)}/key/${encodeURIComponent(e)}`,o=i.retries??bn,a=i.retryDelayMs??xn;let n=new Error("SASS key exchange failed");for(let l=0;l<=o;l++){l>0&&await yn(a*l);const d=new AbortController,p=setTimeout(()=>d.abort(),vn);try{const u=await fetch(r,{signal:d.signal,cache:"no-store"});if(clearTimeout(p),!u.ok){if(n=new Error(`SASS key exchange failed (HTTP ${u.status})`),_n(u.status)&&l<o)continue;throw n}const h=await u.json();if(h.status==="error")throw new Error(`SASS key exchange failed: ${h.msg||"Unknown error"}`);return h.key}catch(u){if(clearTimeout(p),u instanceof DOMException&&u.name==="AbortError")throw new Error("SASS key exchange timed out");if(u instanceof TypeError&&l<o){n=u;continue}throw u}}throw n}function qr(t,e){const s={};switch(t.mode){case"security-template":if(!e)throw new Error("[dam-core] Cannot build auth headers for security-template mode: SASS key exchange has not been performed. Call resolveAuth() first, or use sass-key mode.");s["X-Filerobot-Key"]=e;break;case"sass-key":s["X-Filerobot-Key"]=t.sassKey;break}return t.airboxPuid&&(s["X-Filerobot-Airbox-Puid"]=t.airboxPuid),s}function wn(t){return t.mode==="securityTemplate"||t.mode==="sassKey"}function kn(t){return wn(t)?t.mode==="securityTemplate"?{mode:"security-template",container:t.projectToken,securityTemplateId:t.securityTemplateKey,airboxPuid:t.airboxPuid}:{mode:"sass-key",container:t.projectToken,sassKey:t.sassKey,airboxPuid:t.airboxPuid}:t}async function Gr(t,e){const s=kn(t),i=Ao(s.container,e);if(s.mode==="security-template"){const r=await $n(s.container,s.securityTemplateId,e);return{apiBase:i,headers:qr(s,r),sassKey:r}}return{apiBase:i,headers:qr(s)}}const Sn=3e4;class Qi{constructor(e,s,i){this.baseUrl=`${e.apiBase}/v5`,this.headers=e.headers,this.auth=s,this.apiDomain=i}static async create(e,s){const i=await Gr(e,s);return new Qi(i,e,s)}get(e,s){const i=new URL(`${this.baseUrl}${e}`);if(s)for(const[r,o]of Object.entries(s))o!=null&&i.searchParams.set(r,Array.isArray(o)?o.join(","):String(o));return this.send(i,{method:"GET"})}post(e,s){return this.sendJson("POST",e,s)}put(e,s){return this.sendJson("PUT",e,s)}delete(e,s){return this.sendJson("DELETE",e,s)}absoluteUrl(e){return`${this.baseUrl}${e}`}get authKey(){return this.headers["X-Filerobot-Key"]}sendJson(e,s,i){return this.send(new URL(`${this.baseUrl}${s}`),{method:e,headers:{"Content-Type":"application/json"},body:i===void 0?void 0:JSON.stringify(i)})}async send(e,s,i=!1){var a;const r=new AbortController,o=setTimeout(()=>r.abort(),Sn);try{const n=await fetch(e.toString(),{...s,headers:{...this.headers,...s.headers},signal:r.signal});if(clearTimeout(o),n.status===401&&!i&&((a=this.auth)==null?void 0:a.mode)==="security-template"){const p=await Gr(this.auth,this.apiDomain);return this.headers=p.headers,this.send(e,s,!0)}if(!n.ok){let p=`API error: ${n.status} ${n.statusText}`;try{const u=await n.json();u!=null&&u.msg&&(p=`API error: ${n.status} - ${u.msg}`)}catch{}throw new Error(p)}if(n.status===204)return;const l=await n.text();if(!l)return;const d=JSON.parse(l);if((d==null?void 0:d.status)==="error")throw new Error(`API error: ${d.msg||"Unknown error"}`);return d}catch(n){throw clearTimeout(o),n instanceof DOMException&&n.name==="AbortError"?new Error("API request timed out"):n}}}async function Cn(t,e,s){const i=s.replace(/\/+$/,""),r=i?`${i}/${e}`:`/${e}`,o=await t.post("/folders",{name:r});if(o.status!=="success")throw new Error(o.msg||"Failed to create folder")}async function An(t){return(await t.get("/labels")).labels??[]}const En=["cdn_permalink"],Eo={created_at:"created_at",modified_at:"modified_at",name:"name",size:"size",type:"type"};function Fn(t){let e=t.fields??En;t.permalinksEnabled||(e=e.filter(a=>a!=="cdn_permalink"));const s={offset:t.offset??0,limit:t.limit??100,format:"json,regvar:api,select:internal",preview:2301,recursive:t.recursive??1};e.length>0&&(s.fields=e);const i=t.sort_by??"created_at",r=t.sort_direction??"desc";s.sort=`${Eo[i]||i}:${r}`,t.folder&&(s.folder=t.folder);const o=[];return t.search&&!t.with_ai&&o.push(t.search),t.q&&o.push(t.q),o.length>0&&(s.q=o.join(" ")),t.with_ai&&(s.with_ai=!0,t.ai_query&&(s.ai_query=t.ai_query),t.ai_lang&&(s.ai_lang=t.ai_lang)),t.collection_uuid&&(s.collection_uuid=t.collection_uuid),t.f64&&(s.f64=t.f64),s}function St(t,e){return t.get("/files",Fn(e))}function Qs(t,e){const s={recursive:e.recursive??1};e.folder&&(s.folder=e.folder);const i=[];return e.search&&!e.with_ai&&i.push(e.search),e.q&&i.push(e.q),i.length>0&&(s.q=i.join(" ")),e.with_ai&&(s.with_ai=!0,e.ai_query&&(s.ai_query=e.ai_query),e.ai_lang&&(s.ai_lang=e.ai_lang)),e.collection_uuid&&(s.collection_uuid=e.collection_uuid),e.f64&&(s.f64=e.f64),t.get("/files/stats",s)}function Tn(t,e={}){const s={recursive:e.recursive??0,folder:e.folderPath??"/",limit:e.limit??1e3,offset:e.offset??0};e.q&&(s.q=e.q);const i=e.sort_by??"created_at",r=e.sort_direction??"asc";return s.sort=`${Eo[i]||i}:${r}`,t.get("/folders",s)}async function Ln(t,e){return e.length===0?{}:(await t.post("/folders/previews",{folders:e})).folders||{}}const b="https://scaleflex.cloudimg.io/v7/assets/file-types/v3/",On='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none"><path d="M24 4 42 14v20L24 44 6 34V14z" fill="#eef2ff" stroke="#6366f1" stroke-width="2" stroke-linejoin="round"/><path d="M24 4 42 14 24 24 6 14z" fill="#c7d2fe" stroke="#6366f1" stroke-width="2" stroke-linejoin="round"/><path d="M24 24v20M24 24 6 14M24 24 42 14" stroke="#6366f1" stroke-width="2" stroke-linejoin="round"/></svg>',Xe=`data:image/svg+xml,${encodeURIComponent(On)}`,ji={_default:b+"GENERIC.svg?vh=9a518a",png:b+"PNG.svg?vh=96cd9a",jpg:b+"JPG.svg?vh=06e819",jpg2:b+"JPG2.svg?vh=f0eb7f",jpeg:b+"JPEG.svg?vh=6a65e9",gif:b+"GIF.svg?vh=c3c2c3",bmp:b+"BMP.svg?vh=d2243a",webp:b+"WEBP.svg?vh=fedd74",svg:b+"SVG.svg?vh=a15e46",tiff:b+"TIFF.svg?vh=1f30c3",tif:b+"TIF.svg?vh=b383c9",heic:b+"HEIC.svg?vh=84adfe",avif:b+"AVIF.svg?vh=536b30",ico:b+"ICO.svg?vh=79063d",psd:b+"PSD.svg?vh=be6140",psb:b+"PSB.svg?vh=678646",ai:b+"AI.svg?vh=84b254",dwg:b+"DWG.svg?vh=971fb3",mp4:b+"MP4.svg?vh=42f175",webm:b+"WEBM.svg?vh=26a84a",avi:b+"AVI.svg?vh=d22ba8",mpeg:b+"MPEG.svg?vh=ba93bb",ogv:b+"OGV.svg?vh=74d453","3gp":b+"3GP.svg?vh=f0d388","3g2":b+"3G2.svg?vh=04c652",swf:b+"SWF.svg?vh=3955e2",fla:b+"FLA.svg?vh=daf585",m3u8:b+"M3U8.svg?vh=7d5e62",mp3:b+"MP3.svg?vh=66bbef",wav:b+"WAV.svg?vh=d7a7d5",aac:b+"AAC.svg?vh=07f3f9",oga:b+"OGA.svg?vh=a5c622",opus:b+"OPUS.svg?vh=9548b1",weba:b+"WEBA.svg?vh=4dcf70",mid:b+"MID.svg?vh=3f0e29",midi:b+"MIDI.svg?vh=9fedec",cda:b+"CDA.svg?vh=85b83b",pdf:b+"PDF.svg?vh=18c5f7",doc:b+"DOC.svg?vh=d1b47c",docx:b+"DOCX.svg?vh=1eb6b0",txt:b+"TXT.svg?vh=307979",rtf:b+"RTF.svg?vh=978c5f",xls:b+"XLS.svg?vh=13b5f7",xlsx:b+"XLSX.svg?vh=79d64a",ppt:b+"PPT.svg?vh=4ee29b",pptx:b+"PPTX.svg?vh=8b1568",csv:b+"CSV.svg?vh=4add78",odt:b+"ODT.svg?vh=940781",ods:b+"ODS.svg?vh=9fbe9a",odp:b+"ODP.svg?vh=bf892d",dbf:b+"DBF.svg?vh=457bd4",vsd:b+"VSD.svg?vh=8a9ccb",abw:b+"ABW.svg?vh=313dc7",epub:b+"EPUB.svg?vh=15263d",azw:b+"AZW.svg?vh=a018b1",ics:b+"ICS.svg?vh=909f63",ogx:b+"OGX.svg?vh=f694d2",zip:b+"ZIP.svg?vh=84f98b",rar:b+"RAR.svg?vh=1d6423","7z":b+"7Z.svg?vh=e007e5",tar:b+"TAR.svg?vh=603aed",gz:b+"GZ.svg?vh=de13f7",bz:b+"BZ.svg?vh=0374ff",bz2:b+"BZ2.svg?vh=e14294",arc:b+"ARC.svg?vh=942fad",jar:b+"JAR.svg?vh=149796",mpkg:b+"MPKG.svg?vh=dea655",ttf:b+"TTF.svg?vh=d2e2c1",otf:b+"OTF.svg?vh=c904fd",woff:b+"WOFF.svg?vh=4b8177",woff2:b+"WOFF2.svg?vh=b532d3",eot:b+"EOT.svg?vh=a54980",js:b+"JS.svg?vh=524691",mjs:b+"MJS.svg?vh=d57921",ts:b+"TS.svg?vh=9af3ae",css:b+"CSS.svg?vh=287863",html:b+"HTML.svg?vh=fa7a87",htm:b+"HTM.svg?vh=21323d",xhtml:b+"XHTML.svg?vh=e6d6a9",xul:b+"XUL.svg?vh=6c9c71",json:b+"JSON.svg?vh=104c9e",jsonld:b+"JSONLD.svg?vh=f30c0f",xml:b+"XML.svg?vh=7f7194",php:b+"PHP.svg?vh=503e36",sh:b+"SH.svg?vh=3b820e",csh:b+"CSH.svg?vh=08c0cc",exe:b+"EXE.svg?vh=ccca53",iso:b+"ISO.svg?vh=064b8f",bin:b+"BIN.svg?vh=1e9618",glb:Xe,gltf:Xe,obj:Xe,fbx:Xe,stl:Xe,usdz:Xe,ply:Xe,"3ds":Xe,dae:Xe};function Xt(){return ji._default}function Us(t){const e=(t.split(".").pop()||"").toLowerCase();return ji[e]||ji._default}function Pn(t,e){let s;const i=((...r)=>{clearTimeout(s),s=setTimeout(()=>t(...r),e)});return i.cancel=()=>clearTimeout(s),i}async function In(t){return t.get("/collections")}async function Dn(t,e){return t.get(`/collections/${e}/folders`)}function Fo(t){return t.filter(e=>!!e.name).map(e=>({...e,children:Fo(e.children??[])})).filter(e=>{var s;return!((((s=e.children)==null?void 0:s.length)??0)<1&&!e.filters)})}async function Mn(t){return((await t.get("/tags")).tags||[]).map(i=>({...i,label:i.names.en||Object.values(i.names)[0]||""})).filter(i=>i.label).sort((i,r)=>i.label.localeCompare(r.label))}const Rn=3e4;async function zn(t,e){const s=`${e}/key/${t.securityTemplateKey}`,i=new AbortController,r=setTimeout(()=>i.abort(),Rn);try{const o=await fetch(s,{headers:{"X-Filerobot-Key":t.securityTemplateKey},signal:i.signal});if(clearTimeout(r),!o.ok){let n=`API error: ${o.status} ${o.statusText}`;try{const l=await o.json();l.msg&&(n=`API error: ${o.status} - ${l.msg}`)}catch{}throw new Error(n)}const a=await o.json();if(a.status==="error")throw new Error(`API error: ${a.msg||"Unknown error"}`);return{key:a.key,permissions:a.permissions??[]}}catch(o){throw clearTimeout(r),o instanceof DOMException&&o.name==="AbortError"?new Error("API request timed out"):o}}function Nn(t,e){return t?t.includes(e):!1}const jn={FOLDER_CREATE:"DIR_CREATE"};function Un(t){var r,o;const e=(r=t.info)==null?void 0:r.playlists;if(!(e!=null&&e.length))return null;const s=(o=e[0])==null?void 0:o.playlists;return s!=null&&s.length&&s[0]||null}function Gt(t){return(t.type??"").startsWith("image")}function Yr(t){var e,s;return((e=t.info)==null?void 0:e.img_w)??((s=t.info)==null?void 0:s.video_w)??0}function Qr(t){var e,s;return((e=t.info)==null?void 0:e.img_h)??((s=t.info)==null?void 0:s.video_h)??0}const Kn={excellent:90,good:75,fair:60},Bn=[{label:"WEBP",value:"webp"},{label:"JPEG",value:"jpeg"},{label:"PNG",value:"png"},{label:"GIF",value:"gif"}],Vn=[{label:"Excellent",value:"excellent"},{label:"Good",value:"good"},{label:"Fair",value:"fair"}],Hn=[{label:"Original",value:"original"},{label:"Full HD",value:"full_hd",width:1920},{label:"Large",value:"large",width:1200},{label:"Medium",value:"medium",width:600},{label:"Small",value:"small",width:300}],qn={webp:"awebp,webp",jpeg:"jpeg",png:"png",gif:"agif,gif"},Gn=new Set(["jpg","jpeg","png","gif","webp","svg","bmp","ico","tiff","tif","avif","heic","heif","psd","eps"]),Yn=new Set([...Gn,"pdf","psd","eps","ai","ttf","otf","woff","woff2","eot"]);function Qt(t){if(!t)return"other";const e={image:"image",video:"video",audio:"audio",application:"document",font:"font",text:"document"};return e[t]?e[t]:t.startsWith("image/")?"image":t.startsWith("video/")?"video":t.startsWith("audio/")?"audio":t.startsWith("application/pdf")||t.startsWith("text/")||t.startsWith("application/msword")||t.startsWith("application/vnd.")?"document":t.startsWith("application/zip")||t.startsWith("application/x-rar")||t.startsWith("application/x-7z")||t.startsWith("application/gzip")?"archive":t.startsWith("font/")?"font":"other"}function To(t){const e=(t==null?void 0:t.toLowerCase().replace(".",""))||"";return Yn.has(e)}function bi(t){if(!t)return"";const e=t.split("/");return e.length>1?e[1]:e[0]}const Qn=new Set(["png","svg","webp","gif","avif"]);function Wi(t){const e=(t==null?void 0:t.toLowerCase().replace(".",""))||"";return Qn.has(e)}const Wn=new Set(["svg","svg+xml","png","pdf"]);function Lo(t){return Wn.has(bi(t).toLowerCase())}let Ui=null;function Xn(t){Ui=t??null}function Je(t,e){if(!t||!Ui)return t;try{return Ui(t,e)||t}catch(s){return console.warn("[asset-picker] transformRemoteThumbnail threw:",s),t}}function ci(t){var i;const e=t.info,s=(e==null?void 0:e.video_thumbnail)||(e==null?void 0:e.image_thumbnail)||(e==null?void 0:e.thumbnail)||(e==null?void 0:e.preview)||((i=t.url)==null?void 0:i.cdn)||"";return Je(Jt(s),{source:"asset",asset:t})}function Oo(t){const e=t.info,s=(e==null?void 0:e.video_thumbnail)||(e==null?void 0:e.image_thumbnail)||(e==null?void 0:e.thumbnail)||"";return s?Je(Jt(s),{source:"video",asset:t}):""}function Xi(t){var s,i;let e=Jt(((s=t.url)==null?void 0:s.cdn)||((i=t.url)==null?void 0:i.public)||"");return e?(e=e.replace(/([?&])func=proxy&?/,"$1").replace(/[?&]$/,""),Je(Lt(e,{w:"200",force_format:"webp,jpeg",doc_page:"1",bypass_process_proxy:"1"}),{source:"pdf",asset:t})):""}function Lt(t,e){try{const s=new URL(t);for(const[i,r]of Object.entries(e))s.searchParams.set(i,r);return s.toString()}catch{return t}}const Wr=/^(https:\/\/)([a-z0-9_-]+)\.filerobot\.com\/(?:v\d+\/)?/i;function Jt(t,e){if(!t)return"";const s=r=>r.replace(/(\.filerobot\.com\/[a-z0-9_-]+)\/v\d+\//i,"$1/");if(t.includes("assets.filerobot.com"))return s(t);const i=t.match(Wr);if(i){const r=i[2],o=t.replace(Wr,`$1assets.filerobot.com/${r}/`);return s(o)}if(e)try{const r=new URL(t);return s(`https://assets.filerobot.com/${e}${r.pathname}${r.search}`)}catch{}return t}function Po(t,e){const s=t.file_uri_cdn;if(!s)return"";let i=Jt(s);const r=Qt(t.file_type),o=String(window.devicePixelRatio||1);let a;return r==="video"?a=Lt(i,{w:e,dpr:o,force_format:"webp,jpeg"}):t.file_type==="application/pdf"||bi(t.file_type).toLowerCase()==="pdf"?(i=i.replace(/([?&])func=proxy&?/,"$1").replace(/[?&]$/,""),a=Lt(i,{w:e,dpr:o,force_format:"webp,jpeg",doc_page:"1",bypass_process_proxy:"1"})):a=Lt(i,{w:e,dpr:o}),Je(a,{source:"folder"})}function Jn(t,e){const s={};return t.format&&(s.force_format=qn[t.format]),t.quality&&t.format!=="png"&&(s.q=String(Kn[t.quality])),t.width&&(s.w=String(t.width)),t.height&&(s.h=String(t.height)),(t.width||t.height)&&(s.org_if_sml="1",e!=null&&e.isMultiSelect?s.func="bound":(e==null?void 0:e.isAspectLocked)===!1&&(s.func="cover")),s}const w={TYPE:"type",MIME_TYPE:"mimetype",METADATA:"metadata",DATE:"date",APPROVAL:"approval",SIZE:"size",LICENSE_EXPIRY:"asset_expiration",TAGS:"tags",IMAGE:"image",LABELS:"labels",PRODUCT_REF:"product_ref",FACES:"faces",COLOR:"color"},D={STATUS:"approval_status",APPROVER:"task_approver",REQUESTOR:"task_requester",DUE_DATE:"task_duedate"},M={IS:":",RANGE:"..",IS_NOT:":-",IS_EXACT:":=",CONTAINS_IN_TEXT:"~~~",GREATER_THAN_OR_EQUAL:">=",LESS_THAN_OR_EQUAL:"<="},Zn={AND:"AND"},P={NUMERIC:"numeric",SELECT_ONE:"select-one",MULTI_SELECT:"multi-select",TEXT_AREA:"textarea",TEXT:"text",SUPERTAGS:"tags",DATE:"date",BOOLEAN:"boolean",ATTACHMENTS_ASSETS:"attachments-assets",ATTACHMENT_URI:"attachment-uri",GEO_POINT:"geopoint",DECIMAL2:"decimal2",INTEGER_LIST:"integer-list"},xi={[P.DATE]:"date_",[P.BOOLEAN]:"bool_",[P.NUMERIC]:"num_",[P.DECIMAL2]:"dec_",[P.ATTACHMENTS_ASSETS]:"attach_",[P.ATTACHMENT_URI]:"uri_",[P.SELECT_ONE]:"one_",[P.MULTI_SELECT]:"multi_",[P.SUPERTAGS]:"tags_",[P.TEXT]:"text_",[P.TEXT_AREA]:"area_",[P.GEO_POINT]:"geo_",[P.INTEGER_LIST]:"intlist_"};Object.fromEntries(Object.entries(xi).map(([t,e])=>[e,t]));const Io=Object.values(xi),ze={PRESET:"preset",AFTER:"after",BEFORE:"before",BETWEEN:"between",SPECIFIC:"specific"},Xr={EMPTY:"empty",NOT_EMPTY:"non-empty"},Ce="empty",Ae="non-empty",Ct="specific",Ti=10,gs=10,Ws=10,Do="filters:pinned:",Mo="metadata:pinned:",Jr=[w.DATE,w.TYPE,w.SIZE],Ro=M.IS,Zs="20",ei="1",el=0,tl=[{key:w.DATE,labelKey:"filterDate",label:"Date",icon:"calendar",type:"date"},{key:w.TYPE,labelKey:"filterFormat",label:"Format",icon:"file-type",type:"string"},{key:w.SIZE,labelKey:"filterSize",label:"Size",icon:"scaling",type:"string"},{key:w.LICENSE_EXPIRY,labelKey:"filterLicenseExpiry",label:"License expiry",icon:"history",type:"date"},{key:w.TAGS,labelKey:"filterTags",label:"Tags",icon:"hash",type:"string"},{key:w.LABELS,labelKey:"filterLabels",label:"Labels",icon:"tag",type:"string"},{key:w.PRODUCT_REF,labelKey:"filterProducts",label:"Products",icon:"box",type:"string"},{key:w.IMAGE,labelKey:"filterImage",label:"Image",icon:"image",type:"string"},{key:w.COLOR,labelKey:"filterColor",label:"Color",icon:"swatch-book",type:"string"}],sl={key:w.METADATA,labelKey:"filterMetadata",label:"Metadata",icon:"file-text",type:"string"},il={key:w.APPROVAL,labelKey:"filterApproval",label:"Approval",icon:"badge-check",type:"string"},As=[sl,...tl,il],Yt={[w.TYPE]:"Format",[w.DATE]:"Date",[w.SIZE]:"Size",[w.LICENSE_EXPIRY]:"License expiry",[w.TAGS]:"Tags",[w.LABELS]:"Labels",[w.PRODUCT_REF]:"Products",[w.IMAGE]:"Image",[w.COLOR]:"Color",[w.METADATA]:"Metadata",[w.APPROVAL]:"Approval",[D.STATUS]:"Approval",[D.APPROVER]:"Approval",[D.REQUESTOR]:"Approval",[D.DUE_DATE]:"Approval"},xs={...Object.fromEntries(As.map(t=>[t.key,t.labelKey])),[D.STATUS]:"filterApproval",[D.APPROVER]:"filterApproval",[D.REQUESTOR]:"filterApproval",[D.DUE_DATE]:"filterApproval"},xe={IMAGE:"image",VIDEO:"video",AUDIO:"audio",DOCUMENT:"document",ARCHIVE:"archive",DESIGN_TEMPLATE:"template_fdt",OTHER:"other",FONTS:"font"},di=[{value:xe.IMAGE,labelKey:"assetTypeImage",label:"Image",icon:"image"},{value:xe.VIDEO,labelKey:"assetTypeVideo",label:"Video",icon:"clapperboard"},{value:xe.AUDIO,labelKey:"assetTypeAudio",label:"Audio",icon:"music"},{value:xe.DOCUMENT,labelKey:"assetTypeDocument",label:"Document",icon:"document"},{value:xe.ARCHIVE,labelKey:"assetTypeArchive",label:"Archive",icon:"archive"},{value:xe.DESIGN_TEMPLATE,labelKey:"assetTypeDesignTemplate",label:"Design template",icon:"layout-template"},{value:xe.FONTS,labelKey:"assetTypeFonts",label:"Fonts",icon:"text"},{value:xe.OTHER,labelKey:"assetTypeOther",label:"Other",icon:"layout-grid"}],rl={[xe.IMAGE]:["jpg","jpeg","png","gif","webp","svg","bmp","ico","tiff","tif","avif","heic","heif","psd","eps"],[xe.VIDEO]:["mp4","webm","ogg","mov","avi","mkv","flv","wmv","m4v"],[xe.AUDIO]:["mp3","wav","ogg","flac","aac","wma","m4a","opus"],[xe.DOCUMENT]:["pdf","doc","docx","xls","xlsx","ppt","pptx","txt","csv","rtf","odt","ods","odp","html"],[xe.ARCHIVE]:["zip","rar","7z","tar","gz","bz2","xz"],[xe.FONTS]:["ttf","otf","woff","woff2","eot"]},Li={RESOLUTION:0,ORIENTATION:1,FACES:2},ol=[{value:"small",label:"Small",labelKey:"resolutionSmall"},{value:"medium",label:"Medium",labelKey:"resolutionMedium"},{value:"large",label:"Large",labelKey:"resolutionLarge"}],al=[{value:"portrait",label:"Portrait",labelKey:"orientationPortrait"},{value:"landscape",label:"Landscape",labelKey:"orientationLandscape"},{value:"square",label:"Square",labelKey:"orientationSquare"},{value:"panorama",label:"Panorama",labelKey:"orientationPanorama"}],nl=[{value:"none",label:"None",labelKey:"facesNone"},{value:"1",label:"1"},{value:"2",label:"2"},{value:"3..",label:"3+"}],zo=[{value:"created",label:"Created at",labelKey:"createdAt"},{value:"updated",label:"Updated at",labelKey:"updatedAt"}],Ji=[{value:"today",label:"Today",labelKey:"today"},{value:"before",label:"Before date",labelKey:"beforeDate"},{value:"last_week",label:"Last week",labelKey:"lastWeek"},{value:"after",label:"After date",labelKey:"afterDate"},{value:"last_month",label:"Last month",labelKey:"lastMonth"},{value:"between",label:"Between dates",labelKey:"betweenDates"},{value:"last_year",label:"Last year",labelKey:"lastYear"}],No=[{value:"today",label:"Today",labelKey:"today"},{value:"before",label:"Before date",labelKey:"beforeDate"},{value:"within_week",label:"Within week",labelKey:"withinWeek"},{value:"after",label:"After date",labelKey:"afterDate"},{value:"within_month",label:"Within month",labelKey:"withinMonth"},{value:"between",label:"Between dates",labelKey:"betweenDates"},{value:"within_year",label:"Within year",labelKey:"withinYear"},{value:"specific",label:"Specific date",labelKey:"specificDate"}],jo=[{value:"today",label:"Today",labelKey:"today"},{value:"before",label:"Before date",labelKey:"beforeDate"},{value:"within_week",label:"Within week",labelKey:"withinWeek"},{value:"after",label:"After date",labelKey:"afterDate"},{value:"within_month",label:"Within month",labelKey:"withinMonth"},{value:"between",label:"Between dates",labelKey:"betweenDates"},{value:"within_year",label:"Within year",labelKey:"withinYear"},{value:"specific",label:"Specific date",labelKey:"specificDate"}],ll=["#ffffff","#99a1af","#000000","#894b00","#e7000b","#ff8904","#fdc700","#9ae600","#008236","#00bcff","#1447e6","#7f22fe","#e60076"],cl=[{label:"None (Exact)",value:"0",labelKey:"colorDiffNone"},{label:"Small",value:"1",labelKey:"colorDiffSmall"},{label:"Medium",value:"2",labelKey:"colorDiffMedium"},{label:"Large",value:"4",labelKey:"colorDiffLarge"}],Oi=[{label:"Is",value:M.IS,labelKey:"operatorIs"},{label:"Contains",value:M.CONTAINS_IN_TEXT,labelKey:"operatorContains"}],dt=[{label:"Is",value:M.IS,labelKey:"operatorIs"},{label:"Is not",value:M.IS_NOT,labelKey:"operatorIsNot"}],Pi=[{label:"Is",value:M.IS_EXACT,labelKey:"operatorIs"},{label:"Contains",value:M.IS,labelKey:"operatorContains"},{label:"Does not contain",value:M.IS_NOT,labelKey:"operatorDoesNotContain"}],Ii=[{label:"Is",value:M.IS,labelKey:"operatorIs"},{label:"Greater than",value:M.GREATER_THAN_OR_EQUAL,labelKey:"operatorGreaterThan"},{label:"Is not",value:M.IS_NOT,labelKey:"operatorIsNot"},{label:"Less than",value:M.LESS_THAN_OR_EQUAL,labelKey:"operatorLessThan"},{label:"Between",value:M.RANGE,labelKey:"operatorBetween"}],Zr=[{label:"Is",value:M.IS_EXACT,labelKey:"operatorIs"},{label:"Is not",value:M.IS_NOT,labelKey:"operatorIsNot"}],dl=[{value:"APPROVED",label:"Approved",labelKey:"approved",icon:"circle-check-big",iconColor:"var(--sfx-success, oklch(0.637 0.17 151.295))"},{value:"PENDING",label:"Pending",labelKey:"pending",icon:"clock",iconColor:"var(--sfx-warning, oklch(0.734 0.157 69.419))"},{value:"REJECTED",label:"Rejected",labelKey:"rejected",icon:"x-circle",iconColor:"var(--sfx-destructive, oklch(0.577 0.215 27.325))"},{value:"CANCELLED",label:"Cancelled",labelKey:"cancelled",icon:"ban",iconColor:"var(--sfx-muted-foreground, oklch(0.685 0.033 249.82))"}],hi=[{label:"Empty",value:Ce,labelKey:"empty"},{label:"Not empty",value:Ae,labelKey:"notEmpty"}],hl=[...hi,{label:"Specific",value:Ct,labelKey:"specific"}],pl=[{label:"Empty",value:Ce,labelKey:"empty"},{label:"Not empty",value:Ae,labelKey:"notEmpty"},{label:"True",value:"true",labelKey:"boolTrue"},{label:"False",value:"false",labelKey:"boolFalse"}],ti={[P.DATE]:"calendar",[P.BOOLEAN]:"toggle-left",[P.NUMERIC]:"file-digit",[P.DECIMAL2]:"decimals-arrow-right",[P.ATTACHMENTS_ASSETS]:"paperclip",[P.ATTACHMENT_URI]:"link-2",[P.SELECT_ONE]:"circle-dot",[P.MULTI_SELECT]:"square-check",[P.SUPERTAGS]:"hash",[P.TEXT]:"text-initial",[P.TEXT_AREA]:"text-align-justify",[P.GEO_POINT]:"locate",[P.INTEGER_LIST]:"list-ordered"},ul={[P.TEXT]:"text",[P.TEXT_AREA]:"text",[P.NUMERIC]:"number",[P.DECIMAL2]:"number",[P.BOOLEAN]:"boolean",[P.SELECT_ONE]:"select-one",[P.MULTI_SELECT]:"multi-select",[P.SUPERTAGS]:"tags",[P.DATE]:"date",[P.GEO_POINT]:"geo",[P.ATTACHMENTS_ASSETS]:"attachment",[P.ATTACHMENT_URI]:"attachment",[P.INTEGER_LIST]:"attachment"};async function fl(t){var i;return(((i=(await t.get("/filters",{filter_by:"filetype",format:"list",limit:200})).filters)==null?void 0:i.file_types)??[]).map(r=>({name:r.name,value:r.value,count:r.count,category:r.category??r.value.split("_")[0],label:gl(r.name)}))}function gl(t){const e=t.indexOf("›");return(e!==-1?t.slice(e+1).trim():t).toUpperCase()}async function ml(t){var y,x;const e=await t.get("/settings"),s=e.settings??e,i=(s==null?void 0:s.metadata)??e.metadata,o=((i==null?void 0:i.model)??[])[el],a=i==null?void 0:i.store,l=((a==null?void 0:a.regional_variants_groups)??[]).map($=>({uuid:$.uuid,label:$.label??$.name??"",variants:($.variants??[]).map(k=>({api_value:k.api_value??k.value??"",internal_unique_value:k.internal_unique_value??k.api_value??"",label:k.label??k.name??""}))})).filter($=>$.variants.length>1),d={};for(const $ of l)d[$.uuid]=((y=$.variants[0])==null?void 0:y.api_value)??"";const p=(s==null?void 0:s.project_branding)??((x=e.settings)==null?void 0:x.project_branding),u=p==null?void 0:p.brandColor,h=!!((s==null?void 0:s._cdn_permalink_enabled)??e._cdn_permalink_enabled);if(!o)return{fields:[],regionalVariantGroups:l,regionalFilters:d,brandColor:u,cdnPermalinkEnabled:h};const g=o.groups??[],v=[];for(const $ of g){const k=$.name||"";for(const L of $.fields??[]){const O=L.possible_values,E=O==null?void 0:O.map(z=>({api_value:z.api_value??z.value??"",internal_unique_value:z.internal_unique_value??z.api_value??"",label:z.label??z.name??z.api_value??""}));v.push({key:L.key??L.ckey,label:L.title??L.label??L.key??"",type:L.type??"text",slug:L.slug,ckey:L.ckey,possible_values:E,group:k,regionalVariantsGroupUuid:L.regional_variants_group_uuid})}}return{fields:v,regionalVariantGroups:l,regionalFilters:d,brandColor:u,cdnPermalinkEnabled:h}}function Oe(t){return t.toLocaleDateString("en-CA")}function Xs(){return Oe(new Date)}function Zi(t){const e=new Date;switch(t){case"today":return{from:Xs(),to:null};case"last_week":{const s=new Date(e);return s.setDate(s.getDate()-7),{from:Oe(s),to:null}}case"within_week":{const s=new Date(e);return s.setDate(s.getDate()+7),{from:Xs(),to:Oe(s)}}case"last_month":{const s=new Date(e);return s.setDate(s.getDate()-30),{from:Oe(s),to:null}}case"within_month":{const s=new Date(e);return s.setDate(s.getDate()+30),{from:Xs(),to:Oe(s)}}case"last_year":{const s=new Date(e);return s.setDate(s.getDate()-365),{from:Oe(s),to:null}}case"within_year":{const s=new Date(e);return s.setDate(s.getDate()+365),{from:Xs(),to:Oe(s)}}default:return null}}function eo(t,e){return e?e.type==="date"?vl(e):e.type==="string"?bl(e):!0:!1}function vl(t){return!(!t.kind&&!t.preset||t.kind==="preset"&&!t.preset||t.kind==="between"&&!t.from&&!t.to||t.kind==="after"&&!t.from||t.kind==="before"&&!t.to||t.kind==="specific"&&!t.from||t.from&&t.to&&new Date(t.from)>new Date(t.to))}function bl(t){return!t.values||!Array.isArray(t.values)?!1:t.values.filter(Boolean).length>0}function xl(t,e={}){const s=[];for(const[i,r]of Object.entries(t)){if(!r||!eo(i,r))continue;const o=yl(i,r);s.push(...o)}for(const[i,r]of Object.entries(e)){if(!r||!eo(i,r))continue;const o=El(i,r);s.push(...o)}return _l(s)}function _l(t){const e=[],s=[],i=[];for(const r of t)r.startsWith("type:")||r.startsWith("type=")?e.push(r):r.startsWith("mimetype:")||r.startsWith("mimetype=")?s.push(r):i.push(r);if(e.length>0&&s.length>0){const r=[...e,...s].join(" , ");i.push(r)}else i.push(...e,...s);return i}function yl(t,e){if(e.type==="date")return Uo(t,e);if(t===w.IMAGE)return Al(e);const s=e,{operator:i=Ro,values:r=[],logic:o}=s;if(r.length===0)return[];switch(t){case w.SIZE:return $l(t,r,"..");case w.FACES:return wl(t,i,r);case w.TAGS:return Et(t,i,to(r),",",o);case w.LABELS:return Et(t,i,to(r),",",o);case w.COLOR:return kl(i,r,o);case w.TYPE:return Sl(r,i);case w.MIME_TYPE:return Cl(t,r,i);case w.PRODUCT_REF:return Et(t,"=%",r,",",o);default:return Et(t,i,r,",",o)}}function Uo(t,e){const s=e.field||"created";if(e.kind===ze.PRESET&&e.preset){if(e.preset===Xr.EMPTY)return[`${s}:"empty"`];if(e.preset===Xr.NOT_EMPTY)return[`${s}:"non-empty"`];const i=Zi(e.preset);return i?i.to===null?[`${s}>"${i.from}"`]:[`${s}:"${i.from}..${i.to}"`]:[]}if(e.kind===ze.AFTER&&e.from)return[`${s}:>"${e.from}"`];if(e.kind===ze.BEFORE&&e.to)return[`${s}:<"${e.to}"`];if(e.kind===ze.BETWEEN){if(e.from&&e.to)return[`${s}:"${e.from}..${e.to}"`];if(e.from&&!e.to)return[`${s}:>"${e.from}"`];if(!e.from&&e.to)return[`${s}:<"${e.to}"`]}return e.kind===ze.SPECIFIC&&e.from?[`${s}:"${e.from}"`]:[]}function $l(t,e,s){return e.length===0?[]:[`${t}:"${e.join(s)}"`]}function wl(t,e,s){return s.length===0?[]:[`${t}${e}"${s.join(",")}"`]}function Et(t,e,s,i,r){if(s.length===0)return[];if(r===Zn.AND)return s.map(a=>`${t}${e}"${a}"`);const o=s.map(a=>`"${a}"`).join(i);return[`${t}${e}${o}`]}function kl(t,e,s){const i=[],r=Et("color_search",t,e,",",s);return i.push(...r),i.push('color_operator:"AND"'),i}function Sl(t,e){if(t.length===0)return[];const s=new Set,i=[];for(const o of t){const a=rl[o];if(a)for(const n of a){const l=`${o}_${n}`;s.has(l)||(s.add(l),i.push(l))}else s.has(o)||(s.add(o),i.push(o))}const r=i.map(o=>`"${o}"`).join(",");return[`type${e}${r}`]}function Cl(t,e,s,i){if(e.length===0)return[];const r=e.map(o=>`"${o}"`).join(",");return[`${t}${s}${r}`]}function Al(t){const e=[];if(typeof t=="object"&&t!==null&&!Array.isArray(t)){const a=t,n=a.resolution,l=a.orientation,d=a.faces;return n!=null&&n.length&&e.push(`resolution:"${n.join(",")}"`),l!=null&&l.length&&e.push(`orientation:"${l.join(",")}"`),d!=null&&d.length&&e.push(`faces:"${d.join(",")}"`),e}const s=t,i=s[Li.RESOLUTION],r=s[Li.ORIENTATION],o=s[Li.FACES];return i&&e.push(`resolution:"${i}"`),r&&e.push(`orientation:"${r}"`),o&&e.push(`faces:"${o}"`),e}function El(t,e){const s=Ll(t),i=Tl(t);if(e.type==="date")return Fl(s,e,i);const r=e,{operator:o=Ro,values:a=[],logic:n,metadataType:l}=r;if(a.length===0)return[];if(a.length===1&&(a[0]===Ce||a[0]===Ae)){const d=l===P.GEO_POINT?M.IS+"~":M.IS;return[`${s}${d}"${a[0]}"`]}if((l===P.NUMERIC||l===P.DECIMAL2)&&o===M.RANGE)return[`${s}${M.IS}"${a.join('","')}"`];if(l===P.GEO_POINT){const d=a.map(p=>{const u=p.indexOf("..");if(u===-1)return`(${p})`;const h=p.slice(0,u),g=p.slice(u);return`(${h})${g}`});return Et(s,o+"~",d,",",n)}return Et(s,o,a,",",n)}function Fl(t,e,s){const i=Uo(t,e);return!s||i.length===0?i:i.map(r=>{const o=r.search(/[^a-zA-Z0-9_]/);if(o===-1)return`"${r}"`;const a=r.slice(0,o),l=r.slice(o).replace(/"/g,"");return`"${a}${l}"`})}function Tl(t){return t.startsWith("date_")}function Ll(t){for(const e of Io)if(t.startsWith(e))return t.slice(e.length);return t}function to(t){return t.map(e=>e.replace(/#/g,""))}const Ol=new Set([w.DATE,w.LICENSE_EXPIRY,D.DUE_DATE]),Pl={[w.DATE]:"created",[w.LICENSE_EXPIRY]:w.LICENSE_EXPIRY,[D.DUE_DATE]:D.DUE_DATE};function Ki(t){if(!t)return{};const e={};for(const[s,i]of Object.entries(t))i&&(e[s]=Il(s,i));return e}function Il(t,e){return e.type==="string"||e.type==="date"?e:Ol.has(t)?{type:"date",field:e.field??Pl[t]??"created",kind:e.kind??null,preset:e.preset??null,from:e.from??null,to:e.to??null}:{type:"string",values:e.values,...e.operator!==void 0&&{operator:e.operator},...e.logic!==void 0&&{logic:e.logic}}}function Dl(t){const e=localStorage.getItem(Do+t),s=localStorage.getItem(Mo+t);let i;try{i=e?JSON.parse(e):[...Jr]}catch{i=[...Jr]}let r;try{r=s?JSON.parse(s):[]}catch{r=[]}return{pinnedFilters:i,pinnedMetadata:r}}function Ml(t,e){localStorage.setItem(Do+t,JSON.stringify(e))}function Rl(t,e){localStorage.setItem(Mo+t,JSON.stringify(e))}const Ko="sort-by",Bo="sort-order";function so(t,e){try{localStorage.setItem(Ko,t),localStorage.setItem(Bo,e)}catch{}}function zl(){try{const t=localStorage.getItem(Ko),e=localStorage.getItem(Bo);return{sortBy:t,sortDirection:e}}catch{return{sortBy:null,sortDirection:null}}}const Vo="ap-last-folder",Ho="ap-last-view",qo="ap-last-tab";function ts(t,e){return e?`${t}:${e}`:t}function io(t,e){try{localStorage.setItem(ts(Vo,e),t)}catch{}}function Nl(t){try{return localStorage.getItem(ts(Vo,t))}catch{return null}}function jl(t,e){try{localStorage.setItem(ts(Ho,e),t)}catch{}}function Ul(t){try{return localStorage.getItem(ts(Ho,t))}catch{return null}}function Kl(t,e){try{localStorage.setItem(ts(qo,e),t)}catch{}}function Bl(t){try{const e=localStorage.getItem(ts(qo,t));return e==="assets"||e==="folders"||e==="labels"||e==="collections"?e:null}catch{return null}}function Vl(t){const e=t.replace("#",""),s=e.length===3?e[0]+e[0]+e[1]+e[1]+e[2]+e[2]:e,i=parseInt(s.slice(0,2),16)/255,r=parseInt(s.slice(2,4),16)/255,o=parseInt(s.slice(4,6),16)/255;return[i,r,o]}function Di(t){return t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)}function Hl(t,e,s){const i=Di(t),r=Di(e),o=Di(s),a=.4122214708*i+.5363325363*r+.0514459929*o,n=.2119034982*i+.6806995451*r+.1073969566*o,l=.0883024619*i+.2817188376*r+.6299787005*o,d=Math.cbrt(a),p=Math.cbrt(n),u=Math.cbrt(l),h=.2104542553*d+.793617785*p-.0040720468*u,g=1.9779984951*d-2.428592205*p+.4505937099*u,v=.0259040371*d+.7827717662*p-.808675766*u,y=Math.sqrt(g*g+v*v);let x=Math.atan2(v,g)*(180/Math.PI);return x<0&&(x+=360),[h,y,x]}function ql(t){return t>.7}function Gl(t,e){const s=["--sfx-primary","--sfx-primary-foreground","--sfx-primary-10","--sfx-primary-20","--sfx-accent","--sfx-accent-foreground","--sfx-ring","--sfx-selection-bg"];if(!e){for(const h of s)t.style.removeProperty(h);return}const[i,r,o]=Vl(e),[a,n,l]=Hl(i,r,o),d=`${a.toFixed(3)} ${n.toFixed(3)} ${l.toFixed(1)}`,p=`oklch(${d})`,u=ql(a)?"#000":"#fff";t.style.setProperty("--sfx-primary",p),t.style.setProperty("--sfx-primary-foreground",u),t.style.setProperty("--sfx-primary-10",`oklch(${d} / 0.1)`),t.style.setProperty("--sfx-primary-20",`oklch(${d} / 0.2)`),t.style.setProperty("--sfx-accent",`oklch(${d} / 0.07)`),t.style.setProperty("--sfx-accent-foreground",p),t.style.setProperty("--sfx-ring",`oklch(${d} / 0.7)`),t.style.setProperty("--sfx-selection-bg",`oklch(${d} / 0.08)`)}const er=[{value:"name",labelKey:"sortName",label:"Name"},{value:"created_at",labelKey:"sortUploaded",label:"Uploaded"},{value:"modified_at",labelKey:"sortModified",label:"Modified"},{value:"size",labelKey:"sortSize",label:"Size"},{value:"type",labelKey:"sortFormat",label:"Format"}],Yl=[{value:"relevance",labelKey:"sortRelevance",label:"Relevance"},...er],Ql=[{value:"name",labelKey:"sortName",label:"Name"},{value:"created_at",labelKey:"sortUploaded",label:"Uploaded"},{value:"modified_at",labelKey:"sortModified",label:"Modified"},{value:"files_count_recursive",labelKey:"sortAssetsCount",label:"Assets count"},{value:"files_size_recursive",labelKey:"sortAssetsSize",label:"Assets size"}],Wl=[{value:"name",labelKey:"sortName",label:"Name"}],Xl=[{value:"name",labelKey:"sortName",label:"Name"},{value:"created_at",labelKey:"sortUploaded",label:"Uploaded"},{value:"updated_at",labelKey:"sortModified",label:"Modified"}],Jl=[{value:"name",labelKey:"sortName",label:"Name"}],Ks=C`
  *,
  *::before,
  *::after {
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ec={ATTRIBUTE:1,CHILD:2,ELEMENT:6},tc=t=>(...e)=>({_$litDirective$:t,values:e});class sc{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,s,i){this._$Ct=e,this._$AM=s,this._$Ci=i}_$AS(e,s){return this.update(e,s)}update(e,s){return this.render(...s)}}const Mi=t=>t.includes("-")?t:t.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`);class ic extends sc{constructor(e){if(super(e),this._appliedProps=new Set,e.type!==ec.ELEMENT)throw new Error("cspStyle must be used as an element directive: <el ${cspStyle({...})}>")}render(e){return Ze}update(e,[s]){if(s===this._lastStyles)return Ze;this._lastStyles=s;const{style:i}=e.element,r=s??{};for(const o of this._appliedProps)(!(o in r)||r[o]==null||r[o]==="")&&(i.removeProperty(Mi(o)),this._appliedProps.delete(o));for(const[o,a]of Object.entries(r))a!=null&&a!==""?(i.setProperty(Mi(o),a),this._appliedProps.add(o)):this._appliedProps.has(o)&&(i.removeProperty(Mi(o)),this._appliedProps.delete(o));return Ze}}const R=tc(ic);function rc(t,e){customElements.get(t)||customElements.define(t,e)}const T=t=>e=>(rc(t,e),e);var oc=Object.defineProperty,ac=Object.getOwnPropertyDescriptor,tr=(t,e,s,i)=>{for(var r=i>1?void 0:i?ac(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&oc(e,s,r),r};let Es=class extends A{constructor(){super(...arguments),this.open=!1}updated(t){var e;super.updated(t),t.has("open")&&(this.open?this.dialog&&!this.dialog.open&&this.dialog.showModal():(e=this.dialog)!=null&&e.open&&this._animateClose())}_animateClose(){const t=this.dialog;if(t){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){t.close();return}t.classList.add("closing"),t.addEventListener("animationend",()=>{t.classList.remove("closing"),t.close()},{once:!0})}}_handleBackdropClick(t){t.target===this.dialog&&this.dispatchEvent(new CustomEvent("ap-cancel",{detail:{reason:"backdrop"},bubbles:!0,composed:!0}))}_handleCancel(t){t.preventDefault(),this.dispatchEvent(new CustomEvent("ap-cancel",{detail:{reason:"escape"},bubbles:!0,composed:!0}))}render(){return c`
...
`;var nc=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,Bs=(t,e,s,i)=>{for(var r=i>1?void 0:i?lc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&nc(e,s,r),r};let Pt=class extends A{constructor(){super(...arguments),this.groups=[],this.selectedFilters={},this.t=(t,e)=>typeof e=="string"?e:t,this._open=!1,this._handleOutsideClick=t=>{this._open&&!t.composedPath().includes(this)&&(this._open=!1)}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._handleOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleOutsideClick)}_selectVariant(t,e){this.dispatchEvent(new CustomEvent("regional-change",{detail:{groupUuid:t,value:e},bubbles:!0,composed:!0}))}render(){const t=this.groups.length>0;return c`
      <button
  ...
  `;Bs([f({type:Array})],Pt.prototype,"groups",2);Bs([f({type:Object})],Pt.prototype,"selectedFilters",2);Bs([f({attribute:!1})],Pt.prototype,"t",2);Bs([_()],Pt.prototype,"_open",2);Pt=Bs([T("ap-regional-settings")],Pt);var cc=Object.defineProperty,dc=Object.getOwnPropertyDescriptor,he=(t,e,s,i)=>{for(var r=i>1?void 0:i?dc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&cc(e,s,r),r};const hc=[{value:"assets",labelKey:"tabAssets",labelDefault:"Assets",icon:"gallery-vertical-end"},{value:"folders",labelKey:"tabFolders",labelDefault:"Folders",icon:"folder-open"},{value:"labels",labelKey:"tabLabels",labelDefault:"Labels",icon:"tag"},{value:"collections",labelKey:"tabCollections",labelDefault:"Collections",icon:"layout-grid"}];let ee=class extends A{constructor(){super(...arguments),this.activeTab="assets",this.tabs=["assets","folders"],this.isInsideLabel=!1,this.isInsideCollection=!1,this.isInsideCollectionLeaf=!1,this.viewMode="grid",this.searchQuery="",this.regionalGroups=[],this.regionalFilters={},this.hideClose=!1,this.enableAISearch=!1,this.isAISearchActive=!1,this.t=(t,e)=>typeof e=="string"?e:t,this._localSearch="",this._debouncedSearch=Pn(t=>{(t.length===0||t.length>=3)&&this.dispatchEvent(new CustomEvent("search-change",{detail:{value:t},bubbles:!0,composed:!0}))},300)}disconnectedCallback(){super.disconnectedCallback(),this._debouncedSearch.cancel()}willUpdate(t){t.has("searchQuery")&&(this._localSearch=this.searchQuery)}_handleInput(t){const e=t.target.value;this._localSearch=e,this._debouncedSearch(e)}_clearSearch(){this._localSearch="",this._debouncedSearch.cancel(),this.dispatchEvent(new CustomEvent("search-change",{detail:{value:""},bubbles:!0,composed:!0}))}_toggleView(){const t=this.viewMode==="grid"?"list":"grid";this.dispatchEvent(new CustomEvent("view-change",{detail:{mode:t},bubbles:!0,composed:!0}))}_handleTabChange(t){this.dispatchEvent(new CustomEvent("tab-change",{detail:{tab:t.detail.value},bubbles:!0,composed:!0}))}_handleRegionalChange(t){this.dispatchEvent(new CustomEvent("regional-change",{detail:t.detail,bubbles:!0,composed:!0}))}_toggleAISearch(){this.dispatchEvent(new CustomEvent("ai-search-toggle",{detail:{active:!this.isAISearchActive},bubbles:!0,composed:!0}))}_handleClose(){this.dispatchEvent(new CustomEvent("ap-close",{bubbles:!0,composed:!0}))}render(){const{t}=this,e=hc.filter(s=>this.tabs.includes(s.value)).map(s=>({...s,label:t(s.labelKey,s.labelDefault)}));return c`
    ...
    `];he([f()],ee.prototype,"activeTab",2);he([f({type:Array})],ee.prototype,"tabs",2);he([f({type:Boolean})],ee.prototype,"isInsideLabel",2);he([f({type:Boolean})],ee.prototype,"isInsideCollection",2);he([f({type:Boolean})],ee.prototype,"isInsideCollectionLeaf",2);he([f()],ee.prototype,"viewMode",2);he([f()],ee.prototype,"searchQuery",2);he([f({type:Array})],ee.prototype,"regionalGroups",2);he([f({type:Object})],ee.prototype,"regionalFilters",2);he([f({type:Boolean})],ee.prototype,"hideClose",2);he([f({type:Boolean,reflect:!0,attribute:"ai-search"})],ee.prototype,"enableAISearch",2);he([f({type:Boolean})],ee.prototype,"isAISearchActive",2);he([f({attribute:!1})],ee.prototype,"t",2);he([_()],ee.prototype,"_localSearch",2);ee=he([T("ap-header")],ee);var pc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,sr=(t,e,s,i)=>{for(var r=i>1?void 0:i?uc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&pc(e,s,r),r};let Fs=class extends A{constructor(){super(...arguments),this.title="",this.open=!1}render(){return this.open?c`
      <div class="popover">
  ...
  `;ss([f({type:Array})],ft.prototype,"selected",2);ss([f({type:Array})],ft.prototype,"fileTypes",2);ss([f({attribute:!1})],ft.prototype,"t",2);ss([_()],ft.prototype,"_search",2);ss([_()],ft.prototype,"_expanded",2);ft=ss([T("ap-filter-type")],ft);const ot=C`
  :host {
    display: block;
  }
...
`;var mc=Object.defineProperty,vc=Object.getOwnPropertyDescriptor,bt=(t,e,s,i)=>{for(var r=i>1?void 0:i?vc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&mc(e,s,r),r};let Ve=class extends A{constructor(){super(...arguments),this.filterKey=w.DATE,this.t=(t,e)=>typeof e=="string"?e:t,this.field="created",this.kind=null,this.preset="",this.from="",this.to=""}get _isLicenseExpiry(){return this.filterKey===w.LICENSE_EXPIRY}get _rangeOptions(){return(this._isLicenseExpiry?No:Ji).map(e=>({...e,label:this.t(e.labelKey,e.label)}))}get _fieldOptions(){return zo.map(t=>({...t,label:this.t(t.labelKey,t.label)}))}get _todayStr(){return Oe(new Date)}get _hasFilter(){return!!(this.kind||this.preset||this.from||this.to)}_kindFromValue(t){return["before","after","between","specific"].includes(t)?t:"preset"}_selectField(t){this.field=t,this._dispatchChange()}_selectPreset(t){if(!t){this._clearAll();return}const e=this._kindFromValue(t);if(this.kind=e,this.preset=t,["before","after","between","specific"].includes(t)){this.from="",this.to="",this.requestUpdate();return}const s=Zi(t);s&&(this.from=s.from,this.to=s.to??""),this._dispatchChange()}_clearAll(){this.field="created",this.kind=null,this.preset="",this.from="",this.to="",this._dispatchChange()}_dispatchChange(){this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:this.filterKey,values:{field:this.field,kind:this.kind,preset:this.preset,from:this.from,to:this.to}},bubbles:!0,composed:!0}))}_handleDateInput(t,e){const s=e.target.value,i=s?new Date(s+"T00:00:00").toISOString():"";if(t==="from"?this.from=i:this.to=i,this.preset==="specific"&&t==="from"&&i){const r=new Date(s+"T23:59:59");this.to=r.toISOString()}this.preset==="after"&&t==="from"&&i&&(this.to=new Date().toISOString()),this.preset==="before"&&t==="to"&&i&&(this.from=new Date(0).toISOString()),this._dispatchChange()}_renderDateTypeSection(){return this._isLicenseExpiry?m:c`
    ...
    `}_renderDateInputs(){const t=this.preset;if(!["before","after","between","specific"].includes(t))return m;const e=this.from?Oe(new Date(this.from)):"",s=this.to?Oe(new Date(this.to)):"",i=this._todayStr;return t==="specific"?c`
    ...
    `];Rt([f({type:Array})],et.prototype,"tags",2);Rt([f({type:Array})],et.prototype,"selected",2);Rt([f()],et.prototype,"filterKey",2);Rt([f({attribute:!1})],et.prototype,"t",2);Rt([vt(".tag-search")],et.prototype,"_searchInput",2);Rt([_()],et.prototype,"_search",2);et=Rt([T("ap-filter-tags")],et);var _c=Object.defineProperty,yc=Object.getOwnPropertyDescriptor,is=(t,e,s,i)=>{for(var r=i>1?void 0:i?yc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&_c(e,s,r),r};let gt=class extends A{constructor(){super(...arguments),this.labels=[],this.selected=[],this.t=(t,e)=>typeof e=="string"?e:t,this._search=""}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{var t;return(t=this._searchInput)==null?void 0:t.focus()})}get _atLimit(){return this.selected.length>=gs}get _isSearching(){return this._search.trim().length>0}_toggle(t){const e=this.selected.includes(t);if(!e&&this._atLimit)return;const s=e?this.selected.filter(i=>i!==t):[...this.selected,t];this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:w.LABELS,values:s,operator:M.IS},bubbles:!0,composed:!0}))}_remove(t){const e=this.selected.filter(s=>s!==t);this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:w.LABELS,values:e,operator:M.IS},bubbles:!0,composed:!0}))}_clearAll(){this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:w.LABELS,values:[],operator:M.IS},bubbles:!0,composed:!0}))}_onSearchInput(t){this._search=t.target.value}_clearSearch(){this._search=""}_getLabelBySid(t){return this.labels.find(e=>e.sid===t)}_renderLabelItem(t){const e=this.selected.includes(t.sid),s=!e&&this._atLimit;return c`
      <div
        class="label-item ${s?"disabled":""}"
        title=${s?this.t("labelsLimitTitle",`You can select up to ${gs} labels`,{count:gs}):m}
        @click=${()=>!s&&this._toggle(t.sid)}
      >
        <sfx-checkbox ?checked=${e}></sfx-checkbox>
      ...
      <div class="filter-content">
        ...
        ${this._atLimit?c`
              <div class="info-alert">
                <sfx-icon name="info" .size=${14}></sfx-icon>
                <span
                  >${this.t("labelsLimitAlert",`You can select up to ${gs} labels.`,{count:gs})}</span
                >
              </div>
            `:m}
      </div>
    ...
    `];is([f({type:Array})],gt.prototype,"labels",2);is([f({type:Array})],gt.prototype,"selected",2);is([f({attribute:!1})],gt.prototype,"t",2);is([vt(".search-input")],gt.prototype,"_searchInput",2);is([_()],gt.prototype,"_search",2);gt=is([T("ap-filter-labels")],gt);var $c=Object.defineProperty,wc=Object.getOwnPropertyDescriptor,zt=(t,e,s,i)=>{for(var r=i>1?void 0:i?wc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&$c(e,s,r),r};const Ri=3,Bi=/^#[0-9A-Fa-f]{6}$/;function kc(t){const e=t.trim().split(/\s+/);return e.length<1||!Bi.test(e[0])?null:{hex:e[0],tolerance:e[1]||ei,coverage:e[3]||Zs}}let tt=class extends A{constructor(){super(...arguments),this.values=[],this.t=(t,e)=>typeof e=="string"?e:t,this._colors=[],this._advanced=!1,this._showPalette=!1,this._initialized=!1}get _hasSelection(){return this._colors.length>0}get _selectedHexes(){return new Set(this._colors.map(t=>t.hex))}willUpdate(t){if(t.has("values")){const e=[];for(const s of this.values){const i=kc(s);i&&e.push(i)}(!this._initialized||this.values.length===0&&this._colors.length>0)&&(this._colors=e,e.length>0&&(this._advanced=e.some(s=>s.tolerance!==ei||s.coverage!==Zs)),this._initialized=!0)}}_selectColor(t){if(!Bi.test(t))return;const e=this._colors.findIndex(s=>s.hex.toLowerCase()===t.toLowerCase());if(e>=0){this._removeColor(e);return}this._colors.length>=Ri||(this._colors=[...this._colors,{hex:t,tolerance:ei,coverage:Zs}],this._showPalette=!1,this._dispatchChange())}_removeColor(t){this._colors=this._colors.filter((e,s)=>s!==t),this._dispatchChange()}_clearAll(){this._colors=[],this._showPalette=!1,this._dispatchChange()}_toggleAdvanced(){this._advanced=!this._advanced,this._colors.length>0&&this._dispatchChange()}_handleHexInput(t,e){let i=e.target.value.trim();if(i.startsWith("#")||(i="#"+i),!Bi.test(i)||this._colors.some((a,n)=>n!==t&&a.hex.toLowerCase()===i.toLowerCase()))return;const o=[...this._colors];o[t]={...o[t],hex:i},this._colors=o,this._dispatchChange()}_handleToleranceChange(t,e){const s=[...this._colors];s[t]={...s[t],tolerance:e.detail.value},this._colors=s,this._dispatchChange()}_handleCoverageInput(t,e){const s=e.target.value,i=parseInt(s,10);if(!isNaN(i)&&i>=1&&i<=100){const r=[...this._colors];r[t]={...r[t],coverage:String(i)},this._colors=r,this._dispatchChange()}}_showAddPalette(){this._showPalette=!0}_dispatchChange(){if(this._colors.length===0){this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:"color",values:"",operator:":"},bubbles:!0,composed:!0}));return}const t=this._colors.map(e=>{const s=this._advanced?e.tolerance:ei,i=this._advanced?e.coverage:Zs;return`${e.hex} ${s} ${s} ${i}`});this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:"color",values:t,operator:":"},bubbles:!0,composed:!0}))}_renderPalette(){const t=this._selectedHexes,e=this._colors.length>=Ri;return c`
      <div class="palette">
    ...
    `}_renderColorEntry(t,e){return this._advanced?c`
      <div class="color-row advanced">
        ...
        <div class="adv-field">
          ...
          <sfx-dropdown
            .value=${t.tolerance}
            .options=${cl.map(s=>({...s,label:this.t(s.labelKey,s.label)}))}
    ...
    `:c`
      ...
      `}render(){const t=this._colors.length===0||this._showPalette,e=this._colors.length<Ri&&!this._showPalette;return c`
      <div class="filter-content">
    ...
    `];zt([f({type:Array})],tt.prototype,"values",2);zt([f({attribute:!1})],tt.prototype,"t",2);zt([_()],tt.prototype,"_colors",2);zt([_()],tt.prototype,"_advanced",2);zt([_()],tt.prototype,"_showPalette",2);zt([_()],tt.prototype,"_initialized",2);tt=zt([T("ap-filter-color")],tt);var Sc=Object.defineProperty,Cc=Object.getOwnPropertyDescriptor,xt=(t,e,s,i)=>{for(var r=i>1?void 0:i?Cc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Sc(e,s,r),r};const Ac={KB:1/1e3,MB:1,GB:1e3},Ec=[{value:"MB",label:"MB"},{value:"GB",label:"GB"}];let He=class extends A{constructor(){super(...arguments),this.min=0,this.max=0,this.t=(t,e)=>typeof e=="string"?e:t,this._minVal="",this._maxVal="",this._unit="MB",this._initialized=!1}willUpdate(t){!this._initialized&&(t.has("min")||t.has("max"))&&(this._initialized=!0,this.min>0&&(this._minVal=String(this.min)),this.max>0&&(this._maxVal=String(this.max)))}get _hasFilter(){return this._minVal!==""||this._maxVal!==""}_clearAll(){this._minVal="",this._maxVal="",this._emitChange()}_setUnit(t){this._unit=t.detail.value,this._emitChange()}_emitChange(){const t=Ac[this._unit],e=this._minVal!==""?parseFloat((parseFloat(this._minVal)*t).toFixed(2)).toString():null,s=this._maxVal!==""?parseFloat((parseFloat(this._maxVal)*t).toFixed(2)).toString():null;let i;if(e!==null&&s!==null)i=`${e}..${s}`;else if(e!==null)i=`${e}..`;else if(s!==null)i=`..${s}`;else{this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:w.SIZE,values:[],operator:M.RANGE},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:w.SIZE,values:[i],operator:M.RANGE},bubbles:!0,composed:!0}))}_onMinInput(t){this._minVal=t.target.value,this._emitChange()}_onMaxInput(t){this._maxVal=t.target.value,this._emitChange()}render(){return c`
      <div class="filter-content">
    ...
    `];xt([f({type:Number})],He.prototype,"min",2);xt([f({type:Number})],He.prototype,"max",2);xt([f({attribute:!1})],He.prototype,"t",2);xt([_()],He.prototype,"_minVal",2);xt([_()],He.prototype,"_maxVal",2);xt([_()],He.prototype,"_unit",2);xt([_()],He.prototype,"_initialized",2);He=xt([T("ap-filter-size")],He);var Fc=Object.defineProperty,Tc=Object.getOwnPropertyDescriptor,Vs=(t,e,s,i)=>{for(var r=i>1?void 0:i?Tc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Fc(e,s,r),r};const Lc=pt`
...
`,Dc={portrait:Lc,landscape:Oc,square:Pc,panorama:Ic};let It=class extends A{constructor(){super(...arguments),this.selectedResolution=[],this.selectedOrientation=[],this.selectedFaces=[],this.t=(t,e)=>typeof e=="string"?e:t}get _hasSelection(){return this.selectedResolution.length>0||this.selectedOrientation.length>0||this.selectedFaces.length>0}_toggle(t,e){return t.includes(e)?t.filter(s=>s!==e):[...t,e]}_toggleResolution(t){this.selectedResolution=this._toggle(this.selectedResolution,t),this._dispatchChange()}_toggleOrientation(t){this.selectedOrientation=this._toggle(this.selectedOrientation,t),this._dispatchChange()}_toggleFaces(t){this.selectedFaces=this._toggle(this.selectedFaces,t),this._dispatchChange()}_clearAll(){this.selectedResolution=[],this.selectedOrientation=[],this.selectedFaces=[],this._dispatchChange()}_dispatchChange(){this.dispatchEvent(new CustomEvent("filter-change",{detail:{key:"image",values:{resolution:this.selectedResolution,orientation:this.selectedOrientation,faces:this.selectedFaces}},bubbles:!0,composed:!0}))}render(){return c`
      <div class="filter-content">
        <button class="clear-btn" ?disabled=${!this._hasSelection} @click=${this._clearAll}>
          ${this.t("clearAll","Clear all")}
        </button>
            ...
            ${al.map(t=>c`
                <sfx-checkbox
                  ...
                  ><span class="orientation-label"
                    >${Dc[t.value]}${this.t(t.labelKey,t.label)}</span
                  ></sfx-checkbox
                >
              `)}
          </div>
    ...
    `}_renderTextFilter(t){var d,p;const e=j(t),s=this._getApplied(e),r=this._isSpecialValue(s.values)?"":((d=s.values)==null?void 0:d[0])||"",o=this._getContentMode(e),a=o===Ce||o===Ae,n=s.operator||Oi[0].value,l=t.type===P.TEXT_AREA;return c`
      <div class="filter-content">
        <button
          class="clear-btn"
    ...
    `}_renderNumberFilter(t){var k,L,O;const e=j(t),s=this._getApplied(e),i=s.operator||Ii[0].value,r=this._isSpecialValue(s.values),o=this._getContentMode(e),a=o===Ce||o===Ae,n=i===M.RANGE,l=i===M.GREATER_THAN_OR_EQUAL,d=i===M.LESS_THAN_OR_EQUAL,p=t.type===P.DECIMAL2,u=p?"0.01":"1",h=p?"0.00":"0",g=r?"":((k=s.values)==null?void 0:k[0])||"",v=r?"":((L=s.values)==null?void 0:L[1])||"",y=n||l||d,x=n||l||d?this.t("min","Min"):this.t("value","Value"),$=this.t("max","Max");return c`
      <div class="filter-content">
        <button
          class="clear-btn"
    ...
    `}_renderSelectOneFilter(t){const e=j(t),s=this._getApplied(e),i=this._isSpecialValue(s.values),r=i?[]:s.values||[],o=t.possible_values||[],a=s.operator||dt[0].value,n=(this._selectSearches[e]||"").toLowerCase(),l=n.length>0,d=r.length>0||i,p=n?o.filter(h=>h.label.toLowerCase().includes(n)):o,u=r.length>=Ws;return c`
      <div class="filter-content">
        <!-- Search input -->
        <div class="search-wrapper">
          <sfx-icon class="search-icon" name="search" .size=${14}></sfx-icon>
    ...
    `}_renderMultiSelectFilter(t){const e=j(t),s=this._getApplied(e),i=this._isSpecialValue(s.values),r=i?[]:s.values||[],o=t.possible_values||[],a=s.operator||Pi[0].value,n=(this._selectSearches[e]||"").toLowerCase(),l=n.length>0,d=r.length>0||i,p=n?o.filter(h=>h.label.toLowerCase().includes(n)):o,u=r.length>=Ws;return c`
      <div class="filter-content">
        <!-- Search input -->
        <div class="search-wrapper">
          <sfx-icon class="search-icon" name="search" .size=${14}></sfx-icon>
    ...
    `}_renderTagsFilter(t){const e=j(t),s=this._getApplied(e),i=this._isSpecialValue(s.values),r=i?[]:s.values||[],o=this._tagInputs[e]||"",a=s.operator||dt[0].value,n=r.length>0||i,l=this._tagSuggestions[e]||[],d=this._tagLoading[e]||!1,p=o.trim().length>0,u=r.length>=Ws;return c`
      <div class="filter-content">
        <!-- Search input -->
        <div class="search-wrapper">
          <sfx-icon class="search-icon" name="search" .size=${14}></sfx-icon>
    ...
    `}_renderDateFilter(t){var p,u;const e=j(t),s=this._datePresets[e]||"",i=this._getApplied(e),o=this._isSpecialValue(i.values)?((p=i.values)==null?void 0:p[0])||"":s,a=[{value:"empty",label:"Empty"},{value:"non-empty",label:"Not empty"}],n=this._dateFroms[e]?Oe(new Date(this._dateFroms[e])):"",l=this._dateTos[e]?Oe(new Date(this._dateTos[e])):"",d=["before","after","between"].includes(o);return c`
      <div class="filter-content">
        <button
          class="clear-btn"
    ...
    `}_renderFaceMatcherFilter(t){const e=j(t),s=this._getApplied(e),i=s.values||[],r=s.operator||M.IS;return c`
      <div class="filter-content">
        <button
          class="clear-btn"
          ?disabled=${i.length===0}
    ...
    `}_renderApproverSection(){return this._renderUserPickerSection({title:this.t("approver","Approver"),searchPlaceholder:this.t("searchApproverPlaceholder","Search approvers"),users:this.approverUsers,selectedValues:this.approverValues,operator:this.approverOperator,search:this._approverSearch,onClear:()=>this._clearApprover(),onOperatorChange:t=>this._handleApproverOperator(t),onSearchInput:t=>this._onApproverSearchInput(t),onSearchClear:()=>this._clearApproverSearch(),onToggle:t=>this._toggleApprover(t)})}_renderRequesterSection(){return this._renderUserPickerSection({title:this.t("requester","Requester"),searchPlaceholder:this.t("searchRequesterPlaceholder","Search requesters"),users:this.requesterUsers,selectedValues:this.requesterValues,operator:this.requesterOperator,search:this._requesterSearch,onClear:()=>this._clearRequester(),onOperatorChange:t=>this._handleRequesterOperator(t),onSearchInput:t=>this._onRequesterSearchInput(t),onSearchClear:()=>this._clearRequesterSearch(),onToggle:t=>this._toggleRequester(t)})}_renderDueDateSection(){const t=!!this.dueDatePreset||!!this.dueDateFrom||!!this.dueDateTo;return c`
      <div class="filter-section">
        ...
        <sfx-radio-group
          clearable
          columns="2"
          .options=${jo.map(e=>({...e,label:this.t(e.labelKey,e.label)}))}
          .value=${this.dueDatePreset!==Ce&&this.dueDatePreset!==Ae?this.dueDatePreset:""}
          @sfx-change=${this._handleDueDatePreset}
        ></sfx-radio-group>
...
`).map(e=>e.trim()).filter(e=>e!=="");if(t.length>0){const e=new Set(this.selected),s=[...this.selected,...t.filter(i=>!e.has(i))];this._emit(s)}this._closeAddList()}_renderProductItem(t){const e=this.selected.includes(t);return c`
                ...
                <div class="filter-dropdown">
                  ...
                  ${this._showDropdown?c`
                        <div class="dropdown-menu">
                          ${As.filter(s=>!this.forcedFilterKeys.includes(s.key)).map(s=>this._renderFilterButton(s))}
                        </div>
                      `:m}
                </div>
              `:m}
                      ...
                      ${this._openFilter==="metadata"&&this._openMetadataField?c`
                          ...
                          `:c`
                            <sfx-icon
                              ...
                              .size=${16}
                            ></sfx-icon>
                            ${t(xs[this._openFilter]??this._openFilter,Yt[this._openFilter]||this._openFilter)}
                          `}
                      <button
                        class="anchor-close"
  ...
  `;B([f({type:Number})],U.prototype,"totalCount",2);B([f({type:Number})],U.prototype,"totalFolderCount",2);B([f({type:Boolean})],U.prototype,"isLoading",2);B([f({type:Boolean})],U.prototype,"showUpload",2);B([f({type:Boolean})],U.prototype,"showCreateFolder",2);B([f({type:Boolean})],U.prototype,"showFilters",2);B([f()],U.prototype,"countLabel",2);B([f()],U.prototype,"sortBy",2);B([f()],U.prototype,"sortDirection",2);B([f({type:Array})],U.prototype,"sortOptions",2);B([f({type:Object})],U.prototype,"filters",2);B([f({type:Array})],U.prototype,"labels",2);B([f({type:Array})],U.prototype,"tags",2);B([f({type:Array})],U.prototype,"fileTypes",2);B([f({type:Array})],U.prototype,"metadataFields",2);B([f({type:Array})],U.prototype,"pinnedFilters",2);B([f({type:Array})],U.prototype,"forcedFilterKeys",2);B([f({type:Array})],U.prototype,"approverUsers",2);B([f({type:Array})],U.prototype,"requesterUsers",2);B([f({attribute:!1})],U.prototype,"apiClient",2);B([f({attribute:!1})],U.prototype,"t",2);B([vt("sfx-dropdown")],U.prototype,"_sortDropdown",2);B([_()],U.prototype,"_showDropdown",2);B([_()],U.prototype,"_showMetadataSelector",2);B([_()],U.prototype,"_openFilter",2);B([_()],U.prototype,"_openMetadataField",2);B([_()],U.prototype,"_externalTrigger",2);B([_()],U.prototype,"_externalLeft",2);B([_()],U.prototype,"_externalTop",2);U=B([T("ap-content-toolbar")],U);var qc=Object.defineProperty,Gc=Object.getOwnPropertyDescriptor,le=(t,e,s,i)=>{for(var r=i>1?void 0:i?Gc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&qc(e,s,r),r};let Z=class extends A{constructor(){super(...arguments),this.appliedFilters={},this.appliedMetadata={},this.forcedFilters={},this.metadataFields=[],this.pinnedFilters=[],this.pinnedMetadataFields=[],this.tags=[],this.labels=[],this.approverUsers=[],this.requesterUsers=[],this.activeFilter=null,this.activeMetadataField=null,this.pendingFilter=null,this.pendingMetadataField=null,this.t=(t,e)=>typeof e=="string"?e:t}_mapTypeLabel(t){var i;const e=(i=di.find(r=>r.value===t))==null?void 0:i.label;if(e)return e;const s=t.indexOf("_");return s!==-1?t.slice(s+1).toUpperCase():t}_getSizeSummary(t){if(t.values.length===0)return"";const e=t.values[0],[s,i]=e.split(".."),r=s?parseFloat(s):null,o=i?parseFloat(i):null,a=n=>n>=1e3?`${(n/1e3).toFixed(n%1e3===0?0:1)} GB`:`${n} MB`;return r!==null&&o!==null?`${a(r)} – ${a(o)}`:r!==null?`> ${a(r)}`:o!==null?`< ${a(o)}`:""}_getFilterSummary(t,e){if(t.type==="string"){const s=t;if(s.values.length===0)return"";if(e===w.SIZE)return this._getSizeSummary(s);if(e===w.COLOR){const o=s.values.map(a=>a.split(" ")[0]).filter(Boolean);return o.length===0?"":o.length===1?o[0]:`${o[0]} +${o.length-1}`}const i=o=>o===Ce?this.t("empty","Empty"):o===Ae?this.t("notEmpty","Not empty"):null,r=e===w.TYPE?o=>i(o)??this._mapTypeLabel(o):e===w.TAGS?o=>{var a;return i(o)??(((a=this.tags.find(n=>n.sid===o))==null?void 0:a.label)||o)}:e===w.LABELS?o=>{var a;return i(o)??(((a=this.labels.find(n=>n.sid===o))==null?void 0:a.name)||o)}:e===D.APPROVER?o=>{var a;return i(o)??(((a=this.approverUsers.find(n=>n.uuid===o))==null?void 0:a.name)||o)}:e===D.REQUESTOR?o=>{var a;return i(o)??(((a=this.requesterUsers.find(n=>n.uuid===o))==null?void 0:a.name)||o)}:o=>i(o)??o;return s.values.length===1?r(s.values[0]):`${r(s.values[0])} +${s.values.length-1}`}if(t.type==="date")return e===D.DUE_DATE?this._getDuedateSummary(t):this._getDateSummary(t);if(typeof t=="object"&&"resolution"in t){const s=t,i=[...s.resolution,...s.orientation,...s.faces];return i.length===0?"":i.length===1?i[0]:`${i[0]} +${i.length-1}`}return""}_getDuedateSummary(t){const e=i=>i.split("T")[0],s=t.preset||"";if(s===Ce)return this.t("empty","Empty");if(s===Ae)return this.t("notEmpty","Not empty");if(t.kind==="preset"){const i=jo.find(r=>r.value===s);return i?this.t(i.labelKey,i.label):s}if(t.kind==="between"){if(t.from&&t.to)return`${e(t.from)} – ${e(t.to)}`;if(t.from)return`${this.t("afterDate","After date")}: ${e(t.from)}`;if(t.to)return`${this.t("beforeDate","Before date")}: ${e(t.to)}`}return t.kind==="after"&&t.from?`${this.t("afterDate","After date")}: ${e(t.from)}`:t.kind==="before"&&t.to?`${this.t("beforeDate","Before date")}: ${e(t.to)}`:t.kind==="specific"&&t.from?e(t.from):""}_getDateSummary(t){const e=zo.find(l=>l.value===t.field),s=e?this.t(e.labelKey,e.label):"",i=[...Ji,...No],r=t.preset?i.find(l=>l.value===t.preset):null,o=r?this.t(r.labelKey,r.label):t.preset||"",a=l=>{try{return l.split("T")[0]}catch{return l}};let n="";switch(t.kind){case"preset":n=o;break;case"before":n=t.to?`${this.t("beforeDate","Before date")}: ${a(t.to)}`:o;break;case"after":n=t.from?`${this.t("afterDate","After date")}: ${a(t.from)}`:o;break;case"between":t.from&&t.to?n=`${a(t.from)} – ${a(t.to)}`:t.from?n=`${this.t("afterDate","After date")}: ${a(t.from)}`:t.to&&(n=`${this.t("beforeDate","Before date")}: ${a(t.to)}`);break;case"specific":n=t.from?a(t.from):"";break;default:n=o}return n?s?`${s}: ${n}`:n:""}_getFilterIcon(t){var e,s;return t===D.STATUS||t===D.APPROVER||t===D.REQUESTOR||t===D.DUE_DATE?((e=As.find(i=>i.key===w.APPROVAL))==null?void 0:e.icon)||"filter":((s=As.find(i=>i.key===t))==null?void 0:s.icon)||"filter"}_getMetadataLabel(t){const e=this._stripMetadataPrefix(t),s=this.metadataFields.find(i=>i.key===e);return(s==null?void 0:s.label)||e}_getMetadataIcon(t){const e=this._stripMetadataPrefix(t),s=this.metadataFields.find(i=>i.key===e);return s&&ti[s.type]||"file-text"}_stripMetadataPrefix(t){for(const e of Io)if(t.startsWith(e))return t.slice(e.length);return t}_removeFilter(t){this.dispatchEvent(new CustomEvent("filter-remove",{detail:{key:t},bubbles:!0,composed:!0}))}_removeMetadataFilter(t){this.dispatchEvent(new CustomEvent("metadata-filter-remove",{detail:{fieldKey:t},bubbles:!0,composed:!0}))}_clearAll(){this.dispatchEvent(new CustomEvent("filters-clear-all",{bubbles:!0,composed:!0}))}_openFilter(t,e){const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("filter-open",{detail:{key:t,chipRect:{left:i.left,right:i.right,bottom:i.bottom,width:i.width}},bubbles:!0,composed:!0}))}_openMetadataFilter(t,e){const i=e.currentTarget.getBoundingClientRect();this.dispatchEvent(new CustomEvent("metadata-filter-open",{detail:{fieldKey:t,chipRect:{left:i.left,right:i.right,bottom:i.bottom,width:i.width}},bubbles:!0,composed:!0}))}_renderForcedChip(t,e){const{t:s}=this,i=this._getFilterSummary(e,t),r=e.type==="date";return c`
      <span class="chip forced">
        ${(r||t===w.TYPE||t===w.SIZE)&&i?c`<span class="chip-label">${i}</span>`:c`
              <span class="chip-label"
                >${s(xs[t]??t,Yt[t]||t)}</span
              >
        ...
        <div class="chips">
          ...
          ${d?c`
                ...
                >
                  ...
                  ></span>
                  <span class="chip-label"
                    >${this.t(xs[this.pendingFilter]??this.pendingFilter,Yt[this.pendingFilter]||this.pendingFilter)}</span
                  >
  ...
  `;le([f({type:Object})],Z.prototype,"appliedFilters",2);le([f({type:Object})],Z.prototype,"appliedMetadata",2);le([f({type:Object})],Z.prototype,"forcedFilters",2);le([f({type:Array})],Z.prototype,"metadataFields",2);le([f({type:Array})],Z.prototype,"pinnedFilters",2);le([f({type:Array})],Z.prototype,"pinnedMetadataFields",2);le([f({type:Array})],Z.prototype,"tags",2);le([f({type:Array})],Z.prototype,"labels",2);le([f({type:Array})],Z.prototype,"approverUsers",2);le([f({type:Array})],Z.prototype,"requesterUsers",2);le([f()],Z.prototype,"activeFilter",2);le([f()],Z.prototype,"activeMetadataField",2);le([f()],Z.prototype,"pendingFilter",2);le([f()],Z.prototype,"pendingMetadataField",2);le([f({attribute:!1})],Z.prototype,"t",2);Z=le([T("ap-filters-bar")],Z);var Yc=Object.defineProperty,Qc=Object.getOwnPropertyDescriptor,Fe=(t,e,s,i)=>{for(var r=i>1?void 0:i?Qc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Yc(e,s,r),r};const Wc=6;let de=class extends A{constructor(){super(...arguments),this.t=(t,e)=>typeof e=="string"?e:t,this.assets=[],this.folders=[],this.folderPreviews={},this.selectedIds=[],this.selectedFolderIds=[],this.disabledAssetIds=[],this.disabledFolderIds=[],this.isLoading=!1,this.multiSelect=!0,this.folderSelectable=!1,this.gridSize="normal",this._prevCount=0}willUpdate(t){if(t.has("assets")){const e=t.get("assets");e&&this.assets.length>e.length?this._prevCount=e.length:this._prevCount=0}}render(){const t=this.gridSize==="large"?"280px":"220px";return c`
      ...
      >
        ...
        ${this.assets.map((e,s)=>{const i=s>=this._prevCount?Math.min(s-this._prevCount,20):Math.min(s,20);return c`
            ...
            ></ap-asset-card>
          `})}
        ${this.isLoading?Array.from({length:Wc},()=>c`<div class="ghost-card">
  ...
  `;Fe([f({attribute:!1})],de.prototype,"t",2);Fe([f({type:Array})],de.prototype,"assets",2);Fe([f({type:Array})],de.prototype,"folders",2);Fe([f({type:Object})],de.prototype,"folderPreviews",2);Fe([f({type:Array})],de.prototype,"selectedIds",2);Fe([f({type:Array})],de.prototype,"selectedFolderIds",2);Fe([f({type:Array})],de.prototype,"disabledAssetIds",2);Fe([f({type:Array})],de.prototype,"disabledFolderIds",2);Fe([f({type:Boolean})],de.prototype,"isLoading",2);Fe([f({type:Boolean})],de.prototype,"multiSelect",2);Fe([f({type:Boolean})],de.prototype,"folderSelectable",2);Fe([f({type:String})],de.prototype,"gridSize",2);de=Fe([T("ap-grid-view")],de);var Xc=Object.defineProperty,Jc=Object.getOwnPropertyDescriptor,pe=(t,e,s,i)=>{for(var r=i>1?void 0:i?Jc(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Xc(e,s,r),r};const Zc=5;let te=class extends A{constructor(){super(...arguments),this.t=(t,e)=>typeof e=="string"?e:t,this.assets=[],this.folders=[],this.selectedIds=[],this.selectedFolderIds=[],this.disabledAssetIds=[],this.disabledFolderIds=[],this.isLoading=!1,this.multiSelect=!0,this.folderSelectable=!1,this.totalCount=0,this.isSelectingAll=!1,this.folderPreviews={},this._compactLevel=0}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(t=>{var i;const e=((i=t[0])==null?void 0:i.contentRect.width)??0,s=e<550?2:e<680?1:0;s!==this._compactLevel&&(this._compactLevel=s)}),this._resizeObserver.observe(this)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._resizeObserver)==null||t.disconnect()}_getGridColumns(t){const e=[];return t&&e.push("32px"),e.push("48px"),e.push("minmax(120px, 1fr)"),e.push("72px"),this._compactLevel<2&&e.push("100px"),this._compactLevel<1&&e.push("120px"),e.push("64px"),e.join(" ")}get _allVisibleSelected(){if(this.assets.length===0&&this.folders.length===0||this.selectedIds.length===0&&this.selectedFolderIds.length===0)return!1;const t=new Set(this.selectedIds),e=this.assets.length===0||this.assets.every(r=>t.has(r.uuid));if(!this.folderSelectable)return e&&this.assets.length>0;const s=new Set(this.selectedFolderIds),i=this.folders.length===0||this.folders.every(r=>s.has(r.uuid));return e&&i}_handleHeaderCheckboxClick(){if(this.isSelectingAll)return;const t=this.folderSelectable?this.totalCount+this.folders.length:this.totalCount,e=this.folderSelectable?this.selectedIds.length+this.selectedFolderIds.length:this.selectedIds.length;this._allVisibleSelected&&e>=t?this.dispatchEvent(new CustomEvent("selection-clear",{bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("select-all",{detail:{scope:"all"},bubbles:!0,composed:!0}))}render(){const t=this.folderSelectable?this.totalCount+this.folders.length:this.totalCount,e=this.folderSelectable?this.selectedIds.length+this.selectedFolderIds.length:this.selectedIds.length,s=this._allVisibleSelected&&e>=t;return c`
      ...
      <div class="list-body" role="list" aria-label="Assets">
        ...
        ${this.assets.map((i,r)=>c`
            ...
            ></ap-asset-row>
          `)}
        ${this.isLoading?Array.from({length:Zc},(i,r)=>{const o=["70%","55%","80%","45%","65%"];return c`
                <div
                  class="ghost-row"
                  ${R({"grid-template-columns":this._getGridColumns(this.multiSelect)})}
                >
  ...
  `;pe([f({attribute:!1})],te.prototype,"t",2);pe([f({type:Array})],te.prototype,"assets",2);pe([f({type:Array})],te.prototype,"folders",2);pe([f({type:Array})],te.prototype,"selectedIds",2);pe([f({type:Array})],te.prototype,"selectedFolderIds",2);pe([f({type:Array})],te.prototype,"disabledAssetIds",2);pe([f({type:Array})],te.prototype,"disabledFolderIds",2);pe([f({type:Boolean})],te.prototype,"isLoading",2);pe([f({type:Boolean})],te.prototype,"multiSelect",2);pe([f({type:Boolean})],te.prototype,"folderSelectable",2);pe([f({type:Number})],te.prototype,"totalCount",2);pe([f({type:Boolean})],te.prototype,"isSelectingAll",2);pe([f({type:Object})],te.prototype,"folderPreviews",2);pe([_()],te.prototype,"_compactLevel",2);te=pe([T("ap-list-view")],te);function ir(t){if(t===0)return"0 B";const e=["B","KB","MB","GB","TB"],s=1024,i=Math.floor(Math.log(t)/Math.log(s));return`${(t/Math.pow(s,i)).toFixed(i===0?0:1)} ${e[i]}`}function pi(t){if(!t)return"—";const e=new Date(t);return isNaN(e.getTime())?"—":e.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Yo(t,e){return!t||!e?"":`${t} x ${e}`}var ed=Object.defineProperty,td=Object.getOwnPropertyDescriptor,Nt=(t,e,s,i)=>{for(var r=i>1?void 0:i?td(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&ed(e,s,r),r};let st=class extends A{constructor(){super(...arguments),this.t=(t,e)=>typeof e=="string"?e:t,this.index=0,this.selected=!1,this.disabled=!1,this.multiSelect=!0}_handleSelect(t){if(t.stopPropagation(),t.composedPath().some(i=>i instanceof HTMLElement&&(i.classList.contains("check")||i.classList.contains("check-box")))){this.dispatchEvent(new CustomEvent("asset-select",{detail:{asset:this.asset,index:this.index,event:new MouseEvent("click",{ctrlKey:!0,metaKey:!0,shiftKey:t.shiftKey})},bubbles:!0}));return}this.dispatchEvent(new CustomEvent("asset-select",{detail:{asset:this.asset,index:this.index,event:t},bubbles:!0}))}_handlePreview(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-preview",{detail:{asset:this.asset},bubbles:!0}))}_formatDuration(t){const e=Math.floor(t/3600),s=Math.floor(t%3600/60),i=Math.floor(t%60),r=o=>String(o).padStart(2,"0");return e>0?`${e}:${r(s)}:${r(i)}`:`${r(s)}:${r(i)}`}_handleQuickSelect(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-quick-select",{detail:{asset:this.asset},bubbles:!0}))}render(){var d,p,u,h,g,v,y,x;const t=this.asset;if(!t)return c``;const s=Qt(t.type)==="video",i=((d=t.extension)==null?void 0:d.toLowerCase())==="pdf",r=!!((p=t.info)!=null&&p.thumbnail||(u=t.info)!=null&&u.image_thumbnail||(h=t.info)!=null&&h.preview),o=To(t.extension||"")||r;let a="";s?a=Oo(t):i?a=Xi(t):o&&(a=ci(t));const n=Us(t.extension||""),l=Wi(t.extension||"");return c`
      <div class="card" @click=${this._handleSelect}>
        <div class="thumbnail ${l&&a?"chess":""}">
          ${a?c`<img
                ...
                @error=${$=>{const k=$.target,L=Xt();k.src!==n&&k.src!==L?(k.src=n,k.classList.add("icon-fallback")):k.src!==L&&(k.src=L)}}
              />`:c`<img
                src=${n}
                alt=${t.name}
                class="thumb-img icon-fallback"
                @error=${$=>{const k=$.target,L=Xt();k.src!==L&&(k.src=L)}}
              />`}
        ...
        <div class="info">
          ...
          <div class="meta">
            ${(y=t.extension)==null?void 0:y.toUpperCase()}${(()=>{var O,E,z,S;const $=((O=t.info)==null?void 0:O.img_w)||((E=t.info)==null?void 0:E.video_w),k=((z=t.info)==null?void 0:z.img_h)||((S=t.info)==null?void 0:S.video_h),L=Yo($,k);return L?` · ${L}`:""})()}
  ...
  `;Nt([f({attribute:!1})],st.prototype,"t",2);Nt([f({type:Object})],st.prototype,"asset",2);Nt([f({type:Number})],st.prototype,"index",2);Nt([f({type:Boolean,reflect:!0})],st.prototype,"selected",2);Nt([f({type:Boolean,reflect:!0})],st.prototype,"disabled",2);Nt([f({type:Boolean})],st.prototype,"multiSelect",2);st=Nt([T("ap-asset-card")],st);var sd=Object.defineProperty,id=Object.getOwnPropertyDescriptor,_t=(t,e,s,i)=>{for(var r=i>1?void 0:i?id(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&sd(e,s,r),r};let qe=class extends A{constructor(){super(...arguments),this.t=(t,e)=>typeof e=="string"?e:t,this.index=0,this.selected=!1,this.disabled=!1,this.multiSelect=!0,this.compactLevel=0}_getGridColumns(){const t=[];return this.multiSelect&&t.push("32px"),t.push("48px"),t.push("minmax(120px, 1fr)"),t.push("72px"),this.compactLevel<2&&t.push("100px"),this.compactLevel<1&&t.push("120px"),t.push("64px"),t.join(" ")}_handleSelect(t){if(t.composedPath().some(i=>i instanceof HTMLElement&&(i.classList.contains("check")||i.classList.contains("check-box")))){this.dispatchEvent(new CustomEvent("asset-select",{detail:{asset:this.asset,index:this.index,event:new MouseEvent("click",{ctrlKey:!0,metaKey:!0,shiftKey:t.shiftKey})},bubbles:!0}));return}this.dispatchEvent(new CustomEvent("asset-select",{detail:{asset:this.asset,index:this.index,event:t},bubbles:!0}))}_handlePreview(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-preview",{detail:{asset:this.asset},bubbles:!0}))}_handleQuickSelect(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-quick-select",{detail:{asset:this.asset},bubbles:!0}))}render(){var d,p,u,h,g,v;const t=this.asset;if(!t)return c``;const s=Qt(t.type)==="video",i=((d=t.extension)==null?void 0:d.toLowerCase())==="pdf",r=!!((p=t.info)!=null&&p.thumbnail||(u=t.info)!=null&&u.image_thumbnail||(h=t.info)!=null&&h.preview),o=To(t.extension||"")||r;let a="";s?a=Oo(t):i?a=Xi(t):o&&(a=ci(t));const n=Us(t.extension||""),l=Wi(t.extension||"");return c`
      <div
        class="row"
      ...
      >
        ...
        <div class="thumb ${l&&a?"chess":""}">
          ${a?c`<img
                ...
                loading="lazy"
                @error=${y=>{const x=y.target,$=Xt();x.src!==n&&x.src!==$?(x.src=n,x.classList.add("icon-fallback")):x.src!==$&&(x.src=$)}}
              />`:c`<img
                src=${n}
                alt=${t.name}
                class="icon-fallback"
                @error=${y=>{const x=y.target,$=Xt();x.src!==$&&(x.src=$)}}
              />`}
        </div>
        <div class="name" title=${t.name}>${t.name}</div>
        <div class="type">${(g=t.extension)==null?void 0:g.toUpperCase()}</div>
        ${this.compactLevel<2?c`<div class="desc">${ir(((v=t.size)==null?void 0:v.bytes)||0)}</div>`:m}
        ${this.compactLevel<1?c`<div class="date">${pi(t.created_at||"")}</div>`:m}
        <div class="actions">
          <button
  ...
  `;_t([f({attribute:!1})],qe.prototype,"t",2);_t([f({type:Object})],qe.prototype,"asset",2);_t([f({type:Number})],qe.prototype,"index",2);_t([f({type:Boolean,reflect:!0})],qe.prototype,"selected",2);_t([f({type:Boolean,reflect:!0})],qe.prototype,"disabled",2);_t([f({type:Boolean})],qe.prototype,"multiSelect",2);_t([f({type:Number})],qe.prototype,"compactLevel",2);qe=_t([T("ap-asset-row")],qe);var rd=Object.defineProperty,od=Object.getOwnPropertyDescriptor,yt=(t,e,s,i)=>{for(var r=i>1?void 0:i?od(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&rd(e,s,r),r};let Ge=class extends A{constructor(){super(...arguments),this.previews=[],this.selected=!1,this.disabled=!1,this.selectable=!1,this.multiSelect=!0,this.index=0}_handleClick(t){if(!this.selectable){this._handleOpen();return}if(t.composedPath().some(i=>i instanceof HTMLElement&&(i.classList.contains("check")||i.classList.contains("check-box")))){t.stopPropagation(),this.dispatchEvent(new CustomEvent("folder-select",{detail:{folder:this.folder,index:this.index,event:new MouseEvent("click",{ctrlKey:!0,metaKey:!0,shiftKey:t.shiftKey})},bubbles:!0,composed:!0}));return}this._handleOpen()}_handleOpen(){this.dispatchEvent(new CustomEvent("folder-open",{detail:{folder:this.folder},bubbles:!0,composed:!0}))}_getPreviewUrl(t){return Po(t,"200")}_renderPreviewImg(t){const e=Lo(t.file_type),s=this._getPreviewUrl(t),i=Us(bi(t.file_type)),r=Xt();return c`<div class="preview-slot ${e?"icon-bg":""}">
      <img
    ...
    `];yt([f({type:Object})],Ge.prototype,"folder",2);yt([f({type:Array})],Ge.prototype,"previews",2);yt([f({type:Boolean,reflect:!0})],Ge.prototype,"selected",2);yt([f({type:Boolean,reflect:!0})],Ge.prototype,"disabled",2);yt([f({type:Boolean})],Ge.prototype,"selectable",2);yt([f({type:Boolean})],Ge.prototype,"multiSelect",2);yt([f({type:Number})],Ge.prototype,"index",2);Ge=yt([T("ap-folder-card")],Ge);var ad=Object.defineProperty,nd=Object.getOwnPropertyDescriptor,at=(t,e,s,i)=>{for(var r=i>1?void 0:i?nd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&ad(e,s,r),r};let Ne=class extends A{constructor(){super(...arguments),this.previews=[],this.selected=!1,this.disabled=!1,this.selectable=!1,this.multiSelect=!0,this.index=0,this.compactLevel=0}_getGridColumns(){const t=[];return this.multiSelect&&t.push("32px"),t.push("48px"),t.push("minmax(120px, 1fr)"),t.push("72px"),this.compactLevel<2&&t.push("100px"),this.compactLevel<1&&t.push("120px"),t.push("64px"),t.join(" ")}_renderPreviewImg(t){const e=Lo(t.file_type),s=Po(t,"80"),i=Us(bi(t.file_type)),r=Xt();return c`<div class="preview-slot ${e?"icon-bg":""}">
      <img
        class="preview-img ${e?"icon-mode":""}"
        src="${s||i}"
        alt=""
    ...
    `}_handleClick(t){if(!this.selectable){this._handleOpen();return}if(t.composedPath().some(i=>i instanceof HTMLElement&&(i.classList.contains("check")||i.classList.contains("check-box")))){t.stopPropagation(),this.dispatchEvent(new CustomEvent("folder-select",{detail:{folder:this.folder,index:this.index,event:new MouseEvent("click",{ctrlKey:!0,metaKey:!0,shiftKey:t.shiftKey})},bubbles:!0,composed:!0}));return}this._handleOpen()}_handleOpen(){this.dispatchEvent(new CustomEvent("folder-open",{detail:{folder:this.folder},bubbles:!0,composed:!0}))}render(){var e,s;const t=this.folder;return t?c`
      ...
      >
        ...
        ${this.compactLevel<1?c`<div class="meta">${pi(t.modified_at||t.updated_at||"")}</div>`:m}
        <div></div>
      </div>
    `:c``}};Ne.styles=C`
    :host {
  ...
  `;at([f({type:Object})],Ne.prototype,"folder",2);at([f({type:Array})],Ne.prototype,"previews",2);at([f({type:Boolean,reflect:!0})],Ne.prototype,"selected",2);at([f({type:Boolean,reflect:!0})],Ne.prototype,"disabled",2);at([f({type:Boolean})],Ne.prototype,"selectable",2);at([f({type:Boolean})],Ne.prototype,"multiSelect",2);at([f({type:Number})],Ne.prototype,"index",2);at([f({type:Number})],Ne.prototype,"compactLevel",2);Ne=at([T("ap-folder-row")],Ne);var ld=Object.defineProperty,cd=Object.getOwnPropertyDescriptor,rr=(t,e,s,i)=>{for(var r=i>1?void 0:i?cd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&ld(e,s,r),r};let Ts=class extends A{constructor(){super(...arguments),this.index=0}_handleClick(){this.dispatchEvent(new CustomEvent("label-open",{detail:{label:this.label},bubbles:!0,composed:!0}))}render(){const t=this.label;if(!t)return c``;const e=t.assets_count??0,s=t.color||"#94a3b8";return c`
      <div class="card" @click=${this._handleClick}>
        <div
          class="icon-wrapper"
    ...
    `];rr([f({type:Object})],Ts.prototype,"label",2);rr([f({type:Number})],Ts.prototype,"index",2);Ts=rr([T("ap-label-card")],Ts);var dd=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,or=(t,e,s,i)=>{for(var r=i>1?void 0:i?hd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&dd(e,s,r),r};let Ls=class extends A{constructor(){super(...arguments),this.index=0}_handleClick(){this.dispatchEvent(new CustomEvent("label-open",{detail:{label:this.label},bubbles:!0,composed:!0}))}render(){const t=this.label;if(!t)return c``;const e=t.assets_count??0,s=t.color||"#94a3b8";return c`
  ...
  `;or([f({type:Object})],Ls.prototype,"label",2);or([f({type:Number})],Ls.prototype,"index",2);Ls=or([T("ap-label-row")],Ls);var pd=Object.defineProperty,ud=Object.getOwnPropertyDescriptor,ar=(t,e,s,i)=>{for(var r=i>1?void 0:i?ud(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&pd(e,s,r),r};let Os=class extends A{constructor(){super(...arguments),this.index=0}connectedCallback(){super.connectedCallback(),this.style.setProperty("--sfx-stagger-index",String(this.index))}updated(t){t.has("index")&&this.style.setProperty("--sfx-stagger-index",String(this.index))}_handleClick(){this.dispatchEvent(new CustomEvent("collection-open",{detail:{collection:this.collection},bubbles:!0,composed:!0}))}render(){const t=this.collection;return t?c`
    ...
    `];ar([f({type:Object})],Os.prototype,"collection",2);ar([f({type:Number})],Os.prototype,"index",2);Os=ar([T("ap-collection-card")],Os);var fd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,nr=(t,e,s,i)=>{for(var r=i>1?void 0:i?gd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&fd(e,s,r),r};let Ps=class extends A{constructor(){super(...arguments),this.index=0}_formatDate(t){if(!t)return"";try{return new Date(t).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}catch{return""}}_handleClick(){this.dispatchEvent(new CustomEvent("collection-open",{detail:{collection:this.collection},bubbles:!0,composed:!0}))}render(){const t=this.collection;return t?c`
      <div class="row" @click=${this._handleClick}>
        <div class="icon-wrapper">
  ...
  `;nr([f({type:Object})],Ps.prototype,"collection",2);nr([f({type:Number})],Ps.prototype,"index",2);Ps=nr([T("ap-collection-row")],Ps);var md=Object.defineProperty,vd=Object.getOwnPropertyDescriptor,lr=(t,e,s,i)=>{for(var r=i>1?void 0:i?vd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&md(e,s,r),r};let Is=class extends A{constructor(){super(...arguments),this.index=0}connectedCallback(){super.connectedCallback(),this.style.setProperty("--sfx-stagger-index",String(this.index))}updated(t){t.has("index")&&this.style.setProperty("--sfx-stagger-index",String(this.index))}_handleClick(){this.dispatchEvent(new CustomEvent("collection-folder-open",{detail:{folder:this.folder},bubbles:!0,composed:!0}))}render(){const t=this.folder;return t?c`
      <div class="card" @click=${this._handleClick}>
        <div class="icon-wrapper">
    ...
    `];lr([f({type:Object})],Is.prototype,"folder",2);lr([f({type:Number})],Is.prototype,"index",2);Is=lr([T("ap-collection-folder-card")],Is);var bd=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,cr=(t,e,s,i)=>{for(var r=i>1?void 0:i?xd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&bd(e,s,r),r};let Ds=class extends A{constructor(){super(...arguments),this.index=0}_handleClick(){this.dispatchEvent(new CustomEvent("collection-folder-open",{detail:{folder:this.folder},bubbles:!0,composed:!0}))}render(){const t=this.folder;return t?c`
      <div class="row" @click=${this._handleClick}>
        <div class="icon-wrapper">
  ...
  `;cr([f({type:Object})],Ds.prototype,"folder",2);cr([f({type:Number})],Ds.prototype,"index",2);Ds=cr([T("ap-collection-folder-row")],Ds);var _d=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,rs=(t,e,s,i)=>{for(var r=i>1?void 0:i?yd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&_d(e,s,r),r};let mt=class extends A{constructor(){super(...arguments),this.t=(t,e)=>typeof e=="string"?e:t,this.variant="grid",this.gridSize="normal",this.multiSelect=!0,this.folderCount=0}render(){if(this.variant==="grid"){const a=this.gridSize==="large"?"280px":"220px";return c`
  ...
  `;rs([f({attribute:!1})],mt.prototype,"t",2);rs([f({reflect:!0})],mt.prototype,"variant",2);rs([f({type:String})],mt.prototype,"gridSize",2);rs([f({type:Boolean})],mt.prototype,"multiSelect",2);rs([f({type:Number})],mt.prototype,"folderCount",2);mt=rs([T("ap-skeleton")],mt);var $d=Object.defineProperty,wd=Object.getOwnPropertyDescriptor,ie=(t,e,s,i)=>{for(var r=i>1?void 0:i?wd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&$d(e,s,r),r};let X=class extends A{constructor(){super(...arguments),this.asset=null,this.assets=[],this.selectedIds=[],this.containerToken="",this.showMetadata=!0,this.metadataFields=[],this.labels=[],this.regionalFilters={},this.multiSelect=!0,this.t=(t,e)=>typeof e=="string"?e:t,this._isFullscreen=!1,this._fsImageLoaded=!1,this._previewLoading=!1,this._openSections=new Set(["file-info","metadata"]),this._hls=null}connectedCallback(){super.connectedCallback(),this._onFullscreenChange=this._onFullscreenChange.bind(this),this._onKeyDown=this._onKeyDown.bind(this),document.addEventListener("fullscreenchange",this._onFullscreenChange),document.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("fullscreenchange",this._onFullscreenChange),document.removeEventListener("keydown",this._onKeyDown),this._destroyHls()}_onKeyDown(t){if(t.key!=="ArrowLeft"&&t.key!=="ArrowRight")return;const e=t.composedPath()[0];if(!e)return;const s=e.tagName;s==="INPUT"||s==="TEXTAREA"||s==="SELECT"||e.getAttribute("role")==="radio"||e.getAttribute("role")==="listbox"||e.isContentEditable||(t.preventDefault(),t.key==="ArrowLeft"?this._prev():this._next())}_destroyHls(){this._hls&&(this._hls.destroy(),this._hls=null)}updated(t){if(super.updated(t),t.has("asset")&&(this._destroyHls(),this._previewLoading=!0,this.asset)){const e=Qt(this.asset.type);e==="video"&&this._setupHls(this.asset),e!=="image"&&e!=="video"&&(this._previewLoading=!1)}}async _setupHls(t){var i,r;const e=Un(t);if(!e||(await this.updateComplete,((i=this.asset)==null?void 0:i.uuid)!==t.uuid))return;const s=this._videoEl;if(s){if(s.canPlayType("application/vnd.apple.mpegurl")){s.src=e;return}try{const{default:o}=await K(async()=>{const{default:n}=await import("./hls.light-CLqSdhbI.js");return{default:n}},[]);if(!o.isSupported()||((r=this.asset)==null?void 0:r.uuid)!==t.uuid||!this.isConnected)return;const a=new o;this._hls=a,a.loadSource(e),a.attachMedia(s),a.on(o.Events.ERROR,(n,l)=>{var d;l.fatal&&(this._destroyHls(),s.src=((d=t.url)==null?void 0:d.cdn)||"")})}catch{}}}_onFullscreenChange(){this._isFullscreen=!!document.fullscreenElement,this._isFullscreen&&(this._fsImageLoaded=!1)}_close(){this.dispatchEvent(new CustomEvent("preview-close",{bubbles:!0,composed:!0}))}_exitFullscreen(){var t;(t=document.exitFullscreen)==null||t.call(document)}_fullscreen(){var e,s,i,r,o,a;if(((s=(e=this.asset)==null?void 0:e.extension)==null?void 0:s.toLowerCase())==="pdf"&&((r=(i=this.asset)==null?void 0:i.url)!=null&&r.cdn)){window.open(this.asset.url.cdn,"_blank","noopener");return}this._fsImageLoaded=!1,(a=(o=this.previewArea)==null?void 0:o.requestFullscreen)==null||a.call(o)}_select(){if(!this.asset)return;if(!this.multiSelect){this.dispatchEvent(new CustomEvent("asset-quick-select",{detail:{asset:this.asset},bubbles:!0,composed:!0}));return}const t=this._getCurrentIndex();this.dispatchEvent(new CustomEvent("asset-select",{detail:{asset:this.asset,index:t,event:new MouseEvent("click",{ctrlKey:!0,metaKey:!0})},bubbles:!0,composed:!0}))}_getCurrentIndex(){return!this.asset||this.assets.length===0?-1:this.assets.findIndex(t=>t.uuid===this.asset.uuid)}_navigateTo(t){this._fsImageLoaded=!1,this.dispatchEvent(new CustomEvent("preview-navigate",{detail:{asset:t},bubbles:!0,composed:!0}))}_supportsFullscreen(t){const e=Qt(t.type);return e==="image"||e==="video"||e==="audio"}_findNavTarget(t,e){const s=e===1?this.assets.length:-1;for(let i=t+e;i!==s;i+=e)if(!this._isFullscreen||this._supportsFullscreen(this.assets[i]))return i;return-1}_prev(){const t=this._getCurrentIndex();if(t<=0)return;const e=this._findNavTarget(t,-1);e>=0&&this._navigateTo(this.assets[e])}_next(){const t=this._getCurrentIndex();if(t<0||t>=this.assets.length-1)return;const e=this._findNavTarget(t,1);e>=0&&this._navigateTo(this.assets[e])}_getFullscreenImageUrl(t){var r,o;const e=(r=t.url)==null?void 0:r.cdn;if(!e)return ci(t)||"";const s={source:"asset",asset:t};if(((o=t.extension)==null?void 0:o.toLowerCase())==="svg")return Je(e,s);const i=Jt(e,this.containerToken);return Je(Lt(i,{w:String(window.screen.width),dpr:String(window.devicePixelRatio||1),org_if_sml:"1"}),s)}_getBlurDimensions(t){var a,n;const e=(a=t.info)==null?void 0:a.img_w,s=(n=t.info)==null?void 0:n.img_h;if(!e||!s)return{width:"100vw",height:"100vh"};const i=window.innerWidth,r=window.innerHeight,o=Math.min(i/e,r/s,1);return{width:`${Math.round(e*o)}px`,height:`${Math.round(s*o)}px`}}_onFsImageLoad(){this._fsImageLoaded=!0}_getTagEntries(t){if(!t)return[];if(Array.isArray(t))return this._parseTagArray(t);const e=Object.values(t);if(e.length>0&&Array.isArray(e[0])){const s=e.flat(),i=new Set;return s.filter(r=>!r.label||i.has(r.sid)?!1:(i.add(r.sid),!0))}return e.map(s=>({label:s.label,sid:s.sid})).filter(s=>s.label)}_parseTagArray(t){return t.map(e=>{if(typeof e=="string")return{label:e,sid:e};const s=e;return{label:s.label||Object.values(s.names||{})[0]||"",sid:s.sid||""}}).filter(e=>e.label)}_applyTagFilter(t){this.dispatchEvent(new CustomEvent("filter-update",{detail:{key:w.TAGS,values:[t],operator:M.IS},bubbles:!0,composed:!0}))}_applyLabelFilter(t){this.dispatchEvent(new CustomEvent("filter-update",{detail:{key:w.LABELS,values:[t],operator:M.IS},bubbles:!0,composed:!0}))}_toggleSection(t){const e=new Set(this._openSections);e.has(t)?e.delete(t):e.add(t),this._openSections=e}_renderFileInfoSection(t){const e=this._getFileInfoRows(t);if(e.length===0)return m;const s=this._openSections.has("file-info");return c`
    ...
    `}render(){var O,E,z,S,V,N,F,Q;const t=this.asset;if(!t)return m;const e=Qt(t.type),s=e==="image",i=e==="video",r=e==="audio",o=((O=t.extension)==null?void 0:O.toLowerCase())==="pdf",a=Us(t.extension||""),n=Wi(t.extension||""),l=((E=t.extension)==null?void 0:E.toLowerCase())==="svg",d=ci(t),p=s?l?Je(((z=t.url)==null?void 0:z.cdn)||"",{source:"asset",asset:t}):d||Je(Jt(((S=t.url)==null?void 0:S.cdn)||"",this.containerToken),{source:"asset",asset:t}):"",u=s?this._getFullscreenImageUrl(t):"",h=s&&!l?this._getBlurDimensions(t):null,g=i&&((V=t.url)==null?void 0:V.cdn)||"",v=i?Je(((N=t.info)==null?void 0:N.video_thumbnail)||((F=t.info)==null?void 0:F.preview)||"",{source:"video",asset:t}):"",y=o&&!s?Xi(t):"",x=this._getCurrentIndex(),$=x>0&&this._findNavTarget(x,-1)>=0,k=x>=0&&this._findNavTarget(x,1)>=0,L=this.assets.length>1;return c`
      <div class="panel">
        ...
        <div class="preview-area ${s&&n?"chess":""}">
          ...
          ${s?c`
                <img
                  src=${p}
                  alt=${t.name}
                  @load=${fe=>{fe.target.classList.remove("icon-fallback"),this._previewLoading=!1}}
                  @error=${fe=>{const Y=fe.target;this._previewLoading=!1,Y.src!==a&&(Y.src=a,Y.classList.add("icon-fallback"))}}
                />
          ...
          ${o&&!s?c`
                <img
                  ...
                  @error=${fe=>{const Y=fe.target;Y.src!==a&&(Y.src=a,Y.classList.add("icon-fallback"))}}
                />
              `:m}
  ...
  `;ie([f({type:Object})],X.prototype,"asset",2);ie([f({type:Array})],X.prototype,"assets",2);ie([f({type:Array})],X.prototype,"selectedIds",2);ie([f()],X.prototype,"containerToken",2);ie([f({type:Boolean})],X.prototype,"showMetadata",2);ie([f({type:Array})],X.prototype,"metadataFields",2);ie([f({type:Array})],X.prototype,"labels",2);ie([f({type:Object})],X.prototype,"regionalFilters",2);ie([f({type:Boolean})],X.prototype,"multiSelect",2);ie([f({attribute:!1})],X.prototype,"t",2);ie([vt(".preview-area")],X.prototype,"previewArea",2);ie([vt("video")],X.prototype,"_videoEl",2);ie([_()],X.prototype,"_isFullscreen",2);ie([_()],X.prototype,"_fsImageLoaded",2);ie([_()],X.prototype,"_previewLoading",2);ie([_()],X.prototype,"_openSections",2);X=ie([T("ap-preview-panel")],X);var kd=Object.defineProperty,Sd=Object.getOwnPropertyDescriptor,dr=(t,e,s,i)=>{for(var r=i>1?void 0:i?Sd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&kd(e,s,r),r};const Cd={sparkles:[{tag:"path",attrs:{d:"m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"}},{tag:"path",attrs:{d:"M5 3v4"}},{tag:"path",attrs:{d:"M19 17v4"}},{tag:"path",attrs:{d:"M3 5h4"}},{tag:"path",attrs:{d:"M17 19h4"}}],search:[{tag:"circle",attrs:{cx:"11",cy:"11",r:"8"}},{tag:"path",attrs:{d:"m21 21-4.3-4.3"}}],check:"M20 6 9 17l-5-5","check-check":[{tag:"path",attrs:{d:"M18 6 7 17l-5-5"}},{tag:"path",attrs:{d:"m22 10-7.5 7.5L13 16"}}],close:[{tag:"path",attrs:{d:"M18 6 6 18"}},{tag:"path",attrs:{d:"m6 6 12 12"}}],"chevron-left":"m15 18-6-6 6-6","chevron-right":"m9 18 6-6-6-6","chevron-down":"m6 9 6 6 6-6",download:[{tag:"path",attrs:{d:"M12 15V3"}},{tag:"path",attrs:{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}},{tag:"path",attrs:{d:"m7 10 5 5 5-5"}}],upload:[{tag:"path",attrs:{d:"M12 3v12"}},{tag:"path",attrs:{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}},{tag:"path",attrs:{d:"m17 8-5-5-5 5"}}],fullscreen:[{tag:"path",attrs:{d:"M8 3H5a2 2 0 0 0-2 2v3"}},{tag:"path",attrs:{d:"M21 8V5a2 2 0 0 0-2-2h-3"}},{tag:"path",attrs:{d:"M3 16v3a2 2 0 0 0 2 2h3"}},{tag:"path",attrs:{d:"M16 21h3a2 2 0 0 0 2-2v-3"}}],trash:[{tag:"path",attrs:{d:"M10 11v6"}},{tag:"path",attrs:{d:"M14 11v6"}},{tag:"path",attrs:{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"}},{tag:"path",attrs:{d:"M3 6h18"}},{tag:"path",attrs:{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"}}],more:[{tag:"circle",attrs:{cx:"12",cy:"12",r:"1"}},{tag:"circle",attrs:{cx:"19",cy:"12",r:"1"}},{tag:"circle",attrs:{cx:"5",cy:"12",r:"1"}}],grid:[{tag:"rect",attrs:{x:"3",y:"3",width:"18",height:"18",rx:"2"}},{tag:"path",attrs:{d:"M12 3v18"}},{tag:"path",attrs:{d:"M3 12h18"}}],list:[{tag:"path",attrs:{d:"M3 5h.01"}},{tag:"path",attrs:{d:"M3 12h.01"}},{tag:"path",attrs:{d:"M3 19h.01"}},{tag:"path",attrs:{d:"M8 5h13"}},{tag:"path",attrs:{d:"M8 12h13"}},{tag:"path",attrs:{d:"M8 19h13"}}],preview:[{tag:"path",attrs:{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"}},{tag:"circle",attrs:{cx:"12",cy:"12",r:"3"}}],select:[{tag:"path",attrs:{d:"M5 12h14"}},{tag:"path",attrs:{d:"M12 5v14"}}],"gallery-vertical-end":[{tag:"path",attrs:{d:"M7 2h10"}},{tag:"path",attrs:{d:"M5 6h14"}},{tag:"rect",attrs:{width:"18",height:"12",x:"3",y:"10",rx:"2"}}],filter:[{tag:"path",attrs:{d:"M2 5h20"}},{tag:"path",attrs:{d:"M6 12h12"}},{tag:"path",attrs:{d:"M9 19h6"}}],sort:[{tag:"path",attrs:{d:"m21 16-4 4-4-4"}},{tag:"path",attrs:{d:"M17 20V4"}},{tag:"path",attrs:{d:"m3 8 4-4 4 4"}},{tag:"path",attrs:{d:"M7 4v16"}}],"sort-asc":[{tag:"path",attrs:{d:"m3 8 4-4 4 4"}},{tag:"path",attrs:{d:"M7 4v16"}},{tag:"path",attrs:{d:"M11 12h4"}},{tag:"path",attrs:{d:"M11 16h7"}},{tag:"path",attrs:{d:"M11 20h10"}}],"sort-desc":[{tag:"path",attrs:{d:"m3 16 4 4 4-4"}},{tag:"path",attrs:{d:"M7 20V4"}},{tag:"path",attrs:{d:"M11 4h4"}},{tag:"path",attrs:{d:"M11 8h7"}},{tag:"path",attrs:{d:"M11 12h10"}}],image:[{tag:"rect",attrs:{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2"}},{tag:"circle",attrs:{cx:"9",cy:"9",r:"2"}},{tag:"path",attrs:{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"}}],video:[{tag:"path",attrs:{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"}},{tag:"rect",attrs:{x:"2",y:"6",width:"14",height:"12",rx:"2"}}],audio:[{tag:"path",attrs:{d:"M9 18V5l12-2v13"}},{tag:"circle",attrs:{cx:"6",cy:"18",r:"3"}},{tag:"circle",attrs:{cx:"18",cy:"16",r:"3"}}],music:[{tag:"path",attrs:{d:"M9 18V5l12-2v13"}},{tag:"circle",attrs:{cx:"6",cy:"18",r:"3"}},{tag:"circle",attrs:{cx:"18",cy:"16",r:"3"}}],document:[{tag:"path",attrs:{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"}},{tag:"path",attrs:{d:"M14 2v5a1 1 0 0 0 1 1h5"}},{tag:"path",attrs:{d:"M10 9H8"}},{tag:"path",attrs:{d:"M16 13H8"}},{tag:"path",attrs:{d:"M16 17H8"}}],"file-text":[{tag:"path",attrs:{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"}},{tag:"path",attrs:{d:"M14 2v5a1 1 0 0 0 1 1h5"}},{tag:"path",attrs:{d:"M10 9H8"}},{tag:"path",attrs:{d:"M16 13H8"}},{tag:"path",attrs:{d:"M16 17H8"}}],file:[{tag:"path",attrs:{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"}},{tag:"path",attrs:{d:"M14 2v5a1 1 0 0 0 1 1h5"}}],archive:[{tag:"rect",attrs:{width:"20",height:"5",x:"2",y:"3",rx:"1"}},{tag:"path",attrs:{d:"M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"}},{tag:"path",attrs:{d:"M10 12h4"}}],font:[{tag:"path",attrs:{d:"M12 4v16"}},{tag:"path",attrs:{d:"M4 7V5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2"}},{tag:"path",attrs:{d:"M9 20h6"}}],text:[{tag:"path",attrs:{d:"M12 4v16"}},{tag:"path",attrs:{d:"M4 7V5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2"}},{tag:"path",attrs:{d:"M9 20h6"}}],clapperboard:[{tag:"path",attrs:{d:"m12.296 3.464 3.02 3.956"}},{tag:"path",attrs:{d:"M20.2 6 3 11l-.9-2.4c-.3-1.1.3-2.2 1.3-2.5l13.5-4c1.1-.3 2.2.3 2.5 1.3z"}},{tag:"path",attrs:{d:"M3 11h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}},{tag:"path",attrs:{d:"m6.18 5.276 3.1 3.899"}}],folder:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z","folder-open":"m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2","folder-plus":[{tag:"path",attrs:{d:"M12 10v6"}},{tag:"path",attrs:{d:"M9 13h6"}},{tag:"path",attrs:{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"}}],inbox:[{tag:"path",attrs:{d:"M22 12L16 12L14 15L10 15L8 12L2 12"}},{tag:"path",attrs:{d:"M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"}}],tags:[{tag:"path",attrs:{d:"M13.172 2a2 2 0 0 1 1.414.586l6.71 6.71a2.4 2.4 0 0 1 0 3.408l-4.592 4.592a2.4 2.4 0 0 1-3.408 0l-6.71-6.71A2 2 0 0 1 6 9.172V3a1 1 0 0 1 1-1z"}},{tag:"path",attrs:{d:"M2 7v6.172a2 2 0 0 0 .586 1.414l6.71 6.71a2.4 2.4 0 0 0 3.191.193"}},{tag:"circle",attrs:{cx:"10.5",cy:"6.5",r:".5",fill:"currentColor"}}],tag:[{tag:"path",attrs:{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"}},{tag:"circle",attrs:{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor"}}],hash:[{tag:"path",attrs:{d:"M4 9h16"}},{tag:"path",attrs:{d:"M4 15h16"}},{tag:"path",attrs:{d:"M10 3 8 21"}},{tag:"path",attrs:{d:"M14 3 16 21"}}],calendar:[{tag:"path",attrs:{d:"M8 2v4"}},{tag:"path",attrs:{d:"M16 2v4"}},{tag:"rect",attrs:{width:"18",height:"18",x:"3",y:"4",rx:"2"}},{tag:"path",attrs:{d:"M3 10h18"}}],"file-type":[{tag:"path",attrs:{d:"M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4"}},{tag:"path",attrs:{d:"M14 2v4a2 2 0 0 0 2 2h4"}},{tag:"path",attrs:{d:"M2 13v-1h6v1"}},{tag:"path",attrs:{d:"M5 12v6"}},{tag:"path",attrs:{d:"M4 18h2"}}],scaling:[{tag:"path",attrs:{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"}},{tag:"path",attrs:{d:"M14 15H9v-5"}},{tag:"path",attrs:{d:"M20 9V4h-5"}},{tag:"path",attrs:{d:"M20 4l-6 6"}}],history:[{tag:"path",attrs:{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}},{tag:"path",attrs:{d:"M3 3v5h5"}},{tag:"path",attrs:{d:"M12 7v5l4 2"}}],"swatch-book":[{tag:"path",attrs:{d:"M11 17a4 4 0 0 1-8 0V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2Z"}},{tag:"path",attrs:{d:"M16.7 13H19a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H7"}},{tag:"path",attrs:{d:"M7 17h.01"}},{tag:"path",attrs:{d:"m11 8 2.3-2.3a2.4 2.4 0 0 1 3.404.004L18.6 7.6a2.4 2.4 0 0 1 .026 3.434L9.9 19.8"}}],"badge-check":[{tag:"path",attrs:{d:"M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"}},{tag:"path",attrs:{d:"m9 12 2 2 4-4"}}],box:[{tag:"path",attrs:{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"}},{tag:"path",attrs:{d:"m3.3 7 8.7 5 8.7-5"}},{tag:"path",attrs:{d:"M12 22V12"}}],"layout-grid":[{tag:"rect",attrs:{width:"7",height:"7",x:"3",y:"3",rx:"1"}},{tag:"rect",attrs:{width:"7",height:"7",x:"14",y:"3",rx:"1"}},{tag:"rect",attrs:{width:"7",height:"7",x:"14",y:"14",rx:"1"}},{tag:"rect",attrs:{width:"7",height:"7",x:"3",y:"14",rx:"1"}}],"layout-template":[{tag:"rect",attrs:{width:"18",height:"7",x:"3",y:"3",rx:"1"}},{tag:"rect",attrs:{width:"9",height:"7",x:"3",y:"14",rx:"1"}},{tag:"rect",attrs:{width:"5",height:"7",x:"16",y:"14",rx:"1"}}],pin:[{tag:"path",attrs:{d:"M12 17v5"}},{tag:"path",attrs:{d:"M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V7a1 1 0 0 1 1-1 2 2 0 0 0 2-2H6a2 2 0 0 0 2 2 1 1 0 0 1 1 1z"}}],"pin-off":[{tag:"path",attrs:{d:"M12 17v5"}},{tag:"path",attrs:{d:"M15 9.34V7a1 1 0 0 1 1-1 2 2 0 0 0 2-2H6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v2.34"}},{tag:"path",attrs:{d:"M2 2l20 20"}},{tag:"path",attrs:{d:"M9 12a2 2 0 0 1-1.11 1.79l-1.78.9"}},{tag:"path",attrs:{d:"M17 17H5"}}],lock:[{tag:"rect",attrs:{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2"}},{tag:"path",attrs:{d:"M7 11V7a5 5 0 0 1 10 0v4"}}],globe:[{tag:"circle",attrs:{cx:"12",cy:"12",r:"10"}},{tag:"path",attrs:{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"}},{tag:"path",attrs:{d:"M2 12h20"}}],"circle-check-big":[{tag:"path",attrs:{d:"M21.801 10A10 10 0 1 1 17 3.335"}},{tag:"path",attrs:{d:"m9 11 3 3L22 4"}}],"x-circle":[{tag:"circle",attrs:{cx:"12",cy:"12",r:"10"}},{tag:"path",attrs:{d:"m15 9-6 6"}},{tag:"path",attrs:{d:"m9 9 6 6"}}],ban:[{tag:"circle",attrs:{cx:"12",cy:"12",r:"10"}},{tag:"path",attrs:{d:"m4.9 4.9 14.2 14.2"}}],clock:[{tag:"circle",attrs:{cx:"12",cy:"12",r:"10"}},{tag:"path",attrs:{d:"M12 6v6l4 2"}}],"toggle-left":[{tag:"rect",attrs:{width:"20",height:"14",x:"2",y:"5",rx:"7"}},{tag:"circle",attrs:{cx:"9",cy:"12",r:"3"}}],"file-digit":[{tag:"path",attrs:{d:"M4 12V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2"}},{tag:"path",attrs:{d:"M14 2v5a1 1 0 0 0 1 1h5"}},{tag:"path",attrs:{d:"M10 16h2v6"}},{tag:"path",attrs:{d:"M10 22h4"}},{tag:"rect",attrs:{width:"4",height:"6",x:"2",y:"16",rx:"2"}}],"decimals-arrow-right":[{tag:"path",attrs:{d:"M10 18h10"}},{tag:"path",attrs:{d:"m17 21 3-3-3-3"}},{tag:"path",attrs:{d:"M3 11h.01"}},{tag:"rect",attrs:{width:"5",height:"8",x:"15",y:"3",rx:"2.5"}},{tag:"rect",attrs:{width:"5",height:"8",x:"6",y:"3",rx:"2.5"}}],"text-initial":[{tag:"path",attrs:{d:"M15 5h6"}},{tag:"path",attrs:{d:"M15 12h6"}},{tag:"path",attrs:{d:"M3 19h18"}},{tag:"path",attrs:{d:"m3 12 3.553-7.724a.5.5 0 0 1 .894 0L11 12"}},{tag:"path",attrs:{d:"M3.92 10h6.16"}}],"text-align-justify":[{tag:"path",attrs:{d:"M3 5h18"}},{tag:"path",attrs:{d:"M3 12h18"}},{tag:"path",attrs:{d:"M3 19h18"}}],paperclip:"m16 6-8.414 8.586a2 2 0 0 0 2.829 2.829l8.414-8.586a4 4 0 1 0-5.657-5.657l-8.379 8.551a6 6 0 1 0 8.485 8.485l8.379-8.551","link-2":[{tag:"path",attrs:{d:"M9 17H7A5 5 0 0 1 7 7h2"}},{tag:"path",attrs:{d:"M15 7h2a5 5 0 1 1 0 10h-2"}},{tag:"path",attrs:{d:"M8 12h8"}}],"circle-dot":[{tag:"circle",attrs:{cx:"12",cy:"12",r:"10"}},{tag:"circle",attrs:{cx:"12",cy:"12",r:"1"}}],"square-check":[{tag:"rect",attrs:{width:"18",height:"18",x:"3",y:"3",rx:"2"}},{tag:"path",attrs:{d:"m9 12 2 2 4-4"}}],locate:[{tag:"path",attrs:{d:"M2 12h3"}},{tag:"path",attrs:{d:"M19 12h3"}},{tag:"path",attrs:{d:"M12 2v3"}},{tag:"path",attrs:{d:"M12 19v3"}},{tag:"circle",attrs:{cx:"12",cy:"12",r:"7"}}],"list-ordered":[{tag:"path",attrs:{d:"M11 5h10"}},{tag:"path",attrs:{d:"M11 12h10"}},{tag:"path",attrs:{d:"M11 19h10"}},{tag:"path",attrs:{d:"M4 4h1v5"}},{tag:"path",attrs:{d:"M4 9h2"}},{tag:"path",attrs:{d:"M6.5 20H3.4c0-1 2.6-1.925 2.6-3.5a1.5 1.5 0 0 0-2.6-1.02"}}],plus:[{tag:"path",attrs:{d:"M5 12h14"}},{tag:"path",attrs:{d:"M12 5v14"}}],component:[{tag:"path",attrs:{d:"M15.536 11.293a1 1 0 0 0 0 1.414l2.376 2.377a1 1 0 0 0 1.414 0l2.377-2.377a1 1 0 0 0 0-1.414l-2.377-2.377a1 1 0 0 0-1.414 0z"}},{tag:"path",attrs:{d:"M2.297 11.293a1 1 0 0 0 0 1.414l2.377 2.377a1 1 0 0 0 1.414 0l2.377-2.377a1 1 0 0 0 0-1.414L6.088 8.916a1 1 0 0 0-1.414 0z"}},{tag:"path",attrs:{d:"M8.916 17.912a1 1 0 0 0 0 1.415l2.377 2.376a1 1 0 0 0 1.414 0l2.377-2.376a1 1 0 0 0 0-1.415l-2.377-2.376a1 1 0 0 0-1.414 0z"}},{tag:"path",attrs:{d:"M8.916 4.674a1 1 0 0 0 0 1.414l2.377 2.376a1 1 0 0 0 1.414 0l2.377-2.376a1 1 0 0 0 0-1.414l-2.377-2.377a1 1 0 0 0-1.414 0z"}}],link:[{tag:"path",attrs:{d:"M10 13a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1 1"}},{tag:"path",attrs:{d:"M14 11a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1-1"}}],move:[{tag:"path",attrs:{d:"M5 9 2 12l3 3"}},{tag:"path",attrs:{d:"M9 5l3-3 3 3"}},{tag:"path",attrs:{d:"M15 19l-3 3-3-3"}},{tag:"path",attrs:{d:"M19 9l3 3-3 3"}},{tag:"path",attrs:{d:"M2 12h20"}},{tag:"path",attrs:{d:"M12 2v20"}}],pencil:[{tag:"path",attrs:{d:"M12 20h9"}},{tag:"path",attrs:{d:"M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z"}}],unlock:[{tag:"rect",attrs:{x:"5",y:"11",width:"14",height:"10",rx:"2"}},{tag:"path",attrs:{d:"M8 11V7a4 4 0 0 1 7.5-2"}}],star:[{tag:"path",attrs:{d:"m12 17.3-6.2 3.7 1.6-7L2 9.2l7.1-.6L12 2l2.9 6.6 7.1.6-5.4 4.8 1.6 7z"}}],"star-filled":[{tag:"path",attrs:{d:"m12 17.3-6.2 3.7 1.6-7L2 9.2l7.1-.6L12 2l2.9 6.6 7.1.6-5.4 4.8 1.6 7z",fill:"currentColor"}}],dot:[{tag:"circle",attrs:{cx:"12",cy:"12",r:"5",fill:"currentColor"}}]};let Ms=class extends A{constructor(){super(...arguments),this.name="",this.size=20}render(){const t=Cd[this.name];if(!t)return m;const e=typeof t=="string"?pt`<path d=${t}></path>`:t.map(s=>{const{tag:i,attrs:r}=s;return i==="circle"?pt`<circle cx=${r.cx} cy=${r.cy} r=${r.r} fill=${r.fill??"none"}></circle>`:i==="rect"?pt`<rect width=${r.width} height=${r.height} x=${r.x} y=${r.y} rx=${r.rx??"0"} ry=${r.ry??"0"}></rect>`:pt`<path d=${r.d} fill=${r.fill??"none"}></path>`});return c`
    ...
    `];dr([f()],Ms.prototype,"name",2);dr([f({type:Number})],Ms.prototype,"size",2);Ms=dr([T("sfx-icon")],Ms);var Ad=Object.defineProperty,Ed=Object.getOwnPropertyDescriptor,Qo=(t,e,s,i)=>{for(var r=i>1?void 0:i?Ed(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Ad(e,s,r),r};let ui=class extends A{constructor(){super(...arguments),this.size=24}render(){return c`<div
      class="spinner"
    ...
    `];Qo([f({type:Number})],ui.prototype,"size",2);ui=Qo([T("sfx-spinner")],ui);var Fd=Object.defineProperty,Td=Object.getOwnPropertyDescriptor,Wo=(t,e,s,i)=>{for(var r=i>1?void 0:i?Td(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Fd(e,s,r),r};let fi=class extends A{constructor(){super(...arguments),this.variant="default"}render(){return c`<span class="badge"><slot></slot></span>`}};fi.styles=[C`
      :host {
        display: inline-flex;
      }
      .badge {
    ...
    `];Wo([f({reflect:!0})],fi.prototype,"variant",2);fi=Wo([T("sfx-badge")],fi);var Ld=Object.defineProperty,Od=Object.getOwnPropertyDescriptor,hr=(t,e,s,i)=>{for(var r=i>1?void 0:i?Od(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Ld(e,s,r),r};let Rs=class extends A{constructor(){super(...arguments),this.text="",this.placement="top"}render(){return c`
      <slot></slot>
    ...
    `];hr([f()],Rs.prototype,"text",2);hr([f()],Rs.prototype,"placement",2);Rs=hr([T("sfx-tooltip")],Rs);var Pd=Object.defineProperty,Id=Object.getOwnPropertyDescriptor,pr=(t,e,s,i)=>{for(var r=i>1?void 0:i?Id(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Pd(e,s,r),r};let zs=class extends A{constructor(){super(...arguments),this.open=!1,this.align="start",this._handleOutsideClick=t=>{this.open&&!t.composedPath().includes(this)&&(this.open=!1)},this._handleKeyDown=t=>{t.key==="Escape"&&this.open&&(this.open=!1)}}render(){return c`
    ...
    `];pr([_()],zs.prototype,"open",2);pr([f()],zs.prototype,"align",2);zs=pr([T("sfx-popover")],zs);var Dd=Object.defineProperty,Md=Object.getOwnPropertyDescriptor,_i=(t,e,s,i)=>{for(var r=i>1?void 0:i?Md(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Dd(e,s,r),r};let Zt=class extends A{constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this._hasLabel=!1,this._handleHostClick=()=>{this.dispatchEvent(new CustomEvent("sfx-toggle",{detail:{checked:!this.checked},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._handleHostClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleHostClick)}_onSlotChange(t){const e=t.target;this._hasLabel=e.assignedNodes({flatten:!0}).length>0,this.requestUpdate()}render(){return c`
      <div class="box">
        <svg
          class="check"
          width="12"
    ...
    `];_i([f({type:Boolean,reflect:!0})],Zt.prototype,"checked",2);_i([f({type:Boolean,reflect:!0})],Zt.prototype,"indeterminate",2);_i([f({type:Boolean,reflect:!0})],Zt.prototype,"disabled",2);Zt=_i([T("sfx-checkbox")],Zt);var Rd=Object.defineProperty,zd=Object.getOwnPropertyDescriptor,jt=(t,e,s,i)=>{for(var r=i>1?void 0:i?zd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Rd(e,s,r),r};let it=class extends A{constructor(){super(...arguments),this.value="",this.options=[],this.disabled=!1,this.clearable=!1,this.direction="vertical",this._onKeydown=t=>{const e=this.options.filter(r=>!this.disabled&&!r.disabled);if(e.length===0)return;const s=e.findIndex(r=>r.value===this.value);let i=null;switch(t.key){case"ArrowDown":case"ArrowRight":t.preventDefault(),i=s<0?0:(s+1)%e.length;break;case"ArrowUp":case"ArrowLeft":t.preventDefault(),i=s<0?e.length-1:(s-1+e.length)%e.length;break;case" ":case"Enter":t.preventDefault(),s>=0?this._select(e[s]):e.length>0&&this._select(e[0]);return;default:return}i!==null&&this._select(e[i])}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radiogroup"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0"),this.addEventListener("keydown",this._onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this._onKeydown)}render(){return c`
      ${this.options.map(t=>c`
        ...
        `)}
    `}_select(t){if(this.disabled||t.disabled)return;const e=this.clearable&&t.value===this.value?"":t.value;this.dispatchEvent(new CustomEvent("sfx-change",{detail:{value:e},bubbles:!0,composed:!0}))}};it.styles=[Ks,C`
      :host {
        display: flex;
        flex-direction: column;
        gap: 6px;
    ...
    `];jt([f()],it.prototype,"value",2);jt([f({type:Array})],it.prototype,"options",2);jt([f({type:Boolean})],it.prototype,"disabled",2);jt([f({type:Boolean})],it.prototype,"clearable",2);jt([f({reflect:!0})],it.prototype,"direction",2);jt([f({reflect:!0})],it.prototype,"columns",2);it=jt([T("sfx-radio-group")],it);var Nd=Object.defineProperty,jd=Object.getOwnPropertyDescriptor,ue=(t,e,s,i)=>{for(var r=i>1?void 0:i?jd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Nd(e,s,r),r};let se=class extends A{constructor(){super(...arguments),this.value="",this.label="",this.variant="default",this.clearable=!1,this.options=[],this._open=!1,this._focusedIndex=-1,this._menuPosition="below",this._menuAlign="align-left",this._menuTop=0,this._menuBottom=0,this._menuLeft=0,this._menuRight=0,this._menuWidth=0,this._handleOutsideClick=t=>{t.composedPath().includes(this)||(this._open=!1,document.removeEventListener("click",this._handleOutsideClick))}}close(){this._open=!1}render(){const t=this.options.find(s=>s.value===this.value),e="sfx-dropdown-menu";return c`
      <button
        class="trigger"
        role="combobox"
    ...
    `];ue([f()],se.prototype,"value",2);ue([f()],se.prototype,"label",2);ue([f({reflect:!0})],se.prototype,"variant",2);ue([f({type:Boolean})],se.prototype,"clearable",2);ue([f({type:Array})],se.prototype,"options",2);ue([_()],se.prototype,"_open",2);ue([_()],se.prototype,"_focusedIndex",2);ue([_()],se.prototype,"_menuPosition",2);ue([_()],se.prototype,"_menuAlign",2);ue([_()],se.prototype,"_menuTop",2);ue([_()],se.prototype,"_menuBottom",2);ue([_()],se.prototype,"_menuLeft",2);ue([_()],se.prototype,"_menuRight",2);ue([_()],se.prototype,"_menuWidth",2);se=ue([T("sfx-dropdown")],se);var Ud=Object.defineProperty,Kd=Object.getOwnPropertyDescriptor,Hs=(t,e,s,i)=>{for(var r=i>1?void 0:i?Kd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Ud(e,s,r),r};let Dt=class extends A{constructor(){super(...arguments),this.heading="File info",this.rows=[],this.collapsible=!1,this.open=!0}toggle(){this.collapsible&&(this.open=!this.open)}renderHead(){const t=c`<span>${this.heading}</span><span class="spacer"></span>`;return this.collapsible?c`<button
      class="head"
      type="button"
  ...
  `;Hs([f()],Dt.prototype,"heading",2);Hs([f({attribute:!1})],Dt.prototype,"rows",2);Hs([f({type:Boolean})],Dt.prototype,"collapsible",2);Hs([f({type:Boolean,reflect:!0})],Dt.prototype,"open",2);Dt=Hs([T("sfx-asset-info")],Dt);var Bd=Object.defineProperty,Vd=Object.getOwnPropertyDescriptor,ur=(t,e,s,i)=>{for(var r=i>1?void 0:i?Vd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Bd(e,s,r),r};let Ns=class extends A{constructor(){super(...arguments),this.items=[],this.rootLabel="Root"}_navigate(t){this.dispatchEvent(new CustomEvent("breadcrumb-navigate",{detail:{uuid:t},bubbles:!0,composed:!0}))}render(){return this.items.length===0?c``:c`
  ...
  `;ur([f({type:Array})],Ns.prototype,"items",2);ur([f()],Ns.prototype,"rootLabel",2);Ns=ur([T("sfx-breadcrumb")],Ns);var Hd=Object.defineProperty,qd=Object.getOwnPropertyDescriptor,Te=(t,e,s,i)=>{for(var r=i>1?void 0:i?qd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Hd(e,s,r),r};let q=class extends A{constructor(){super(...arguments),this.kind="confirm",this.heading="",this.message="",this.value="",this.placeholder="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.danger=!1,this.loading=!1,this.confirmDisabled=!1,this.error=null,this._handleDocKeyDown=t=>{t.key==="Escape"&&q._stack[q._stack.length-1]===this&&(t.preventDefault(),this._cancel())}}connectedCallback(){super.connectedCallback(),q._stack.push(this),document.addEventListener("keydown",this._handleDocKeyDown),requestAnimationFrame(()=>{var t,e;(t=this._input)==null||t.focus(),(e=this._input)==null||e.select()})}disconnectedCallback(){document.removeEventListener("keydown",this._handleDocKeyDown),q._stack=q._stack.filter(t=>t!==this),super.disconnectedCallback()}get inputValue(){var t;return(((t=this._input)==null?void 0:t.value)??this.value).trim()}_onInput(t){this.dispatchEvent(new CustomEvent("sfx-dialog-input",{detail:{value:t.target.value},bubbles:!0,composed:!0}))}_confirm(){this.loading||this.confirmDisabled||this.dispatchEvent(new CustomEvent("sfx-dialog-confirm",{detail:{value:this.kind==="prompt"?this.inputValue:""},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("sfx-dialog-cancel",{bubbles:!0,composed:!0}))}_onBackdrop(t){t.target===t.currentTarget&&this._cancel()}_onInputKeyDown(t){t.key==="Enter"&&(t.preventDefault(),this._confirm())}render(){return c`
    ...
    `];q._stack=[];Te([f()],q.prototype,"kind",2);Te([f()],q.prototype,"heading",2);Te([f()],q.prototype,"message",2);Te([f()],q.prototype,"value",2);Te([f()],q.prototype,"placeholder",2);Te([f()],q.prototype,"confirmLabel",2);Te([f()],q.prototype,"cancelLabel",2);Te([f({type:Boolean})],q.prototype,"danger",2);Te([f({type:Boolean})],q.prototype,"loading",2);Te([f({type:Boolean})],q.prototype,"confirmDisabled",2);Te([f()],q.prototype,"error",2);Te([vt("input")],q.prototype,"_input",2);q=Te([T("sfx-dialog")],q);var Gd=Object.defineProperty,Yd=Object.getOwnPropertyDescriptor,Ut=(t,e,s,i)=>{for(var r=i>1?void 0:i?Yd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Gd(e,s,r),r};function ms(t){const e=new Date(t);return e.setHours(0,0,0,0),e}function oo(t,e){return t.getFullYear()===e.getFullYear()&&t.getMonth()===e.getMonth()&&t.getDate()===e.getDate()}let rt=class extends A{constructor(){super(...arguments),this.value=null,this.minDate=null,this.maxDate=null,this.locale="",this._viewYear=0,this._viewMonth=0,this._viewInitialized=!1}willUpdate(){if(!this._viewInitialized){this._viewInitialized=!0;const t=this.value??new Date;this._viewYear=t.getFullYear(),this._viewMonth=t.getMonth()}}get _locale(){return this.locale||document.documentElement.lang||"en"}get _monthOptions(){const t=new Intl.DateTimeFormat(this._locale,{month:"long"});return Array.from({length:12},(e,s)=>({value:String(s),label:t.format(new Date(2e3,s,1))}))}get _yearOptions(){var s,i;const t=((s=this.minDate)==null?void 0:s.getFullYear())??this._viewYear-10,e=((i=this.maxDate)==null?void 0:i.getFullYear())??this._viewYear+10;return Array.from({length:e-t+1},(r,o)=>{const a=t+o;return{value:String(a),label:String(a)}})}get _weekdayLabels(){const t=new Intl.DateTimeFormat(this._locale,{weekday:"short"});return Array.from({length:7},(e,s)=>{const i=t.format(new Date(2e3,0,3+s)).slice(0,2);return i.charAt(0).toUpperCase()+i.slice(1)})}get _days(){const e=(new Date(this._viewYear,this._viewMonth,1).getDay()+6)%7,s=new Date(this._viewYear,this._viewMonth,1-e);return Array.from({length:42},(i,r)=>{const o=new Date(s.getFullYear(),s.getMonth(),s.getDate()+r);return{date:o,outside:o.getMonth()!==this._viewMonth}})}_isDisabled(t){return!!(this.minDate&&ms(t)<ms(this.minDate)||this.maxDate&&ms(t)>ms(this.maxDate))}_prevMonth(){this._viewMonth===0?(this._viewMonth=11,this._viewYear-=1):this._viewMonth-=1}_nextMonth(){this._viewMonth===11?(this._viewMonth=0,this._viewYear+=1):this._viewMonth+=1}_selectDay(t){this._isDisabled(t)||this.dispatchEvent(new CustomEvent("sfx-select",{detail:{date:t},bubbles:!0,composed:!0}))}render(){const t=ms(new Date);return c`
      ...
      <div class="days">
        ${this._days.map(({date:e,outside:s})=>{const i=this._isDisabled(e),r=oo(e,t),o=this.value?oo(e,this.value):!1,a=["day",s&&"outside",r&&"today",o&&"selected"].filter(Boolean).join(" ");return c`
    ...
    `];Ut([f({attribute:!1})],rt.prototype,"value",2);Ut([f({attribute:!1})],rt.prototype,"minDate",2);Ut([f({attribute:!1})],rt.prototype,"maxDate",2);Ut([f()],rt.prototype,"locale",2);Ut([_()],rt.prototype,"_viewYear",2);Ut([_()],rt.prototype,"_viewMonth",2);rt=Ut([T("sfx-calendar")],rt);var Qd=Object.defineProperty,Wd=Object.getOwnPropertyDescriptor,ye=(t,e,s,i)=>{for(var r=i>1?void 0:i?Wd(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&Qd(e,s,r),r};function vs(t){if(!t)return null;const[e,s,i]=t.split("-").map(Number);return!e||!s||!i?null:new Date(e,s-1,i)}function ao(t){const e=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),i=String(t.getDate()).padStart(2,"0");return`${e}-${s}-${i}`}function Xd(t){return new Intl.DateTimeFormat(t,{year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(new Date(2e3,0,1)).map(e=>e.type).filter(e=>e==="month"||e==="day"||e==="year")}function no(t){return new Intl.DateTimeFormat(t,{year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(new Date(2e3,0,1)).map(e=>{switch(e.type){case"month":return"MM";case"day":return"DD";case"year":return"YYYY";default:return e.value}}).join("")}function Jd(t,e){const s=t.split(/[^0-9]+/).filter(Boolean);if(s.length!==3)return null;const i=Xd(e),r={};for(const[d,p]of i.entries()){const u=s[d];if(p==="year"?u.length!==4:u.length>2)return null;r[p]=Number(u)}const{month:o,day:a,year:n}=r;if(!o||!a||!n||o<1||o>12||a<1||a>31)return null;const l=new Date(n,o-1,a);return l.getFullYear()!==n||l.getMonth()!==o-1||l.getDate()!==a?null:l}let oe=class extends A{constructor(){super(...arguments),this.value="",this.min="",this.max="",this.placeholder="",this.disabled=!1,this.locale="",this._draft="",this._error="",this._open=!1,this._popoverTop=0,this._popoverBottom=0,this._popoverLeft=0,this._popoverPosition="below",this._openCalendar=()=>{this.disabled||this._open||(this._open=!0,this._updatePopoverPosition(),document.addEventListener("click",this._handleOutsideClick),document.addEventListener("keydown",this._handleKeyDown))},this._toggleCalendar=()=>{this.disabled||(this._open?(this._open=!1,this._cleanupListeners()):this._openCalendar())},this._handleOutsideClick=t=>{this._open&&!t.composedPath().includes(this)&&(this._open=!1,this._cleanupListeners())},this._handleKeyDown=t=>{t.key==="Escape"&&this._open&&(t.preventDefault(),t.stopPropagation(),this._open=!1,this._cleanupListeners())}}get _effectiveLocale(){return this.locale||document.documentElement.lang||"en"}get _selectedDate(){return vs(this.value)}get _displayText(){const t=this._selectedDate;return t?new Intl.DateTimeFormat(this._effectiveLocale).format(t):""}willUpdate(t){var e,s;t.has("value")&&((s=(e=this.shadowRoot)==null?void 0:e.activeElement)==null?void 0:s.tagName)!=="INPUT"&&(this._draft=this._displayText,this._error="")}render(){const t=this._selectedDate;return c`
      <div
  ...
  `;Qe([f({type:Array})],Pe.prototype,"selectedAssets",2);Qe([f({type:Array})],Pe.prototype,"selectedFolders",2);Qe([f({type:Number})],Pe.prototype,"totalCount",2);Qe([f({type:Number})],Pe.prototype,"totalFolderCount",2);Qe([f({type:Boolean})],Pe.prototype,"isSelectingAll",2);Qe([f({type:Boolean})],Pe.prototype,"multiSelect",2);Qe([f({type:Number})],Pe.prototype,"maxSelections",2);Qe([f({type:Boolean})],Pe.prototype,"showTransform",2);Qe([f({attribute:!1})],Pe.prototype,"t",2);Pe=Qe([T("ap-selection-bar")],Pe);var th=Object.defineProperty,sh=Object.getOwnPropertyDescriptor,fr=(t,e,s,i)=>{for(var r=i>1?void 0:i?sh(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&th(e,s,r),r};let js=class extends A{constructor(){super(...arguments),this.active=!1,this.rect={x:0,y:0,width:0,height:0}}render(){return!this.active||this.rect.width<5||this.rect.height<5?m:c`
      <div
        class="marquee"
  ...
  `;fr([f({type:Boolean})],js.prototype,"active",2);fr([f({type:Object})],js.prototype,"rect",2);js=fr([T("ap-marquee-overlay")],js);var ih=Object.defineProperty,rh=Object.getOwnPropertyDescriptor,qs=(t,e,s,i)=>{for(var r=i>1?void 0:i?rh(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&ih(e,s,r),r};let Mt=class extends A{constructor(){super(...arguments),this.folders=[],this.loading=!1,this.t=(t,e)=>typeof e=="string"?e:t,this._mode="recursive"}_handleConfirm(){this.dispatchEvent(new CustomEvent("folder-resolve-confirm",{detail:{mode:this._mode},bubbles:!0,composed:!0}))}_handleCancel(){this.dispatchEvent(new CustomEvent("folder-resolve-cancel",{bubbles:!0,composed:!0}))}_handleModeChange(t){this._mode=t.detail.value}render(){const t=this.folders.length;return c`
      <div
        class="backdrop"
    ...
    `];De([f({type:Array})],_e.prototype,"assets",2);De([f({type:Boolean})],_e.prototype,"isMultiSelect",2);De([f({attribute:!1})],_e.prototype,"t",2);De([f({attribute:!1})],_e.prototype,"exportOriginalLabel",2);De([f({attribute:!1})],_e.prototype,"applyExportLabel",2);De([_()],_e.prototype,"_format",2);De([_()],_e.prototype,"_quality",2);De([_()],_e.prototype,"_width",2);De([_()],_e.prototype,"_height",2);De([_()],_e.prototype,"_lockAspect",2);De([_()],_e.prototype,"_activePreset",2);_e=De([T("ap-transformation-dialog")],_e);var ch=Object.defineProperty,dh=Object.getOwnPropertyDescriptor,$t=(t,e,s,i)=>{for(var r=i>1?void 0:i?dh(e,s):e,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&ch(e,s,r),r};const hh=/[/\\\x00-\x1f]/;let Ye=class extends A{constructor(){super(...arguments),this.t=(t,e)=>typeof e=="string"?e:t,this.currentFolderPath="/",this.loading=!1,this.error=null,this._name="",this._localError=null,this._apiErrorDismissed=!1}updated(t){t.has("error")&&this.error&&(this._apiErrorDismissed=!1)}_onInput(t){this._name=t.detail.value,this._localError&&(this._localError=null),this.error&&!this._apiErrorDismissed&&(this._apiErrorDismissed=!0)}_validateName(t){return hh.test(t)?this.t("folderNameInvalidChars",`Folder name can't contain "/" or "\\".`):t==="."||t===".."?this.t("folderNameReserved",`Folder name can't be "." or "..".`):null}_onConfirm(t){if(this.loading)return;const e=t.detail.value.trim();if(!e)return;const s=this._validateName(e);if(s){this._localError=s;return}this.dispatchEvent(new CustomEvent("create-folder-confirm",{detail:{name:e},bubbles:!0,composed:!0}))}_onCancel(){this.dispatchEvent(new CustomEvent("create-folder-cancel",{bubbles:!0,composed:!0}))}render(){const t=this._localError??(this._apiErrorDismissed?null:this.error);return c`
      <sfx-dialog
        kind="prompt"
  ...
  `;$t([f({attribute:!1})],Ye.prototype,"t",2);$t([f()],Ye.prototype,"currentFolderPath",2);$t([f({type:Boolean})],Ye.prototype,"loading",2);$t([f()],Ye.prototype,"error",2);$t([_()],Ye.prototype,"_name",2);$t([_()],Ye.prototype,"_localError",2);$t([_()],Ye.prototype,"_apiErrorDismissed",2);Ye=$t([T("ap-create-folder-dialog")],Ye);var ph=Object.defineProperty,wt=(t,e,s,i)=>{for(var r=void 0,o=t.length-1,a;o>=0;o--)(a=t[o])&&(r=a(e,s,r)||r);return r&&ph(e,s,r),r};const mr=class mr extends A{constructor(){super(),this._initFailed=!1,this._loadId=0,this._loadMoreId=0,this._selectAllId=0,this._loadDataTimer=null,this._pendingFilter=null,this._pendingMetadataField=null,this._normalizedForcedFilters={},this._uploaderEl=null,this._uploaderImportPromise=null,this._dragCounter=0,this._isDragOver=!1,this._isUploaderOpen=!1,this._folderResolveOpen=!1,this._transformOpen=!1,this._createFolderOpen=!1,this._isCreatingFolder=!1,this._createFolderError=null,this._transformAssets=[],this._transformFolders=[],this._transformAfterResolve=!1,this._onDragEnter=e=>{var s;!((s=this.config)!=null&&s.uploader)||!this._hasFileTransfer(e)||(e.preventDefault(),this._dragCounter++,this._dragCounter===1&&(this._isDragOver=!0))},this._onDragOver=e=>{var s;!((s=this.config)!=null&&s.uploader)||!this._hasFileTransfer(e)||(e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="copy"))},this._onDragLeave=e=>{var s;!((s=this.config)!=null&&s.uploader)||!this._hasFileTransfer(e)||(e.preventDefault(),this._dragCounter--,this._dragCounter<=0&&(this._dragCounter=0,this._isDragOver=!1))},this._onDrop=e=>{var i,r;if(!((i=this.config)!=null&&i.uploader)||!this._hasFileTransfer(e))return;e.preventDefault(),this._dragCounter=0,this._isDragOver=!1;const s=Array.from(((r=e.dataTransfer)==null?void 0:r.files)??[]);s.length>0&&this._openUploader(s)},this._cancelCreateFolderRequested=!1,this.store=$a(),this.storeCtrl=new pn(this,this.store),this.selectionCtrl=new fn(this,this.store),this.infiniteScrollCtrl=new gn(this,()=>this._loadMore()),this.marqueeCtrl=new Yi(this,{queryCards:e=>{const s=[],i=(o,a,n)=>o.querySelectorAll(`[${a}]`).forEach(l=>{const d=l.dataset[n];d&&s.push({uuid:d,el:l})});let r=!1;for(const o of Array.from(e.children))o.shadowRoot&&(i(o.shadowRoot,"data-asset-uuid","assetUuid"),i(o.shadowRoot,"data-folder-uuid","folderUuid"),r=!0);return(!r||s.length===0)&&(i(e,"data-asset-uuid","assetUuid"),i(e,"data-folder-uuid","folderUuid")),s},getSelection:()=>{const e=this.store.getState();return[...e.selectedAssets.keys(),...e.selectedFolders.keys()]},setSelection:e=>{var d,p;const s=this.store.getState(),i=((d=s.config)==null?void 0:d.folderSelection)===!0,r=new Map,o=new Map;for(const u of e){const h=s.selectedAssets.get(u);if(h){r.set(u,h);continue}const g=s.selectedFolders.get(u);if(i&&g){o.set(u,g);continue}if(!s.disabledAssetIds.has(u)){const v=s.assets.find(y=>y.uuid===u);if(v){r.set(u,v);continue}}if(i&&!s.disabledFolderIds.has(u)){const v=s.folders.find(y=>y.uuid===u);v&&o.set(u,v)}}const a=(p=s.config)==null?void 0:p.maxSelections,n=r.size+(i?o.size:0),l=a&&n>a?new Map(Array.from(r.entries()).slice(0,Math.max(0,a-o.size))):r;this.store.setState({selectedAssets:l,...i?{selectedFolders:o}:{}})},isInteractiveTarget:e=>{var s;return(((s=this.store.getState().config)==null?void 0:s.multiSelect)??!0)===!1?!0:e.composedPath().some(i=>{if(!(i instanceof HTMLElement))return!1;if(i instanceof HTMLButtonElement||i instanceof HTMLInputElement)return!0;const r=i.tagName.toLowerCase();return r.startsWith("ap-asset-")||r.startsWith("ap-folder-")?!0:i.classList.contains("check")||i.classList.contains("check-box")})}})}get _isInline(){var e;return((e=this.config)==null?void 0:e.displayMode)==="inline"}disconnectedCallback(){super.disconnectedCallback(),this._uploaderEl&&(this._uploaderEl.remove(),this._uploaderEl=null),this._uploaderImportPromise=null,this._dragCounter=0,this._isDragOver=!1,this._isUploaderOpen=!1}updated(e){super.updated(e),e.has("config")&&this.config&&this._initConfig(this.config);const s=this.renderRoot.querySelector("#sentinel");if(s&&s!==this._lastSentinel){this._lastSentinel=s;const r=this.renderRoot.querySelector(".main-content");this.infiniteScrollCtrl.observe(s,r)}const i=this.renderRoot.querySelector(".main-content");i&&i!==this._lastMarqueeContainer&&(this._lastMarqueeContainer=i,this.marqueeCtrl.attach(i))}_computeAuthKey(e){return JSON.stringify({auth:e.auth,apiBase:e.apiBase})}_initConfig(e){const s={folderSelection:!0,...e};this._applyConfig(s);const i=this._computeAuthKey(s);(!this._initPromise||i!==this._lastAuthKey||this._initFailed)&&(this._lastAuthKey=i,this._initFailed=!1,this._initPromise=this._fetchBootstrapData(s).catch(()=>{this._initFailed=!0})),this._initI18n(s.locale),this.toggleAttribute("inline",s.displayMode==="inline"),s.displayMode==="inline"&&!this.store.getState().isOpen&&this.open()}_applyConfig(e){const s=zl(),i=s.sortBy??e.defaultSortBy??"created_at",r=s.sortDirection??e.defaultSortDirection??"desc";this.store.setState({config:e,projectToken:e.auth.projectToken,viewMode:e.rememberLastView&&Ul(e.auth.projectToken)||e.defaultViewMode||"grid",sortBy:i,sortDirection:r,disabledAssetIds:new Set(e.disabledAssetIds??[]),disabledFolderIds:new Set(e.disabledFolderIds??[])}),Xn(e.transformRemoteThumbnail),this._normalizedForcedFilters=Ki(e.forcedFilters)}async _initI18n(e){try{const{i18n:s,isNew:i}=await dn(e||"en");i&&s.on("missingKey",(o,a,n,l,d,p)=>{const u=n.match(/_(?:zero|one|two|few|many|other)$/),h=u&&(p!=null&&p[`defaultValue${u[0]}`])?String(p[`defaultValue${u[0]}`]):l;hn.handleMissingKey(n,h,a)});const r=(o,a,n)=>typeof a=="string"?s.t(o,a,n??{}):s.t(o,a??{});this.store.setState({t:r})}catch{}}async _fetchBootstrapData(e){const s=e.apiBase||`https://api.filerobot.com/${e.auth.projectToken}/v5`;let i;if(e.auth.mode==="securityTemplate"){const{key:r,permissions:o}=await zn(e.auth,s);i=r,this.store.setState({sassKey:r,permissions:o})}else i=e.auth.sassKey;this.apiClient=new Qi({apiBase:s.replace(/\/v5$/,""),headers:{"X-Filerobot-Key":i}});try{const[r,o,a,n,l]=await Promise.allSettled([ml(this.apiClient),An(this.apiClient),Mn(this.apiClient),fl(this.apiClient),In(this.apiClient)]),d={};if(r.status==="fulfilled"){const{fields:v,regionalVariantGroups:y,regionalFilters:x,brandColor:$,cdnPermalinkEnabled:k}=r.value;d.metadataFields=v,d.regionalVariantGroups=y,d.regionalFilters=x,d.cdnPermalinkEnabled=k,$&&(d.brandColor=$)}o.status==="fulfilled"&&(d.labels=o.value||[]),a.status==="fulfilled"&&(d.tags=a.value),l.status==="fulfilled"&&(d.collections=l.value.collections||[]),n.status==="fulfilled"&&(d.fileTypes=n.value);const{pinnedFilters:p,pinnedMetadata:u}=Dl(e.auth.projectToken??null),h=this.store.getState().filters;d.filters={...h,pinned:p,visible:[...p],metadata:{...h.metadata,pinned:u,visible:[...u]}},this.store.setState(d);const g=e.brandColor||d.brandColor||this.store.getState().brandColor;g&&(d.brandColor||this.store.setState({brandColor:g}),Gl(this,g))}catch(r){throw this.dispatchEvent(new CustomEvent("ap-error",{detail:{error:r,context:"init"},bubbles:!0,composed:!0})),r}}_ensureUploaderImport(){return customElements.get("sfx-uploader")?Promise.resolve():this._uploaderImportPromise?this._uploaderImportPromise:(this._uploaderImportPromise=K(()=>import("./define-DzXRo4G6.js").then(e=>e.aH),[]).then(()=>{},e=>{throw this._uploaderImportPromise=null,e}),this._uploaderImportPromise)}_buildUploaderConfig(){const e=this.config,s=e.uploader,i=this.store.getState();let r;return e.auth.mode==="securityTemplate"?r={mode:"security-template",container:e.auth.projectToken,securityTemplateId:e.auth.securityTemplateKey}:r={mode:"sass-key",container:e.auth.projectToken,sassKey:e.auth.sassKey},{auth:r,targetFolder:i.currentFolderPath||"/",mode:"inline",restrictions:s.restrictions,concurrency:s.concurrency,autoProceed:s.autoProceed,showFillMetadata:s.showFillMetadata,connectors:s.connectors,sourcesLayout:s.sourcesLayout,header:s.header??"back",clearOnClose:s.clearOnClose,clearOnComplete:s.clearOnComplete,closeOnComplete:s.closeOnComplete,rejectedFileAutoRemoveDelay:s.rejectedFileAutoRemoveDelay,lastUploadReview:s.lastUploadReview,showLocateButton:s.showLocateButton,showCopyCdnButton:s.showCopyCdnButton,getLocateUrl:s.getLocateUrl,minimizeOnUpload:s.minimizeOnUpload,metadataConfig:s.metadataConfig,tusConfig:s.tusConfig,locale:s.locale??e.locale,transformRemoteThumbnail:e.transformRemoteThumbnail}}async _openUploader(e){var i;if(!((i=this.config)!=null&&i.uploader)||this._isUploaderOpen)return;try{await this._ensureUploaderImport()}catch(r){this.dispatchEvent(new CustomEvent("ap-error",{detail:{error:r instanceof Error?r:new Error(String(r)),context:"uploader-load"},bubbles:!0,composed:!0}));return}this._uploaderEl=document.createElement("sfx-uploader");const s=this._uploaderEl;s.addEventListener("sfx-all-complete",()=>{this.store.getState().isOpen&&this._loadData()}),s.addEventListener("sfx-complete-action",()=>{this._closeUploader()}),s.addEventListener("sfx-cancel",()=>{this._closeUploader()}),this._isUploaderOpen=!0,await this.updateComplete,s.config=this._buildUploaderConfig(),await s.updateComplete,e!=null&&e.length&&s.addFiles(e)}_closeUploader(){this._isUploaderOpen=!1,this._uploaderEl&&(this._uploaderEl.remove(),this._uploaderEl=null)}_handleUploadClick(){this._openUploader()}_hasFileTransfer(e){var s,i;return!!((i=(s=e.dataTransfer)==null?void 0:s.types)!=null&&i.includes("Files"))}async open(){var d,p,u,h,g,v,y,x;const e=this.store.getState(),s=new Set(Object.keys(this._normalizedForcedFilters)),i={},r=Ki((d=this.config)==null?void 0:d.defaultFilters);for(const[$,k]of Object.entries(r))s.has($)||(i[$]=k);const o=Object.keys(i),a=((p=this.config)==null?void 0:p.tabs)??["assets","folders"],n=(u=this.config)!=null&&u.rememberLastTab?Bl(this.config.auth.projectToken):null,l=(n&&a.includes(n)?n:null)??((h=this.config)!=null&&h.defaultTab&&a.includes(this.config.defaultTab)?this.config.defaultTab:null)??((g=this.config)!=null&&g.initialFolderPath&&a.includes("folders")?"folders":null)??a[0]??"assets";this.store.setState({isOpen:!0,activeTab:l,searchQuery:"",isAISearchActive:!!((v=this.config)!=null&&v.enableAISearch&&((y=this.config)!=null&&y.defaultAISearch)),filters:{metadata:{pinned:e.filters.metadata.pinned,visible:[...e.filters.metadata.pinned],applied:{}},pinned:e.filters.pinned,visible:[...new Set([...e.filters.pinned,...o])],applied:i},offset:0,assets:[],folders:[],currentFolder:null,currentFolderPath:this._resolveInitialFolderPath(l),activeLabelUuid:null,activeCollectionUuid:null,activeCollectionFolders:[],activeCollectionFolder:null,isLoadingCollectionFolders:!1,breadcrumb:this._buildBreadcrumbFromPath(this._resolveInitialFolderPath(l),((x=this.config)==null?void 0:x.rootFolderPath)||"/"),selectedAssets:new Map,selectedFolders:new Map,isResolvingFolders:!1,folderPreviews:{},isPreviewOpen:!1,previewAsset:null,isLoading:!0,isSelectingAll:!1}),this._dragCounter=0,this._isDragOver=!1,this.dispatchEvent(new CustomEvent("ap-open",{detail:{timestamp:Date.now()},bubbles:!0,composed:!0})),await this.updateComplete,!this._initPromise&&this.config&&this._initConfig(this.config),!(this._initPromise&&(await this._initPromise,this._initFailed))&&this._loadData()}close(){this.store.setState({isOpen:!1}),this._dragCounter=0,this._isDragOver=!1,this._isUploaderOpen=!1,this._folderResolveOpen=!1,this._transformOpen=!1,this._transformAssets=[],this._transformFolders=[],this._transformAfterResolve=!1,this._selectAllId++}_scrollToTop(){var e;(e=this.renderRoot.querySelector(".main-content"))==null||e.scrollTo({top:0})}async _loadData(){var i,r,o,a,n,l,d,p,u,h,g,v,y,x,$,k,L,O,E,z,S,V,N,F,Q,fe,Y,ge,me,Ke,nt,W,$e,Me,lt,os,as,ns,ls,cs,ds,hs,ps;if(!this.apiClient)return;const e=++this._loadId,s=this.store.getState();this._scrollToTop(),this.store.setState({isLoading:!0});try{const We=s.activeTab;if(We==="assets"){const ve=this._buildSearchNotation(),ct=s.currentFolderPath||"/",Re=s.isAISearchActive&&!!s.searchQuery,Le=St(this.apiClient,{fields:(i=this.config)==null?void 0:i.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,folder:ct,offset:0,limit:s.limit,sort_by:s.sortBy,sort_direction:s.sortDirection,search:s.searchQuery||void 0,q:ve||void 0,recursive:1,...Re&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((r=s.config)==null?void 0:r.locale)??"en"}}),be=Qs(this.apiClient,{folder:ct,q:ve||void 0,search:s.searchQuery||void 0,recursive:1,...Re&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((o=s.config)==null?void 0:o.locale)??"en"}}).catch(()=>null),[ce,we]=await Promise.all([Le,be]);if(e!==this._loadId)return;const ke=((a=ce.files)==null?void 0:a.length)??0,re=ke>=s.limit,Se=((n=we==null?void 0:we.stats)==null?void 0:n.approx_files_count)??((l=we==null?void 0:we.info)==null?void 0:l.total_files_count)??((d=ce.info)==null?void 0:d.total_files_count)??((u=(p=ce.base)==null?void 0:p.count)==null?void 0:u.files_recursive)??((g=(h=ce.base)==null?void 0:h.count)==null?void 0:g.files_direct)??ke;this.store.setState({assets:ce.files||[],folders:[],totalCount:Se,totalFolderCount:0,offset:0,hasMore:re,isLoading:!1})}else if(We==="folders"){const ve=this._buildSearchNotation(),ct=s.currentFolderPath||"/",[Re,Le,be]=await Promise.all([Tn(this.apiClient,{folderPath:s.currentFolderPath,q:s.searchQuery||void 0,recursive:s.searchQuery?1:0,sort_by:s.sortBy,sort_direction:s.sortDirection}),St(this.apiClient,{fields:(v=this.config)==null?void 0:v.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,folder:ct,offset:0,limit:s.limit,sort_by:s.sortBy,sort_direction:s.sortDirection,search:s.searchQuery||void 0,q:ve||void 0,recursive:0,...s.isAISearchActive&&s.searchQuery&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((y=s.config)==null?void 0:y.locale)??"en"}}),Qs(this.apiClient,{folder:ct,q:ve||void 0,search:s.searchQuery||void 0,recursive:0,...s.isAISearchActive&&s.searchQuery&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((x=s.config)==null?void 0:x.locale)??"en"}}).catch(()=>null)]);if(e!==this._loadId)return;const ce=Re.folders||[];let we={};if(ce.length>0)try{we=await Ln(this.apiClient,ce.map(Kt=>Kt.uuid))}catch{}if(e!==this._loadId)return;const ke=(($=Le.files)==null?void 0:$.length)??0,re=ke>=s.limit,Se=((k=be==null?void 0:be.stats)==null?void 0:k.approx_files_count)??((L=be==null?void 0:be.info)==null?void 0:L.total_files_count)??((O=Le.info)==null?void 0:O.total_files_count)??((z=(E=Le.base)==null?void 0:E.count)==null?void 0:z.files_direct)??ke;this.store.setState({assets:Le.files||[],folders:ce,folderPreviews:we,totalCount:Se,totalFolderCount:Re.total??ce.length,offset:0,hasMore:re,isLoading:!1})}else if(We==="labels"){if(!s.activeLabelUuid){this.store.setState({assets:[],folders:[],totalCount:s.labels.length,totalFolderCount:0,offset:0,hasMore:!1,isLoading:!1});return}const ve=s.labels.find($i=>$i.uuid===s.activeLabelUuid);if(!ve){this.store.setState({isLoading:!1});return}const ct=ve.sid.replace("#",""),Re=this._buildSearchNotation(),Le=`labels:${ct}${Re?" "+Re:""}`,be=s.isAISearchActive&&!!s.searchQuery,ce=St(this.apiClient,{fields:(S=this.config)==null?void 0:S.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,folder:"/",offset:0,limit:s.limit,sort_by:s.sortBy,sort_direction:s.sortDirection,search:s.searchQuery||void 0,q:Le,recursive:1,...be&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((V=s.config)==null?void 0:V.locale)??"en"}}),we=Qs(this.apiClient,{folder:"/",q:Le,search:s.searchQuery||void 0,recursive:1,...be&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((N=s.config)==null?void 0:N.locale)??"en"}}).catch(()=>null),[ke,re]=await Promise.all([ce,we]);if(e!==this._loadId)return;const Se=((F=ke.files)==null?void 0:F.length)??0,Kt=Se>=s.limit,yi=((Q=re==null?void 0:re.stats)==null?void 0:Q.approx_files_count)??((fe=re==null?void 0:re.info)==null?void 0:fe.total_files_count)??((Y=ke.info)==null?void 0:Y.total_files_count)??((me=(ge=ke.base)==null?void 0:ge.count)==null?void 0:me.files_recursive)??((nt=(Ke=ke.base)==null?void 0:Ke.count)==null?void 0:nt.files_direct)??Se;this.store.setState({assets:ke.files||[],folders:[],totalCount:yi,totalFolderCount:0,offset:0,hasMore:Kt,isLoading:!1})}else if(We==="collections"){if(!s.activeCollectionUuid){this.store.setState({assets:[],folders:[],totalCount:0,totalFolderCount:0,offset:0,hasMore:!1,isLoading:!1});return}const ve=s.activeCollectionFolder;if(!(ve&&!((W=ve.children)!=null&&W.length))){this.store.setState({assets:[],folders:[],totalCount:0,totalFolderCount:0,offset:0,hasMore:!1,isLoading:!1});return}const Re=s.activeCollectionUuid,Le=ve.filters||void 0,be=this._buildSearchNotation(),ce=s.isAISearchActive&&!!s.searchQuery,we=St(this.apiClient,{fields:($e=this.config)==null?void 0:$e.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,offset:0,limit:s.limit,sort_by:s.sortBy,sort_direction:s.sortDirection,search:s.searchQuery||void 0,q:be||void 0,recursive:1,collection_uuid:Re,f64:Le,...ce&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((Me=s.config)==null?void 0:Me.locale)??"en"}}),ke=Qs(this.apiClient,{q:be||void 0,search:s.searchQuery||void 0,recursive:1,collection_uuid:Re,f64:Le,...ce&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((lt=s.config)==null?void 0:lt.locale)??"en"}}).catch(()=>null),[re,Se]=await Promise.all([we,ke]);if(e!==this._loadId)return;const Kt=((os=re.files)==null?void 0:os.length)??0,yi=Kt>=s.limit,$i=((as=Se==null?void 0:Se.stats)==null?void 0:as.approx_files_count)??((ns=Se==null?void 0:Se.info)==null?void 0:ns.total_files_count)??((ls=re.info)==null?void 0:ls.total_files_count)??((ds=(cs=re.base)==null?void 0:cs.count)==null?void 0:ds.files_recursive)??((ps=(hs=re.base)==null?void 0:hs.count)==null?void 0:ps.files_direct)??Kt;this.store.setState({assets:re.files||[],folders:[],totalCount:$i,totalFolderCount:0,offset:0,hasMore:yi,isLoading:!1})}}catch(We){if(e!==this._loadId)return;this.store.setState({isLoading:!1}),this.dispatchEvent(new CustomEvent("ap-error",{detail:{error:We,context:"loadData"},bubbles:!0,composed:!0}))}}async _loadMore(){var r,o,a;const e=this.store.getState();if(e.isLoading||!e.hasMore||!this.apiClient||e.activeTab==="labels"&&!e.activeLabelUuid||e.activeTab==="collections"&&!(e.activeCollectionFolder&&!((r=e.activeCollectionFolder.children)!=null&&r.length)))return;const s=++this._loadMoreId,i=e.offset+e.limit;this.store.setState({isLoading:!0});try{const n=this._buildSearchNotation();let l=n||void 0,d=e.currentFolderPath||"/",p=e.activeTab==="folders"?0:1;if(e.activeTab==="labels"&&e.activeLabelUuid){const k=e.labels.find(L=>L.uuid===e.activeLabelUuid);k&&(l=`labels:${k.sid.replace("#","")}${n?" "+n:""}`),d="/",p=1}let u,h;e.activeTab==="collections"&&e.activeCollectionFolder&&(u=e.activeCollectionUuid||void 0,h=e.activeCollectionFolder.filters||void 0,d="",p=1);const g=await St(this.apiClient,{fields:(o=this.config)==null?void 0:o.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,...d?{folder:d}:{},offset:i,limit:e.limit,sort_by:e.sortBy,sort_direction:e.sortDirection,search:e.searchQuery||void 0,q:l,recursive:p,...u&&{collection_uuid:u},...h&&{f64:h},...e.isAISearchActive&&e.searchQuery&&{with_ai:!0,ai_query:e.searchQuery,ai_lang:((a=e.config)==null?void 0:a.locale)??"en"}});if(s!==this._loadMoreId)return;const v=this.store.getState().assets,y=g.files||[],x=y.length>=e.limit,$=[...v,...y];this.store.setState({assets:$,offset:i,hasMore:x,isLoading:!1})}catch{if(s!==this._loadMoreId)return;this.store.setState({isLoading:!1})}}_debouncedLoadData(e=120){this._loadDataTimer&&clearTimeout(this._loadDataTimer),this._loadDataTimer=setTimeout(()=>{this._loadDataTimer=null,this._loadData()},e)}_handleCancel(e){var s,i;this.close(),(i=(s=this.config)==null?void 0:s.onCancel)==null||i.call(s),this.dispatchEvent(new CustomEvent("ap-cancel",{detail:{reason:e},bubbles:!0,composed:!0}))}_handleSearchChange(e){var r;const s=this.store.getState();if(s.activeTab==="labels"&&!s.activeLabelUuid){this.store.setState({searchQuery:e.detail.value});return}if(s.activeTab==="collections"&&!(s.activeCollectionFolder&&!((r=s.activeCollectionFolder.children)!=null&&r.length))){this.store.setState({searchQuery:e.detail.value});return}const i={searchQuery:e.detail.value,offset:0,assets:[],folders:[],isLoading:!0};s.isAISearchActive&&e.detail.value&&(i.sortBy="relevance"),this.store.setState(i),this.selectionCtrl.resetRange(),this._debouncedLoadData()}_handleAISearchToggle(e){var o;const s=e.detail.active,i=this.store.getState(),r={isAISearchActive:s};i.searchQuery&&(s?r.sortBy="relevance":i.sortBy==="relevance"&&(r.sortBy=((o=this.config)==null?void 0:o.defaultSortBy)??"created_at"),r.offset=0,r.assets=[],r.folders=[],r.isLoading=!0),this.store.setState(r),i.searchQuery&&this._debouncedLoadData()}_handleViewChange(e){var i;const s=e.detail.mode;this.store.setState({viewMode:s}),(i=this.config)!=null&&i.rememberLastView&&jl(s,this.config.auth.projectToken),this._scrollToTop()}_handleRegionalChange(e){const{groupUuid:s,value:i}=e.detail,r=this.store.getState().regionalFilters;this.store.setState({regionalFilters:{...r,[s]:i}})}_handleSortChange(e){const s=e.detail.value,i=this.store.getState();this.store.setState({sortBy:s,offset:0,assets:[],folders:[]}),so(s,i.sortDirection),this.selectionCtrl.resetRange(),this._loadData()}_handleSortDirectionChange(e){const s=e.detail.value,i=this.store.getState();this.store.setState({sortDirection:s,offset:0,assets:[],folders:[]}),so(i.sortBy,s),this.selectionCtrl.resetRange(),this._loadData()}_handleTabChange(e){var i,r;const s=e.detail.tab;(i=this.config)!=null&&i.rememberLastTab&&Kl(s,this.config.auth.projectToken),this._selectAllId++,this.store.setState({activeTab:s,activeLabelUuid:null,activeCollectionUuid:null,activeCollectionFolders:[],activeCollectionFolder:null,isLoadingCollectionFolders:!1,currentFolder:null,currentFolderPath:((r=this.config)==null?void 0:r.rootFolderPath)??"/",breadcrumb:[],offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData()}_handleAssetSelect(e){this.selectionCtrl.handleSelect(e.detail.asset,e.detail.index,e.detail.event)}_handleFolderSelect(e){this.selectionCtrl.handleFolderSelect(e.detail.folder,e.detail.index,e.detail.event)}_handleAssetPreview(e){this.store.setState({previewAsset:e.detail.asset,isPreviewOpen:!0})}get _transformationsConfig(){var s;const e=(s=this.config)==null?void 0:s.transformations;return typeof e=="object"?e:void 0}_handleQuickSelect(e){var i;const s=e.detail.asset;if((i=this.config)!=null&&i.transformations&&Gt(s)){this._transformAssets=[s],this._transformFolders=[],this._transformOpen=!0;return}this._emitSelect([s])}_emitSelect(e,s){var r,o;const i={assets:e};s!=null&&s.length&&(i.folders=s),(o=(r=this.config)==null?void 0:r.onSelect)==null||o.call(r,e,s!=null&&s.length?s:void 0),this.dispatchEvent(new CustomEvent("ap-select",{detail:i,bubbles:!0,composed:!0})),this._isInline||this.close()}_handleFolderOpen(e){var o;const s=e.detail.folder,i=this.store.getState(),r=s.path||`${i.currentFolderPath}${s.name}/`;(o=this.config)!=null&&o.rememberLastFolder&&io(r,this.config.auth.projectToken),this._selectAllId++,this.store.setState({currentFolder:s.uuid,currentFolderPath:r,breadcrumb:[...i.breadcrumb,{uuid:s.uuid,name:s.name,path:r}],searchQuery:"",offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData()}_handleBreadcrumbNavigate(e){var n,l;const s=e.detail.uuid,i=this.store.getState();if(i.activeTab==="labels"){this._selectAllId++,this.store.setState({activeLabelUuid:null,breadcrumb:[],searchQuery:"",offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData();return}if(i.activeTab==="collections"){if(this._selectAllId++,!s){this.store.setState({activeCollectionUuid:null,activeCollectionFolder:null,activeCollectionFolders:[],breadcrumb:[],searchQuery:"",offset:0,assets:[],folders:[],isLoading:!1}),this.selectionCtrl.resetRange();return}if(s===i.activeCollectionUuid){this.store.setState({activeCollectionFolder:null,breadcrumb:[i.breadcrumb[0]],searchQuery:"",offset:0,assets:[],folders:[],isLoading:!1}),this.selectionCtrl.resetRange();return}const d=this._findCollectionFolder(i.activeCollectionFolders,s);if(d){const p=i.breadcrumb.findIndex(h=>h.uuid===s),u=i.breadcrumb.slice(0,p+1);this.store.setState({activeCollectionFolder:d,breadcrumb:u,searchQuery:"",offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData()}return}const r=s?i.breadcrumb.findIndex(d=>d.uuid===s):-1,o=s?i.breadcrumb.slice(0,r+1):[],a=o.length>0?o[o.length-1].path:((n=this.config)==null?void 0:n.rootFolderPath)||"/";(l=this.config)!=null&&l.rememberLastFolder&&io(a,this.config.auth.projectToken),this._selectAllId++,this.store.setState({currentFolder:s||null,currentFolderPath:a,breadcrumb:o,offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData()}_handleLabelOpen(e){const s=e.detail.label;this._selectAllId++,this.store.setState({activeLabelUuid:s.uuid,breadcrumb:[{uuid:s.uuid,name:s.name,path:""}],searchQuery:"",offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData()}async _handleCollectionOpen(e){const s=e.detail.collection;if(this.apiClient){this._selectAllId++,this.store.setState({activeCollectionUuid:s.uuid,activeCollectionFolder:null,activeCollectionFolders:[],isLoadingCollectionFolders:!0,breadcrumb:[{uuid:s.uuid,name:s.title,path:""}],searchQuery:"",offset:0,assets:[],folders:[],isLoading:!0}),this.selectionCtrl.resetRange();try{const i=await Dn(this.apiClient,s.uuid),r=Fo(i.folders||[]);this.store.setState({activeCollectionFolders:r,isLoadingCollectionFolders:!1,isLoading:!1})}catch(i){this.store.setState({isLoadingCollectionFolders:!1,isLoading:!1}),this.dispatchEvent(new CustomEvent("ap-error",{detail:{error:i,context:"loadCollectionFolders"},bubbles:!0,composed:!0}))}}}_handleCollectionFolderOpen(e){var n;const s=e.detail.folder,i=this.store.getState(),r=s.path.split(" -> ").filter(Boolean),o=[{uuid:i.activeCollectionUuid,name:((n=i.breadcrumb[0])==null?void 0:n.name)||"Collection",path:""}];let a="";for(const l of r)a=a?`${a} -> ${l}`:l,o.push({uuid:a,name:l,path:a});this._selectAllId++,this.store.setState({activeCollectionFolder:s,breadcrumb:o,searchQuery:"",offset:0,assets:[],folders:[]}),this.selectionCtrl.resetRange(),this._loadData()}_findCollectionFolder(e,s){for(const i of e){if(i.path===s)return i;if(i.children){const r=this._findCollectionFolder(i.children,s);if(r)return r}}return null}_getVisibleCollectionFolders(){const e=this.store.getState();return e.activeCollectionUuid?e.activeCollectionFolder?e.activeCollectionFolder.children??[]:e.activeCollectionFolders:[]}_resolveInitialFolderPath(e){var s,i,r;return e==="folders"&&((s=this.config)==null?void 0:s.rememberLastFolder)&&Nl(this.config.auth.projectToken)||((i=this.config)==null?void 0:i.initialFolderPath)||((r=this.config)==null?void 0:r.rootFolderPath)||"/"}_buildBreadcrumbFromPath(e,s){if(!e||e===s||e==="/")return[];const r=(e.startsWith(s)?e.slice(s.length):e.replace(/^\//,"")).split("/").filter(Boolean),o=[];let a=s.endsWith("/")?s:s+"/";for(const n of r)a+=n+"/",o.push({uuid:a,name:n,path:a});return o}_handlePreviewClose(){this.store.setState({isPreviewOpen:!1,previewAsset:null})}_handlePreviewNavigate(e){this.store.setState({previewAsset:e.detail.asset})}_handleSelectionConfirm(e){var r,o;const s=e.detail.assets,i=e.detail.folders||[];if(i.length>0&&((r=this.config)==null?void 0:r.folderSelection)!==!1&&((o=this.config)==null?void 0:o.folderSelectionMode)==="assets"){this._folderResolveOpen=!0;return}this._emitSelect(s,i.length?i:void 0)}_handleSelectionTransform(e){var o,a;const s=e.detail.assets,i=e.detail.folders||[];if(i.length>0&&((o=this.config)==null?void 0:o.folderSelection)!==!1&&((a=this.config)==null?void 0:a.folderSelectionMode)==="assets"){this._transformAfterResolve=!0,this._folderResolveOpen=!0;return}if(s.filter(Gt).length===0){this._emitSelect(s,i.length?i:void 0);return}this._transformAssets=s,this._transformFolders=i,this._transformOpen=!0}async _handleFolderResolveConfirm(e){var o;const s=e.detail.mode,i=this.selectionCtrl.getSelectedFolders(),r=this.selectionCtrl.getSelectedAssets();this.store.setState({isResolvingFolders:!0});try{const a=await Promise.all(i.map(h=>{var g;return St(this.apiClient,{fields:(g=this.config)==null?void 0:g.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,folder:h.path,recursive:s==="recursive"?1:0,limit:1e4})})),n=[];for(const h of a)n.push(...h.files);const l=[...r],d=new Set(l.map(h=>h.uuid));for(const h of n)d.has(h.uuid)||(l.push(h),d.add(h.uuid));const p=(o=this.config)==null?void 0:o.maxSelections,u=p?l.slice(0,p):l;if(this._folderResolveOpen=!1,this.store.setState({isResolvingFolders:!1}),this._transformAfterResolve){this._transformAfterResolve=!1,this._transformAssets=u,this._transformFolders=[],this._transformOpen=!0;return}this._emitSelect(u)}catch(a){this.store.setState({isResolvingFolders:!1}),this.dispatchEvent(new CustomEvent("ap-error",{detail:{error:a,context:"folderResolve"},bubbles:!0,composed:!0}))}}_handleFolderResolveCancel(){this._folderResolveOpen=!1,this._transformAfterResolve=!1}_handleTransformConfirm(e){const s=e.detail.params,i=e.detail.isAspectLocked??!0,r=this._transformAssets,o=this._transformFolders,a=r.length>1,n=Jn(s,{isMultiSelect:a,isAspectLocked:i}),l=r.map(d=>{var g,v;if(!Gt(d))return d;const p=(g=d.url)==null?void 0:g.cdn,u=(v=d.url)==null?void 0:v.permalink,h={cdn:p?Lt(p,n):""};return u&&(h.permalink_cdn=Lt(u,n)),{...d,transformation:{params:s,url:h}}});this._transformOpen=!1,this._transformAssets=[],this._transformFolders=[],this._emitSelect(l,o.length?o:void 0)}_handleTransformSkip(){const e=this._transformAssets,s=this._transformFolders;this._transformOpen=!1,this._transformAssets=[],this._transformFolders=[],this._emitSelect(e,s.length?s:void 0)}_handleTransformCancel(){this._transformOpen=!1,this._transformAssets=[],this._transformFolders=[]}_openCreateFolderDialog(){this._createFolderError=null,this._createFolderOpen=!0}_handleCreateFolderCancel(){this._isCreatingFolder&&(this._cancelCreateFolderRequested=!0),this._createFolderOpen=!1,this._createFolderError=null}async _handleCreateFolderConfirm(e){const s=e.detail.name;if(!s||this._isCreatingFolder||!this.apiClient)return;const i=this.store.getState().currentFolderPath||"/";this._isCreatingFolder=!0,this._cancelCreateFolderRequested=!1,this._createFolderError=null;try{await Cn(this.apiClient,s,i),this._cancelCreateFolderRequested||(this._createFolderOpen=!1),this._loadData()}catch(r){this._cancelCreateFolderRequested||(this._createFolderError=this._mapCreateFolderError(r))}finally{this._isCreatingFolder=!1,this._cancelCreateFolderRequested=!1}}_mapCreateFolderError(e){const s=(e==null?void 0:e.message)??"";if(/timed out/i.test(s))return"Request timed out. Please try again.";const i=s.match(/^API error: (\d+)/);if(i)switch(Number(i[1])){case 400:return"Invalid folder name.";case 401:return"Authentication failed. Please reload the page.";case 403:return"You do not have permission to create a folder here.";case 409:return"A folder with this name already exists.";default:return"Failed to create folder. Please try again."}return s||"Failed to create folder. Please try again."}async _handleSelectAll(e){var l,d,p;const s=this.store.getState();if(s.isSelectingAll||!this.apiClient||!(((l=s.config)==null?void 0:l.multiSelect)??!0))return;const r=((d=e==null?void 0:e.detail)==null?void 0:d.scope)??"all",o=r!=="assets"&&((p=this.config)==null?void 0:p.folderSelection)!==!1&&s.folders.length>0;if(!(r!=="folders")){o&&this.selectionCtrl.selectAllFolders(s.folders);return}if(s.assets.length>=s.totalCount){o&&this.selectionCtrl.selectAllFolders(s.folders),this.selectionCtrl.selectAll(s.assets);return}const n=++this._selectAllId;this.store.setState({isSelectingAll:!0});try{const u=this._buildSearchNotation();let h=s.currentFolderPath||"/";const g=s.limit,v=s.assets,y=s.totalCount;let x=s.activeTab==="folders"?0:1,$=u||void 0;if(s.activeTab==="labels"&&s.activeLabelUuid){const F=s.labels.find(Q=>Q.uuid===s.activeLabelUuid);F&&($=`labels:${F.sid.replace("#","")}${u?" "+u:""}`),h="/",x=1}let k,L;s.activeTab==="collections"&&s.activeCollectionFolder&&(k=s.activeCollectionUuid||void 0,L=s.activeCollectionFolder.filters||void 0,h="",x=1);const O=[];for(let F=v.length;F<y;F+=g)O.push(F);const E=4,z=[];for(let F=0;F<O.length;F+=E){if(n!==this._selectAllId)return;const Q=O.slice(F,F+E),fe=await Promise.all(Q.map(Y=>{var ge,me;return St(this.apiClient,{fields:(ge=this.config)==null?void 0:ge.apiFields,permalinksEnabled:this.store.getState().cdnPermalinkEnabled,...h?{folder:h}:{},offset:Y,limit:g,sort_by:s.sortBy,sort_direction:s.sortDirection,search:s.searchQuery||void 0,q:$,recursive:x,...k&&{collection_uuid:k},...L&&{f64:L},...s.isAISearchActive&&s.searchQuery&&{with_ai:!0,ai_query:s.searchQuery,ai_lang:((me=s.config)==null?void 0:me.locale)??"en"}})}));if(n!==this._selectAllId)return;for(const Y of fe)Y.files&&z.push(...Y.files)}if(n!==this._selectAllId)return;const S=new Set(v.map(F=>F.uuid)),V=z.filter(F=>S.has(F.uuid)?!1:(S.add(F.uuid),!0)),N=[...v,...V];this.store.setState({assets:N,offset:Math.max(0,N.length-g),hasMore:!1,isSelectingAll:!1}),o&&this.selectionCtrl.selectAllFolders(s.folders),this.selectionCtrl.selectAll(N)}catch(u){if(n!==this._selectAllId)return;this.store.setState({isSelectingAll:!1}),this.dispatchEvent(new CustomEvent("ap-error",{detail:{error:u,context:"selectAll"},bubbles:!0,composed:!0}))}}_handleSelectionClear(){this.selectionCtrl.clearSelection()}_handleSelectionDeselect(e){const s=new Map(this.store.getState().selectedAssets);s.delete(e.detail.uuid),this.store.setState({selectedAssets:s})}_isDateFilterKey(e){return e===w.DATE||e===w.LICENSE_EXPIRY||e===D.DUE_DATE}_handleFilterUpdate(e){const{key:s,values:i,operator:r}=e.detail,a={...this.store.getState().filters};let n=i===""||i===null||i===void 0||Array.isArray(i)&&i.length===0||typeof i=="object"&&!Array.isArray(i)&&Object.values(i).every(d=>d==null||d===""||Array.isArray(d)&&d.length===0);if(!n&&this._isDateFilterKey(s)&&typeof i=="object"&&!Array.isArray(i)){const{kind:d,preset:p,from:u,to:h}=i;n=!d&&!p&&!u&&!h}if(n){const d={...a.applied};delete d[s],a.applied=d,a.pinned.includes(s)||(a.visible=a.visible.filter(p=>p!==s))}else{const d={...a.applied};this._isDateFilterKey(s)&&typeof i=="object"&&!Array.isArray(i)?d[s]={type:"date",field:i.field||"created",kind:i.kind||null,preset:i.preset||null,from:i.from||null,to:i.to||null}:s===w.IMAGE&&typeof i=="object"&&!Array.isArray(i)?d[s]=i:d[s]={type:"string",values:Array.isArray(i)?i:[i],operator:r||":"},a.applied=d,a.visible.includes(s)||(a.visible=[...a.visible,s])}this.store.setState({filters:a,offset:0,assets:[],folders:[],isLoading:!0}),this.selectionCtrl.resetRange(),this._debouncedLoadData();const l=s===D.STATUS||s===D.APPROVER||s===D.REQUESTOR||s===D.DUE_DATE;if(this._pendingFilter===s||this._pendingFilter===w.APPROVAL&&l){this._pendingFilter=null;const d=this.renderRoot.querySelector("ap-filters-bar");d&&(d.pendingFilter=null)}}_handleFilterOpen(e){const s=e.detail.key,i=e.detail.chipRect,r=this.renderRoot.querySelector("ap-content-toolbar");let o,a;if(i){const n=this.renderRoot.querySelector(".toolbar-filters-wrapper");if(n){const l=n.getBoundingClientRect();o=i.left-l.left,a=i.bottom-l.top}}r==null||r.openFilterPanel(s,!0,o,a)}_handleMetadataFilterOpen(e){const{fieldKey:s,chipRect:i}=e.detail,r=this.renderRoot.querySelector("ap-content-toolbar");let o,a;if(i){const n=this.renderRoot.querySelector(".toolbar-filters-wrapper");if(n){const l=n.getBoundingClientRect();o=i.left-l.left,a=i.bottom-l.top}}r==null||r.openMetadataFieldPanel(s,!0,o,a)}_handleFilterPanelChange(e){const s=this.renderRoot.querySelector("ap-filters-bar");s&&(s.activeFilter=e.detail.key,s.activeMetadataField=e.detail.metadataFieldKey||null),!e.detail.key&&!e.detail.metadataFieldKey&&(this._pendingFilter||this._pendingMetadataField)&&(this._pendingFilter=null,this._pendingMetadataField=null,s&&(s.pendingFilter=null,s.pendingMetadataField=null))}async _handleFilterPending(e){var h,g,v;const{key:s,metadataFieldKey:i}=e.detail,r=this.renderRoot.querySelector("ap-filters-bar"),o=this.renderRoot.querySelector("ap-content-toolbar");if(!r||!o)return;i?(this._pendingMetadataField=i,r.pendingMetadataField=i):s&&(this._pendingFilter=s,r.pendingFilter=s),await r.updateComplete;let a=r.renderRoot.querySelector(".chip.pending");if(!a){const y=r.renderRoot.querySelectorAll(".chip.pinned-empty"),x=i?(h=r._getMetadataLabel)==null?void 0:h.call(r,i):void 0;for(const $ of y){const k=(v=(g=$.querySelector(".chip-label"))==null?void 0:g.textContent)==null?void 0:v.trim();if(i&&k===x){a=$;break}if(s&&k===(Yt[s]||s)){a=$;break}}}if(!a)return;const n=a.getBoundingClientRect(),l=this.renderRoot.querySelector(".toolbar-filters-wrapper"),d=l==null?void 0:l.getBoundingClientRect(),p=d?n.left-d.left:n.left,u=d?n.bottom-d.top:void 0;i?o.openMetadataFieldPanel(i,!0,p,u):s&&o.openFilterPanel(s,!0,p,u)}_handleFilterRemove(e){var a;const s=e.detail.key;if(s in(((a=this.config)==null?void 0:a.forcedFilters)??{}))return;const r={...this.store.getState().filters},o={...r.applied};delete o[s],r.applied=o,r.pinned.includes(s)||(r.visible=r.visible.filter(n=>n!==s)),this.store.setState({filters:r,offset:0,assets:[],folders:[],isLoading:!0}),this.selectionCtrl.resetRange(),this._debouncedLoadData()}_handleMetadataFilterChange(e){const{fieldKey:s,operator:i,values:r,metadataType:o}=e.detail,n={...this.store.getState().filters},l={...n.metadata},d={...l.applied};if(!r||Array.isArray(r)&&r.length===0?(delete d[s],l.applied=d,l.pinned.includes(s)||(l.visible=l.visible.filter(u=>u!==s))):(d[s]={type:"string",values:Array.isArray(r)?r:[r],operator:i||":",metadataType:o},l.applied=d,l.visible.includes(s)||(l.visible=[...l.visible,s])),n.metadata=l,this.store.setState({filters:n,offset:0,assets:[],folders:[],isLoading:!0}),this.selectionCtrl.resetRange(),this._debouncedLoadData(),this._pendingMetadataField===s){this._pendingMetadataField=null;const u=this.renderRoot.querySelector("ap-filters-bar");u&&(u.pendingMetadataField=null)}}_handleMetadataFieldToggle(e){const{fieldKey:s,visible:i}=e.detail,o={...this.store.getState().filters},a={...o.metadata};i?a.visible.includes(s)||(a.visible=[...a.visible,s]):a.visible=a.visible.filter(n=>n!==s),o.metadata=a,this.store.setState({filters:o})}_handleMetadataFilterRemove(e){const{fieldKey:s}=e.detail,r={...this.store.getState().filters},o={...r.metadata},a={...o.applied};delete a[s],o.applied=a,o.pinned.includes(s)||(o.visible=o.visible.filter(n=>n!==s)),r.metadata=o,this.store.setState({filters:r,offset:0,assets:[],folders:[],isLoading:!0}),this.selectionCtrl.resetRange(),this._debouncedLoadData()}_handleFilterPin(e){var n,l;const{key:s,pinned:i}=e.detail,o={...this.store.getState().filters};i?o.pinned.includes(s)||(o.pinned=[...o.pinned,s]):(o.pinned=o.pinned.filter(d=>d!==s),s in o.applied||(o.visible=o.visible.filter(d=>d!==s))),this.store.setState({filters:o});const a=((l=(n=this.store.getState().config)==null?void 0:n.auth)==null?void 0:l.projectToken)??null;Ml(a,o.pinned)}_handleMetadataPin(e){var l,d;const{fieldKey:s,pinned:i}=e.detail,o={...this.store.getState().filters},a={...o.metadata};i?a.pinned.includes(s)||(a.pinned=[...a.pinned,s]):(a.pinned=a.pinned.filter(p=>p!==s),s in a.applied||(a.visible=a.visible.filter(p=>p!==s))),o.metadata=a,this.store.setState({filters:o});const n=((d=(l=this.store.getState().config)==null?void 0:l.auth)==null?void 0:d.projectToken)??null;Rl(n,a.pinned)}_handleFiltersClearAll(){const e=this.store.getState();this.store.setState({filters:{...e.filters,applied:{},visible:[...e.filters.pinned],metadata:{...e.filters.metadata,applied:{},visible:[...e.filters.metadata.pinned]}},offset:0,assets:[],folders:[],isLoading:!0});const s=this.renderRoot.querySelector("ap-filters-bar");s&&(s.activeFilter=null),this.selectionCtrl.resetRange(),this._debouncedLoadData()}_handleFilterDeactivate(e){const s=e.detail.key,r={...this.store.getState().filters};r.visible=r.visible.filter(o=>o!==s),this.store.setState({filters:r})}_handleMetadataFieldDeactivate(e){const{fieldKey:s}=e.detail,r={...this.store.getState().filters},o={...r.metadata};o.visible=o.visible.filter(a=>a!==s),r.metadata=o,this.store.setState({filters:r})}_handleFiltersSet(e){var d;const{applied:s,metadata:i}=e.detail,o={...this.store.getState().filters},a=new Set(Object.keys(((d=this.config)==null?void 0:d.forcedFilters)??{})),n={...s};for(const p of a)delete n[p];o.applied=n;const l=Object.keys(s);if(o.visible=[...new Set([...o.pinned,...l])],i){const p={...o.metadata};p.applied=i.applied;const u=Object.keys(i.applied);p.visible=[...new Set([...p.pinned,...u])],o.metadata=p}this.store.setState({filters:o,offset:0,assets:[],folders:[],isLoading:!0}),this.selectionCtrl.resetRange(),this._debouncedLoadData()}_getSortOptions(){var s;const e=this.storeCtrl.state;if(e.activeTab==="labels"&&!e.activeLabelUuid)return Wl;if(e.activeTab==="collections"){if(!e.activeCollectionUuid)return Xl;if(!(e.activeCollectionFolder&&!((s=e.activeCollectionFolder.children)!=null&&s.length)))return Jl}return e.searchQuery?Yl:e.activeTab==="folders"?Ql:er}_buildSearchNotation(){const e=this.store.getState(),s={...this._normalizedForcedFilters,...e.filters.applied};return xl(s,e.filters.metadata.applied).join(" ")}render(){var L,O,E,z,S,V,N,F,Q,fe,Y,ge,me,Ke,nt,W,$e,Me,lt,os,as,ns,ls,cs,ds,hs,ps,We;const e=this.storeCtrl.state,s=e.t,i=Array.from(e.selectedAssets.keys()),r=Array.from(e.selectedFolders.keys()),o=((L=this.config)==null?void 0:L.disabledAssetIds)??[],a=((O=this.config)==null?void 0:O.disabledFolderIds)??[],n=this.selectionCtrl.getSelectedAssets(),l=this.selectionCtrl.getSelectedFolders(),d=((E=this.config)==null?void 0:E.folderSelection)!==!1,p=c`
      ...
      ></ap-header>
    `,u=!!((N=this.config)!=null&&N.uploader),h=((F=this.config)==null?void 0:F.folderCreation)===!0,g=((Q=this.config)==null?void 0:Q.auth.mode)==="sassKey",v=e.activeTab==="folders",y=h&&v&&(g||Nn(e.permissions,jn.FOLDER_CREATE)),x=c`
      <div
        class="content-area"
      ...
      >
        ...
        <div class="main-content">
          <div class="toolbar-filters-wrapper${(fe=this.config)!=null&&fe.stickyFilters?" sticky":""}">
            <ap-content-toolbar
              ...
              .requesterUsers=${((Ke=this.config)==null?void 0:Ke.requesterUsers)??[]}
              .t=${s}
            ...
            ${e.activeTab==="labels"&&!e.activeLabelUuid||e.activeTab==="collections"&&!(e.activeCollectionFolder&&!((nt=e.activeCollectionFolder.children)!=null&&nt.length))?m:c`
                  <ap-filters-bar
                    ...
                    .requesterUsers=${(($e=this.config)==null?void 0:$e.requesterUsers)??[]}
                    .pinnedFilters=${e.filters.pinned}
                    .pinnedMetadataFields=${e.filters.metadata.pinned}
                    .forcedFilters=${((Me=this.config)==null?void 0:Me.forcedFilters)??{}}
                    .t=${s}
          ...
          ${e.isLoading&&e.assets.length===0&&e.folders.length===0&&!(e.activeTab==="labels"&&!e.activeLabelUuid)&&!(e.activeTab==="collections"&&!(e.activeCollectionFolder&&!((lt=e.activeCollectionFolder.children)!=null&&lt.length)))?c`<ap-skeleton
                .variant=${e.viewMode}
                .gridSize=${((os=this.config)==null?void 0:os.gridSize)??"normal"}
                .multiSelect=${((as=this.config)==null?void 0:as.multiSelect)!==!1}
                .folderCount=${2}
                .t=${s}
          ...
          ${this._transformOpen?c`
                <ap-transformation-dialog
                  ...
                  .t=${s}
                  .exportOriginalLabel=${(ns=this._transformationsConfig)==null?void 0:ns.exportOriginalLabel}
                  .applyExportLabel=${(ls=this._transformationsConfig)==null?void 0:ls.applyExportLabel}
        ...
        ${e.isPreviewOpen&&e.previewAsset?c`<ap-preview-panel
              ...
              .showMetadata=${((cs=this.config)==null?void 0:cs.showMetadata)!==!1}
              .metadataFields=${e.metadataFields}
              .labels=${e.labels}
              .regionalFilters=${e.regionalFilters}
              .multiSelect=${((ds=this.config)==null?void 0:ds.multiSelect)??!0}
              .t=${s}
    ...
    `,$=c`
      <ap-selection-bar
        ...
        .multiSelect=${((hs=this.config)==null?void 0:hs.multiSelect)??!0}
        .maxSelections=${(ps=this.config)==null?void 0:ps.maxSelections}
        .showTransform=${!!((We=this.config)!=null&&We.transformations)&&n.some(Gt)}
        .t=${s}
    ...
    `}_renderContent(e,s,i=[],r=!1,o=[],a=[]){var l,d,p,u,h,g,v,y,x,$,k,L,O;const n=e.t;if(e.activeTab==="assets")return!e.isLoading&&e.assets.length===0?c`
      ...
      `;if(e.activeTab==="folders")return!e.isLoading&&e.folders.length===0&&e.assets.length===0?c`
        ...
        ></ap-list-view>
        <div id="sentinel"></div>
      `;if(e.activeTab==="labels"){if(!e.activeLabelUuid){let E=e.labels;if(e.searchQuery){const S=e.searchQuery.toLowerCase();E=e.labels.filter(V=>V.name.toLowerCase().includes(S))}const z=e.sortDirection==="asc"?1:-1;return E=[...E].sort((S,V)=>z*S.name.localeCompare(V.name)),E.length===0?c`
            <div class="empty-state">
        ...
        ></ap-list-view>
        <div id="sentinel"></div>
      `}if(e.activeTab==="collections"){if(!e.activeCollectionUuid){let S=e.collections;if(e.searchQuery){const N=e.searchQuery.toLowerCase();S=e.collections.filter(F=>F.title.toLowerCase().includes(N))}const V=e.sortDirection==="asc"?1:-1;return e.sortBy==="created_at"?S=[...S].sort((N,F)=>V*(new Date(N.created_at).getTime()-new Date(F.created_at).getTime())):e.sortBy==="updated_at"?S=[...S].sort((N,F)=>V*(new Date(N.updated_at).getTime()-new Date(F.updated_at).getTime())):S=[...S].sort((N,F)=>V*N.title.localeCompare(F.title)),S.length===0?c`
            <div class="empty-state">
        ...
        `}if(e.isLoadingCollectionFolders)return c`<div class="loading-center"><sfx-spinner></sfx-spinner></div>`;const E=this._getVisibleCollectionFolders();if(!e.activeCollectionFolder||((($=e.activeCollectionFolder.children)==null?void 0:$.length)??0)>0){let S=E;if(e.searchQuery){const N=e.searchQuery.toLowerCase();S=E.filter(F=>F.name.toLowerCase().includes(N))}const V=e.sortDirection==="asc"?1:-1;return S=[...S].sort((N,F)=>V*N.name.localeCompare(F.name)),S.length===0?c`
            <div class="empty-state">
              <sfx-icon name="folder" .size=${48}></sfx-icon>
              <div class="empty-title">
    ...
    `];let je=mr;wt([_()],je.prototype,"_isDragOver");wt([_()],je.prototype,"_isUploaderOpen");wt([_()],je.prototype,"_folderResolveOpen");wt([_()],je.prototype,"_transformOpen");wt([_()],je.prototype,"_createFolderOpen");wt([_()],je.prototype,"_isCreatingFolder");wt([_()],je.prototype,"_createFolderError");wt([f({type:Object})],je.prototype,"config");typeof customElements<"u"&&!customElements.get("sfx-asset-picker")&&customElements.define("sfx-asset-picker",je);const uh=[{pattern:"/",load:()=>K(()=>import("./landing-BVgcdmvt.js"),__vite__mapDeps([0,1])).then(t=>t.default)},{pattern:"/docs/getting-started",load:()=>K(()=>import("./getting-started-Ch2NjLo6.js"),__vite__mapDeps([2,3])).then(t=>t.default)},{pattern:"/docs/configuration",load:()=>K(()=>import("./configuration-DFpgwuv1.js"),__vite__mapDeps([4,3])).then(t=>t.default)},{pattern:"/docs/api",load:()=>K(()=>import("./api-Dl3UszFN.js"),__vite__mapDeps([5,3])).then(t=>t.default)},{pattern:"/docs/theming",load:()=>K(()=>import("./theming-hrqYM8pb.js"),__vite__mapDeps([6,3])).then(t=>t.default)},{pattern:"/docs/filters",load:()=>K(()=>import("./filters-BlL5oE1x.js"),__vite__mapDeps([7,3])).then(t=>t.default)},{pattern:"/docs/types",load:()=>K(()=>import("./types-DPNAgA2W.js"),__vite__mapDeps([8,3])).then(t=>t.default)},{pattern:"/examples/basic",load:()=>K(()=>import("./basic-CX7ZLN1c.js"),__vite__mapDeps([9,1])).then(t=>t.default)},{pattern:"/examples/single-select",load:()=>K(()=>import("./single-select-DtMoSgxr.js"),__vite__mapDeps([10,1])).then(t=>t.default)},{pattern:"/examples/multi-select",load:()=>K(()=>import("./multi-select-DyDuy631.js"),__vite__mapDeps([11,1])).then(t=>t.default)},{pattern:"/examples/disabled-assets",load:()=>K(()=>import("./disabled-assets-DHVO5YbJ.js"),__vite__mapDeps([12,1])).then(t=>t.default)},{pattern:"/examples/theming",load:()=>K(()=>import("./theming-BuAoWkAJ.js"),__vite__mapDeps([13,1])).then(t=>t.default)},{pattern:"/examples/custom-theming",load:()=>K(()=>import("./custom-theming-DjsaBk1g.js"),__vite__mapDeps([14,1])).then(t=>t.default)},{pattern:"/examples/default-filters",load:()=>K(()=>import("./default-filters-C2e9c_bH.js"),__vite__mapDeps([15,1])).then(t=>t.default)},{pattern:"/examples/forced-filters",load:()=>K(()=>import("./forced-filters-DWMOycET.js"),__vite__mapDeps([16,1])).then(t=>t.default)},{pattern:"/examples/hidden-tabs",load:()=>K(()=>import("./hidden-tabs-BcFBpeaO.js"),__vite__mapDeps([17,1])).then(t=>t.default)},{pattern:"/examples/root-folder",load:()=>K(()=>import("./root-folder-Det8_UHU.js"),__vite__mapDeps([18,1])).then(t=>t.default)},{pattern:"/examples/events",load:()=>K(()=>import("./events-BipDR5Ts.js"),__vite__mapDeps([19,1])).then(t=>t.default)},{pattern:"/examples/react-wrapper",load:()=>K(()=>import("./react-wrapper-BXYjOtmk.js"),__vite__mapDeps([20,1])).then(t=>t.default)},{pattern:"/examples/inline",load:()=>K(()=>import("./inline-CtsQcdwe.js"),__vite__mapDeps([21,1])).then(t=>t.default)},{pattern:"/examples/sticky-filters",load:()=>K(()=>import("./sticky-filters-mNkGk2Jg.js"),__vite__mapDeps([22,1])).then(t=>t.default)},{pattern:"/examples/grid-size",load:()=>K(()=>import("./grid-size-B1zwyddK.js"),__vite__mapDeps([23,1])).then(t=>t.default)},{pattern:"/examples/preferences",load:()=>K(()=>import("./preferences-DFmK9o3B.js"),__vite__mapDeps([24,1])).then(t=>t.default)},{pattern:"/examples/uploader",load:()=>K(()=>import("./uploader-BEkq5kia.js"),__vite__mapDeps([25,1])).then(t=>t.default)},{pattern:"/examples/folder-selection",load:()=>K(()=>import("./folder-selection-BWC1Gt8X.js"),__vite__mapDeps([26,1])).then(t=>t.default)},{pattern:"/examples/ai-search",load:()=>K(()=>import("./ai-search-CkElL0CK.js"),__vite__mapDeps([27,1])).then(t=>t.default)},{pattern:"/examples/transformations",load:()=>K(()=>import("./transformations-D9DsLoDp.js"),__vite__mapDeps([28,1])).then(t=>t.default)},{pattern:"/examples/language-switcher",load:()=>K(()=>import("./language-switcher-C-FAIN0e.js"),__vite__mapDeps([29,1])).then(t=>t.default)}];let bs=null,lo=0;function fh(t){const e=document.getElementById("content"),s=document.getElementById("sidebar"),i=document.getElementById("sidebar-docs"),r=document.getElementById("sidebar-examples"),o=document.querySelectorAll(".topbar-nav-link");async function a(){const n=location.hash.slice(1)||"/",l=++lo;bs!=null&&bs.destroy&&bs.destroy(),t.close();const d=uh.find(x=>x.pattern===n);if(!d){location.hash="#/";return}const p=n.startsWith("/docs/"),u=n.startsWith("/examples/"),h=p||u,g=n==="/";s.classList.toggle("hidden",!h),document.body.classList.toggle("has-sidebar",h),document.body.classList.toggle("is-home",g),i.classList.toggle("hidden",!p),r.classList.toggle("hidden",!u),s.querySelectorAll(".sidebar-link").forEach(x=>{x.classList.toggle("active",x.getAttribute("data-route")===n)});const v=p?"docs":u?"examples":"home";o.forEach(x=>{x.classList.toggle("active",x.getAttribute("data-section")===v)}),s.classList.remove("mobile-open"),window.scrollTo(0,0);const y=await d.load();l===lo&&(bs=y,e.innerHTML=y.render(),y.init&&y.init(t))}window.addEventListener("hashchange",a),a()}const gr="ap-demo-auth",gi={projectToken:"fbmjmuoeb",securityTemplateKey:"SECU_47D57B3106A841F7A1FEA951846CC5F3"};function gh(){try{const t=localStorage.getItem(gr);if(t)return{...gi,...JSON.parse(t)}}catch{}return{...gi}}function mh(t){localStorage.setItem(gr,JSON.stringify(t))}function vh(){const t=window.__apDemoFlags;return t&&typeof t=="object"?t:{}}function Sh(t={}){const{projectToken:e,securityTemplateKey:s}=gh();return{auth:{mode:"securityTemplate",securityTemplateKey:s,projectToken:e},...t,...vh()}}function bh(){const t=document.getElementById("auth-btn"),e=document.getElementById("auth-popover"),s=document.getElementById("auth-project-token"),i=document.getElementById("auth-sec-key"),r=document.getElementById("auth-save");try{const o=localStorage.getItem(gr);if(o){const a=JSON.parse(o);s.value=a.projectToken??"",i.value=a.securityTemplateKey??""}}catch{}t.addEventListener("click",o=>{o.stopPropagation(),e.classList.toggle("hidden")}),r.addEventListener("click",()=>{mh({projectToken:s.value.trim()||gi.projectToken,securityTemplateKey:i.value.trim()||gi.securityTemplateKey}),window.location.reload()}),document.addEventListener("click",o=>{!e.contains(o.target)&&!t.contains(o.target)&&e.classList.add("hidden")})}bh();console.info(`%c[asset-picker demo]%c Override picker config from the console:
  window.__apDemoFlags = { folderCreation: true }
Then re-open the picker. Flags merge over the example's own overrides.`,"color: #5b6cff; font-weight: 600;","color: inherit;");const xh=document.getElementById("sidebar-toggle"),Xo=document.getElementById("sidebar");xh.addEventListener("click",()=>{Xo.classList.toggle("mobile-open")});document.getElementById("content").addEventListener("click",()=>{Xo.classList.remove("mobile-open")});const _h=document.getElementById("picker");fh(_h);export{m as A,Qi as D,Ze as E,K as _,an as a,Sh as b,on as c,c as d,tc as e,Fr as f,A as g,C as h,sc as i,wh as j,rc as k,Go as l,R as m,f as n,vt as o,Us as p,Xt as q,_ as r,va as s,ec as t,pt as w};
