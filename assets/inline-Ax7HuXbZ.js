import{t as e}from"./index-DEo6o-Qa.js";import{t}from"./code-block-Dan-Xu_Q.js";var n={render(){return`
    ...
    `},init(n){let r=document.getElementById(`inline-picker`);r.config=e({displayMode:`inline`,onSelect:e=>alert(`Selected ${e.length} asset(s)`)}),t(`#code-container`,[{label:`HTML`,lang:`markup`,code:`
...
}`}])},destroy(){let e=document.getElementById(`inline-picker`);e&&e.close()}};export{n as default};