import{t as e}from"./index-DEo6o-Qa.js";import{t}from"./code-block-Dan-Xu_Q.js";var n=[{id:`btn-en`,label:`English`,code:`en`},{id:`btn-fr`,label:`French`,code:`fr`},{id:`btn-de`,label:`German`,code:`de`}],r={render(){return`
      ...
      <section class="page-section">
        <div style="display:flex;gap:0.75rem;flex-wrap:wrap;">
          ${n.map(({id:e,label:t})=>`<button class="btn-primary" id="${e}">${t}</button>`).join(`
        `)}
        </div>
      </section>
    ...
    `},init(r){t(`#code-container`,[{label:`HTML`,lang:`markup`,code:`
<script type="module">
...
}`}]);for(let{id:t,code:i}of n)document.getElementById(t).addEventListener(`click`,()=>{r.config=e({locale:i}),r.open()})}};export{r as default};