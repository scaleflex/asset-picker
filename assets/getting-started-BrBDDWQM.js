import{n as e,r as t,t as n}from"./doc-utils-C97Qk3q2.js";var r={render(){return`
      <div class="doc-content">
        ...
        <h3>npm / yarn / pnpm</h3>
        ${n(`bash`,`npm install @scaleflex/asset-picker`)}
        ${n(`bash`,`yarn add @scaleflex/asset-picker`)}
        ${n(`bash`,`pnpm add @scaleflex/asset-picker`)}
        ...
        ${n(`markup`,`<script src="https://cdn.scaleflex.com/asset-picker/0.2.17/asset-picker.min.js"><\/script>`)}
        ...
        ${n(`markup`,`<sfx-asset-picker></sfx-asset-picker>
...
<\/script>`)}
        ...
        <h3>React</h3>
        ${n(`tsx`,`import { AssetPicker } from '@scaleflex/asset-picker/react';
  ...
  return (
    <>
      ...
      />
        ...
        ${e(void 0,{href:`#/docs/configuration`,label:`Configuration`})}
      </div>
