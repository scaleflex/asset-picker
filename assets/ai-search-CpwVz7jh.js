import{t as e}from"./index-DEo6o-Qa.js";import{t}from"./code-block-Dan-Xu_Q.js";var n=!1,r={render(){return`
    ...
    `},init(r){n=!1;let i=document.getElementById(`toggle-default-ai`);i.addEventListener(`change`,()=>{n=i.checked}),document.getElementById(`open-btn`).addEventListener(`click`,()=>{r.config=e({enableAISearch:!0,defaultAISearch:n,onSelect:e=>alert(`Selected ${e.length} asset(s)`),onCancel:()=>console.log(`Cancelled`)}),r.open()}),t(`#code-container`,[{label:`HTML`,lang:`markup`,code:`
<script type="module">
