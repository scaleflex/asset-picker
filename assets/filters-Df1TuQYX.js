      ...
      <div class="doc-content">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>'approval'</code></td><td><code>FILTER_KEYS.APPROVAL</code></td><td>Approval — opens its four sub-filters (status, approver, requester, due date), each an independent chip. See <a href="#/examples/approval-users">Approval users</a></td><td>Yes</td></tr>
        ...
        <p>Which fields are offered <em>within</em> the <code>'metadata'</code> filter is controlled separately by <code>enabledMetadataFields</code> — see <a href="#/examples/enabled-metadata-fields">Enabled metadata fields</a>.</p>
