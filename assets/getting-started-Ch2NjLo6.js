import{h as t,c as e,d as s}from"./doc-utils-XkOyWBCy.js";const o={render(){return`
      <div class="doc-content">
        ...
        <h3>npm / yarn / pnpm</h3>
        ${e("bash","npm install @scaleflex/asset-picker")}
        ${e("bash","yarn add @scaleflex/asset-picker")}
        ${e("bash","pnpm add @scaleflex/asset-picker")}
        ...
        ${e("markup",'<script src="https://cdn.scaleflex.com/asset-picker/0.2.17/asset-picker.min.js"><\/script>')}
        ...
        ${e("markup",`<sfx-asset-picker></sfx-asset-picker>
...
<\/script>`)}
        ...
        <h3>React</h3>
        ${e("tsx",`import { AssetPicker } from '@scaleflex/asset-picker/react';
  ...
  return (
    <>
      ...
      />
        ...
        ${s(void 0,{href:"#/docs/configuration",label:"Configuration"})}
      </div>
    `},init(){t()}};export{o as default};
