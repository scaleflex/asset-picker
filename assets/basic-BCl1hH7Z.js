...
}`}]),document.getElementById(`open-btn`).addEventListener(`click`,()=>{n.config=e({onSelect:e=>alert(`Selected ${e.length} asset(s)`),onCancel:()=>console.log(`Cancelled`)}),n.open()})}};export{n as default};