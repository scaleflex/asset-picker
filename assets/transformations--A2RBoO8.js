import{t as e}from"./index-DEo6o-Qa.js";import{t}from"./code-block-Dan-Xu_Q.js";var n={render(){return`
  ...
  applyExportLabel: 'Confirm',          // optional
    ...
    `},init(n){let r=document.getElementById(`output`);document.getElementById(`open-btn`).addEventListener(`click`,()=>{n.config=e({transformations:!0,onSelect:e=>{r.style.display=`block`,r.textContent=JSON.stringify(e,null,2)},onCancel:()=>console.log(`Cancelled`)}),n.open()}),t(`#code-container`,[{label:`HTML`,lang:`markup`,code:`
<script type="module">
