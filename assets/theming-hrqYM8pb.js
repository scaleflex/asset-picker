import{h as d,c as t,d as e}from"./doc-utils-XkOyWBCy.js";const r={render(){return`
  ...
  --ap-modal-max-width: 1400px;
        ...
        ${e({href:"#/docs/api",label:"API"},{href:"#/docs/filters",label:"Filters"})}
      </div>
    `},init(){d()}};export{r as default};
