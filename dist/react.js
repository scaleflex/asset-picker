...
const H = R(function({ config: P, open: o, onSelect: i, onSelectWithFolders: m, onCancel: k, className: t, style: r }, l) {
...
function q({ config: s, children: P }) {
  const [o, i] = b(!1), [m, k] = b(s), t = u(null), r = u(null), l = u(null), n = u(null), a = x(
    (d) => {
