...
const page: Page = {
  ...
  init() {
    renderCodeBlock('#code-install', [
      {
        label: 'bash',
        lang: 'bash',
        code: `npm install @scaleflex/asset-picker`,
      },
    ]);

    renderCodeBlock('#code-basic', [
      {
        label: 'React',
        lang: 'tsx',
        code: `
